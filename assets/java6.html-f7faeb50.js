...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="方法的分类" tabindex="-1"><a class="header-anchor" href="#方法的分类" aria-hidden="true">#</a> 方法的分类</h3><h4 id="根据参数个数" tabindex="-1"><a class="header-anchor" href="#根据参数个数" aria-hidden="true">#</a> 根据参数个数：</h4><pre><code>无参方法
有参方法
</code></pre><h4 id="根据返回值类型" tabindex="-1"><a class="header-anchor" href="#根据返回值类型" aria-hidden="true">#</a> 根据返回值类型:</h4><pre><code>有返回值的方法：
基本数据类型
引用数据类型
无返回值的方法
void
</code></pre><h3 id="方法的分类-1" tabindex="-1"><a class="header-anchor" href="#方法的分类-1" aria-hidden="true">#</a> 方法的分类</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_6_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>对于无返回值类型的方法，它不向本方法外部返回任何值。定义这样的方法时，声明方法返回类型的位置不能省略不写，而应该用关键字void来代替，即 “空”的意思。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class FunctionDemo {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="示例-funcsum-java" tabindex="-1"><a class="header-anchor" href="#示例-funcsum-java" aria-hidden="true">#</a> 示例 FuncSum.java</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_6_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="☻-练习" tabindex="-1"><a class="header-anchor" href="#☻-练习" aria-hidden="true">#</a> ☻ 练习</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> 下列选项中，哪些可以与void  setAge(int year,int month,int day)方法在同一个类中定义____?
