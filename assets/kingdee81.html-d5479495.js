...
this.getView().showMessage(String.format(&quot;事件 closedCallBack，只能收到子界面主动返回给列表界面的数据%s&quot;, returnData));
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+u+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>金蝶云苍穹单据列表插件billClosedCallBack事件案例</em> 知识点整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',18);function C(_,f){const l=v("ExternalLinkIcon");return t(),s("div",null,[a(" more "),i("h1",g,[p,e(),i("a",k,[e("81-金蝶云苍穹单据列表插件billClosedCallBack事件案例.md"),d(l)])]),h])}const w=n(b,[["render",C],["__file","kingdee81.html.vue"]]);export{w as default};
