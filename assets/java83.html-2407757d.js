...
D. int a = 97.0;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr>`,6),b={class:"hint-container tip"},h=n("p",{class:"hint-container-title"},"提示",-1),g=n("em",null,"Java-int类型和long类型的讲解",-1),p={href:"https://github.com/javaobjects/demo59_2",target:"_blank",rel:"noopener noreferrer"};function x(f,I){const i=o("ExternalLinkIcon");return s(),l("div",null,[d(" more "),n("h1",c,[u,e(),n("a",m,[e("83-Java-int类型和long类型的讲解.md"),t(i)])]),_,n("div",b,[h,n("p",null,[n("strong",null,[e("以上就是我关于 "),g,e(" 知识点的整理与总结的全部内容，"),n("a",p,[e("另附源码"),t(i)])])])])])}const L=a(v,[["render",x],["__file","java83.html.vue"]]);export{L as default};
