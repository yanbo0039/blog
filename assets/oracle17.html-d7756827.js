import{_ as e,X as n,Y as a,a1 as r,a0 as o}from"./framework-68dd73a2.js";const p="/blog/assets/Oracle_17_1.png",t="/blog/assets/Oracle_17_2.png",i="/blog/assets/Oracle_17_3.png",m="/blog/assets/Oracle_17_4.png",g="/blog/assets/Oracle_17_5.png",s="/blog/assets/Oracle_17_6.png",c="/blog/assets/Oracle_17_7.png",d="/blog/assets/Oracle_17_8.png",l="/blog/assets/Oracle_17_9.png",f="/blog/assets/Oracle_17_10.png",_="/blog/assets/Oracle_17_11.png",u="/blog/assets/Oracle_17_12.png",b="/blog/assets/Oracle_17_13.png",h="/blog/assets/Oracle_17_14.png",y="/blog/assets/Oracle_17_15.png",x="/blog/assets/Oracle_17_16.png",w="/blog/assets/Oracle_17_17.png",k="/blog/assets/Oracle_17_18.png",v="/blog/assets/Oracle_17_19.png",O="/blog/assets/Oracle_17_20.png",z="/blog/assets/Oracle_17_21.png",j={},N=o(`<h1 id="oracle初级测试题六-分组函数" tabindex="-1"><a class="header-anchor" href="#oracle初级测试题六-分组函数" aria-hidden="true">#</a> Oracle初级测试题六--分组函数</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p>--请思考如下问题？</p><p>--查询所有员工的每个月工资总和，平均工资？</p><pre><code>select sum(sal) as 月工资总和,avg(sal) as 平均工资
from emp;
...
</code></pre><figure><img src="`+m+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>另一种理解：奖金&gt;0才是有奖金
select count(*) from emp where nvl(comm,0) &gt; 0;
</code></pre><figure><img src="`+g+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="练习一" tabindex="-1"><a class="header-anchor" href="#练习一" aria-hidden="true">#</a> --练习一</h3><p>--1.查询部门20的员工，每个月的工资总和及平均工资。</p><pre><code>select sum(sal),avg(sal) from emp where deptno in 20;
...
</code></pre><figure><img src="`+O+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--6.写一个查询，显示每个部门最高工资和最低工资的差额。</p><pre><code>select (max(sal)-min(sal))
from emp
group by deptno;
</code></pre><figure><img src="`+z+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Oracle初级测试题六--分组函数</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',75);function S(E,A){return n(),a("div",null,[r(" more "),N])}const G=e(j,[["render",S],["__file","oracle17.html.vue"]]);export{G as default};
