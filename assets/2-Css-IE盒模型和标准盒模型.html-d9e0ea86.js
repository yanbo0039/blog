import{_ as r,X as o,Y as i,a1 as d,Z as n,$ as a,a2 as h,a0 as t,F as c}from"./framework-68dd73a2.js";const p={},s=t(`<h1 id="css-ie盒模型和标准盒模型" tabindex="-1"><a class="header-anchor" href="#css-ie盒模型和标准盒模型" aria-hidden="true">#</a> Css-IE盒模型和标准盒模型</h1><p>最近无意刷咯一题。。算出IE盒模型所占的高度。。。果然。。。不知如何算。。。因为谁特么去关心IE。。。但是。。。基于是自已的错题情况下。。还是弄清楚为好。。</p><pre><code>参考咯很多文章最后得出结论 
