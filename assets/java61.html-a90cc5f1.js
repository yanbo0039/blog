import{_ as e,X as i,Y as n,a1 as s,a0 as l}from"./framework-68dd73a2.js";const a="/blog/assets/Java_61_1.png",r="/blog/assets/Java_61_2.png",t="/blog/assets/Java_61_3.png",d="/blog/assets/Java_61_4.png",v={},c=l('<h1 id="java-spring两种自动装配-autowired-resoure的区别" tabindex="-1"><a class="header-anchor" href="#java-spring两种自动装配-autowired-resoure的区别" aria-hidden="true">#</a> Java-Spring两种自动装配@Autowired&amp;@Resoure的区别</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p><em>沿用上一个项目</em></p><ol><li>将@Autowired换成@Resoure</li></ol><figure><img src="'+a+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>换成@Resoure之后</p><figure><img src="'+r+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>从中可以看出 @utowired导入的包是Spring的包 而@Resoure导入的包是Java的包</strong></p><p><strong>若有这么一个需求 项目中都使用controller不再使用以前的servlet，禁止大家在controller里使用Java底层的API ，那么此时就理解成不使用用 @Resource 使用 @Autowired</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>建议大家使用框架的时候后专心使用框架API，不要一边使用框架API，一边使用JavaAPI，所以使用@Autowired
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>测试运行：</strong></p><figure><img src="`+d+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>经我测试依然没有问题</p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 Java-Spring两种自动装配@Autowired&amp;@Resoure的区别 知识点的总结</strong></p></div>',26);function o(u,m){return i(),n("div",null,[s(" more "),c])}const b=e(v,[["render",o],["__file","java61.html.vue"]]);export{b as default};
