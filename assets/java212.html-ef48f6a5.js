import{_ as e,X as s,Y as l,a1 as d,Z as t,$ as n,a2 as a,a0 as v,F as r}from"./framework-68dd73a2.js";const c={},u={id:"_212-java异常处理方式-自定义异常-md",tabindex:"-1"},m=t("a",{class:"header-anchor",href:"#_212-java异常处理方式-自定义异常-md","aria-hidden":"true"},"#",-1),b={href:"http://xn--212-Java--yt6nh85g9qg16iea831afa1t905in10ddc2c.md",target:"_blank",rel:"noopener noreferrer"},o=v(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h3 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h3><blockquote><p>异常处理方式： 抛出异常 -&gt; 捕获异常 -&gt; 处理异常 -&gt; 释放、关闭资源</p></blockquote><pre><code>	自行处理（积极处理）：
	...
	回避处理（消极处理）：
		...
		throw: 抛出具体的异常
</code></pre><h3 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h3><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter08.自定义异常;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Java异常处理方式-自定义异常</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,11);function p(h,g){const i=r("ExternalLinkIcon");return s(),l("div",null,[d(" more "),t("h1",u,[m,n(),t("a",b,[n("212-Java异常处理方式-自定义异常.md"),a(i)])]),o])}const y=e(c,[["render",p],["__file","java212.html.vue"]]);export{y as default};
