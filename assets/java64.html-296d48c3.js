import{_ as t,X as e,Y as p,a1 as l,Z as n,$ as a,a2 as o,a0 as i,F as c}from"./framework-68dd73a2.js";const u={},r=i(`<h1 id="java-springmvc服务端数据校验如何实现" tabindex="-1"><a class="header-anchor" href="#java-springmvc服务端数据校验如何实现" aria-hidden="true">#</a> Java-springMVC服务端数据校验如何实现</h1><ol><li>新建一个动态web工程 命名 <strong>demo_springMVC_validate</strong></li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>导入对应的jar包并添加到内路径</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="3"><li>导入对应的配置文件</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>springmvc-servlet.xml</strong></p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token prolog">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>新建包 <strong>net.ptcs.demo.controller</strong></li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>新建Jsp页面 <strong>add_book.jsp</strong></li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>&lt;%@ page language=&quot;java&quot; contentType=&quot;text/html; charset=UTF-8&quot;
	pageEncoding=&quot;UTF-8&quot;%&gt;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时报错信息如下：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Multiple annotations found at this line:
	- The superclass &quot;javax.servlet.http.HttpServlet&quot; was not found on the Java 
	 Build Path
	- Line breakpoint:add_book.jsp [line: 1]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>解决方法：</strong></p><ul><li>项目右键 ----&gt; Configure Build Path -----&gt; Java Build Path ---&gt; Add Library ---&gt; Server RunTime ----&gt; Next ---&gt; Apache Tomcat v8.0 ---&gt; Finish ---&gt; Apply ---&gt; Apply and close</li></ul><p><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_8.png" alt="" loading="lazy"><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_9.png" alt="" loading="lazy"><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_10.png" alt="" loading="lazy"></p><ul><li>最后成功解决咯报错，如图所示</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_11.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="6"><li>新建一个 <strong>Book</strong> 实体类</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_12.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package net.ptcs.demo.entity;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="10"><li>运行并测试</li></ol><ul><li>出现如下报错：</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_13.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>原因：</strong></p><ul><li>springmvc-servlet.xml 中的 value 值与配置文件名不一致</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_14.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>解决：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>将这两名字更改为统一
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>如图所示，测试成功</strong></p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_64_15.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,44),d={href:"https://github.com/javaobjects/demo_springMVC_validate",target:"_blank",rel:"noopener noreferrer"},v=n("hr",null,null,-1),k=n("h3",{id:"分割线",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),a(" 分割线")],-1),m=n("hr",null,null,-1),g=n("p",null,[n("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function b(q,h){const s=c("ExternalLinkIcon");return e(),p("div",null,[l(" more "),r,n("p",null,[n("strong",null,[a("以上就是我关于 Java-springMVC服务端数据校验如何实现? 知识点的整理与总结的全部内容 "),n("a",d,[a("另附源码链接"),o(s)])])]),v,k,m,g])}const x=t(u,[["render",b],["__file","java64.html.vue"]]);export{x as default};
