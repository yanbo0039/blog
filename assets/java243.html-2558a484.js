import{_ as i,X as e,Y as n,a1 as t,a0 as a}from"./framework-68dd73a2.js";const r="/blog/assets/Java_243_1.png",d={},s=a('<h1 id="_243-java多线程编程-常用方法-线程优先级priority-md" tabindex="-1"><a class="header-anchor" href="#_243-java多线程编程-常用方法-线程优先级priority-md" aria-hidden="true">#</a> 243-Java多线程编程-常用方法_线程优先级priority.md</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h4><figure><img src="'+r+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter04.常用方法;
