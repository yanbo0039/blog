import{_ as a,X as l,Y as s,a1 as d,Z as i,$ as n,a2 as t,a0 as r,F as v}from"./framework-68dd73a2.js";const c="/blog/assets/IDEA_4_1.png",u="/blog/assets/IDEA_4_2.png",m="/blog/assets/IDEA_4_3.png",o="/blog/assets/IDEA_4_4.png",p="/blog/assets/IDEA_4_5.png",b={},g={id:"_4-idea-java注释详细设置大全-md",tabindex:"-1"},h=i("a",{class:"header-anchor",href:"#_4-idea-java注释详细设置大全-md","aria-hidden":"true"},"#",-1),E={href:"http://xn--4-IDEA-Java-u56rs91f1g7dk9zc2gc7s8fsual90g.md",target:"_blank",rel:"noopener noreferrer"},f=r(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h3 id="设置最终效果" tabindex="-1"><a class="header-anchor" href="#设置最终效果" aria-hidden="true">#</a> 设置最终效果</h3><blockquote><p>如下所未是我常用的注释最终效果,分享给大家</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>    /**
     * @methodName copyDir
     * &lt;p&gt;
     *    Description:
     * &lt;/p&gt; 
     ...
     * @version 1.0
    */
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>由于一直使用Eclipse，在Eclipse中注释使用是一件非常方便的事， 只需要将别人设置好的注释模板生成.xml文件直接导入而后通过 /** + ENTER 快捷键 在类或者方法上可以使用了，但这是IDEA 所以 习惯使用Eclipse的小伙伴一定要避免以下误区</p></blockquote><p><strong>网络上大把使用EclipseCodeFormatter插件而后导入xml文件而后就可以在IDEA中使用的，本人亲测是不行的！！！！！大家不必去浪费时间，如果有小伙伴用这种方式而成功的，欢迎指导一下本人。</strong></p><h3 id="设置步骤" tabindex="-1"><a class="header-anchor" href="#设置步骤" aria-hidden="true">#</a> 设置步骤</h3><blockquote><p>请进入如下设置界面 file --&gt; setting --&gt; editor</p></blockquote><ol><li>设置 File and Code Templates 里的 Files列表下的 class / interface / Enum / annationtype</li></ol><blockquote><p>这们的共性是取消勾选 Reformat according to style 与Enable Live Templates 两个勾选框，而后代码界面按如下界面设置</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>#if (\${PACKAGE_NAME} &amp;&amp; \${PACKAGE_NAME} != &quot;&quot;)package \${PACKAGE_NAME};#end
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+m+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+o+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+p+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h3><ol><li>测试新建 class / interface / Enum / annationtype</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.yoyling;
/**
 * @className TestClass
 * &lt;p&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>注：取异常值可能有时候取不到， 不过不要紧，在设置里的勾选框，多取消或添加上勾选多测试几次后，只要成功了就一直能取到值了。</strong></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>IDEA-Java注释详细设置大全</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,52);function x(y,A){const e=v("ExternalLinkIcon");return l(),s("div",null,[d(" more "),i("h1",g,[h,n(),i("a",E,[n("4-IDEA-Java注释详细设置大全.md"),t(e)])]),f])}const _=a(b,[["render",x],["__file","idea4.html.vue"]]);export{_ as default};
