...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>抽取接口</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_57_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_57_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>MyService也是同样的操作实现接口MyServiceIfac</strong></p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_57_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="3"><li>抽取接口后各类的代码如下：</li></ol><p><strong>MyController</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package test;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>测试</li></ol><p><strong>如图所示，测试通过</strong><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_57_4.png" alt="" loading="lazy"></p><p><strong>作用：</strong> 调用者跟被调用者不能见面,实现解耦合，无须更改配置文件</p><p><strong>以上就是我对于Java重构代码之面向接口编程 的知识点的总结</strong></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,35);function a(r,v){return i(),n("div",null,[s(" more "),d])}const u=e(t,[["render",a],["__file","java57.html.vue"]]);export{u as default};
