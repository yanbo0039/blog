import{_ as s,X as d,Y as a,a1 as l,Z as i,$ as e,a2 as v,a0 as t,F as c}from"./framework-68dd73a2.js";const r={},u={id:"_207-java面向对象高级特性-多态-接口-md",tabindex:"-1"},m=i("a",{class:"header-anchor",href:"#_207-java面向对象高级特性-多态-接口-md","aria-hidden":"true"},"#",-1),b={href:"http://xn--207-Java---my5qfrs45c7ojmwpkra888bc68dvm7b8m3cek7b95p.md",target:"_blank",rel:"noopener noreferrer"},o=t(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h3 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h3><blockquote><p>接口（interface） ： 对类来说是一套规范，是一套行为协议</p></blockquote><p>&lt;权限访问修饰符&gt; interface 接口名称 { 常量; 抽象方法; }</p><pre><code>     常量默认修饰符：public static final
...
</code></pre><h3 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h3><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter07.接口;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Java面向对象高级特性-多态-接口</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,15);function p(h,g){const n=c("ExternalLinkIcon");return d(),a("div",null,[l(" more "),i("h1",u,[m,e(),i("a",b,[e("207-Java面向对象高级特性-多态-接口.md"),v(n)])]),o])}const _=s(r,[["render",p],["__file","java207.html.vue"]]);export{_ as default};
