import{_ as t,X as e,Y as i,a1 as n,a0 as s}from"./framework-68dd73a2.js";const l={},d=s(`<h1 id="java-实现自动登录功能" tabindex="-1"><a class="header-anchor" href="#java-实现自动登录功能" aria-hidden="true">#</a> Java-实现自动登录功能</h1><p><strong>勾选自动登录：</strong><em>会写cookie:</em> 其实是一个文件 保存在本地硬盘下面 可以通过资源管理器访问到</p><p>cookie文件中保存了你的username password 用户类型，用于下次登陆，只不过是自动的</p><p>如图所示，页面中有一个自动登陆的复选框</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_48_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>**login.jsp：**核心代码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;form name=&quot;form1&quot; method=&quot;post&quot; action=&quot;&lt;%=request.getContextPath()%&gt;/LoginServlet&quot; id=&quot;loginForm&quot;&gt;
...
%&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h5><p><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_48_3.png" alt="" loading="lazy"> 登陆进去之后，可以看到浏览器里是有记录对应的cookie值</p><p>下面见证奇迹的时刻到咯。。。。。。 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_48_1.gif" alt="" loading="lazy"></p><h6 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h6><p>从上面的动态图可以看到，输入登录页面直接跳过咯输入用户名跟密码的页面直接跳到咯主页面，以后自动登录功能实现成功。</p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,20);function u(a,r){return e(),i("div",null,[n(" more "),d])}const o=t(l,[["render",u],["__file","java48.html.vue"]]);export{o as default};
