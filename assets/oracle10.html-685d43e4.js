import{_ as s,X as a,Y as c,a1 as o,Z as t,$ as e,a2 as i,a0 as n,F as l}from"./framework-68dd73a2.js";const u="/blog/assets/Oracle_10_1.png",b="/blog/assets/Oracle_10_2.png",d="/blog/assets/Oracle_10_3.png",p="/blog/assets/Oracle_10_4.png",h={},g=n(`<h1 id="oracle-sql考试试题0-未完成" tabindex="-1"><a class="header-anchor" href="#oracle-sql考试试题0-未完成" aria-hidden="true">#</a> Oracle SQL考试试题0-未完成</h1><p><strong>一</strong>**、执行以下创建<strong><strong>S</strong></strong>tudent****、Teacher、Course、<strong><strong>SC</strong></strong>表****语句，并初始化表格数据**</p><pre><code>create table student(  sno varchar2(10) primary key,  sname varchar2(20),  sage number(2),  ssex varchar2(5)  ); 
...
create table sc(  sno varchar2(10),  cno varchar2(10),  score number(4,2),  constraint pk_sc primary key (sno,cno)  ); 
 ...
 --/*******初始化学生表的数据******/ 
  ...
  commit;
</code></pre><h3 id="练习" tabindex="-1"><a class="header-anchor" href="#练习" aria-hidden="true">#</a> 练习</h3>`,4),m={href:"https://www.2cto.com/database/",target:"_blank",rel:"noopener noreferrer"},v=n(`<pre><code>select * from student;
