import{_ as e,X as n,Y as i,a1 as a,a0 as s}from"./framework-68dd73a2.js";const d="/blog/assets/Oracle_22_1.png",l={},r=s(`<h1 id="oracle初级测试题十四-8-8-约束" tabindex="-1"><a class="header-anchor" href="#oracle初级测试题十四-8-8-约束" aria-hidden="true">#</a> Oracle初级测试题十四(8-8)--约束</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h2 id="练习1" tabindex="-1"><a class="header-anchor" href="#练习1" aria-hidden="true">#</a> 练习1</h2><ol><li>学校有一个选课系统，其中包括如下关系模式：</li></ol><p>系(系编号： 主键， 系名称: 唯一键， 系主任： 非空约束， 系所在校去：取值范围只能在南湖校区和浑南校区)</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>create table tabCollege(
       cgNo number(4) 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,37);function t(c,v){return n(),i("div",null,[a(" more "),r])}const m=e(l,[["render",t],["__file","oracle22.html.vue"]]);export{m as default};
