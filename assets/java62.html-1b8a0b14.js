import{_ as n,X as e,Y as i,a1 as s,a0 as a}from"./framework-68dd73a2.js";const t={},l=a(`<h1 id="java-spring使用注解配置自动装配电脑" tabindex="-1"><a class="header-anchor" href="#java-spring使用注解配置自动装配电脑" aria-hidden="true">#</a> Java-Spring使用注解配置自动装配电脑</h1><p><strong>题目</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>电脑爱好者会自己去电脑城组装电脑，我们用代码完成一台电脑的配置：
...
&lt;/beans&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>测试，如图所示测试成功</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_62_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>拓展测试</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package trainning;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>运行测试，报错信息如下</strong><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_62_2.png" alt="" loading="lazy"></p><p>说明：违反唯一，容器里有多个bean不知道要哪一个</p><p><strong>解决：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@Autowired @Qualifier(&quot;goldenField&quot;)//此处的值默认为首字母小写 
private ComputerCase jixiang;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>再次测试,如图所示测试成功</strong></p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_62_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>以上就是我关于 Java-Spring使用注解配置自动装配电脑 知识点的整理与总结的全部内容</strong></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,28);function d(r,v){return e(),i("div",null,[s(" more "),l])}const o=n(t,[["render",d],["__file","java62.html.vue"]]);export{o as default};
