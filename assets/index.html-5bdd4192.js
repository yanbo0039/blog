...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,8);function q(f,k){const n=s("ExternalLinkIcon");return o(),t("div",null,[l(" more "),m,a("p",null,[e("或者另一种书写法式 "),a("a",v,[e("Google"),i(n)]),e(" 或 "),a("a",g,[e("Yahoo"),i(n)]),e(" 或 "),a("a",b,[e("MSN"),i(n)]),e(" 或 "),a("a",p,[e("The New York Times"),i(n)]),e(".")]),_])}const x=d(u,[["render",q],["__file","index.html.vue"]]);export{x as default};
