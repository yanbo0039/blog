...
from emp,dept;
</code></pre><p><img src="`+g+'" alt="" loading="lazy"><img src="'+_+'" alt="" loading="lazy"><img src="'+h+`" alt="" loading="lazy"></p><p>--2.写一个查询，显示所有工作在CHICAGO并且奖金不为空的员工姓名，工作地点，奖金</p><pre><code>select emp.ename,dept.loc,emp.comm
from emp,dept where dept.loc = &#39;CHICAGO&#39; and emp.comm is not null;
</code></pre><p><img src="`+f+`" alt="" loading="lazy"> --3.写一个查询，显示所有姓名中含有A字符的员工姓名，工作地点。</p><pre><code>select emp.ename,dept.loc 
from emp,dept
...
select * from dept;
select * from emp;
</code></pre><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>Oracle-多表链接</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,49);function v(C,N){return n(),p("div",null,[a(" more "),z])}const E=e(x,[["render",v],["__file","oracle9.html.vue"]]);export{E as default};
