import{_ as e,X as p,Y as o,a1 as l,Z as n,$ as s,a2 as t,a0 as c,F as i}from"./framework-68dd73a2.js";const r={},d={id:"_59-oracle-sql开发-——-序列、索引、同义词-md",tabindex:"-1"},k=n("a",{class:"header-anchor",href:"#_59-oracle-sql开发-——-序列、索引、同义词-md","aria-hidden":"true"},"#",-1),u={href:"http://xn--7iq43lp98c.md",target:"_blank",rel:"noopener noreferrer"},m=c(`<h4 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h4><ul><li>NEXTVAL和CURRVAL伪列 <ul><li>CURRVAL：表示序列返回的当前值；</li><li>NEXTVAL：表示序列返回的下一个值；</li><li>CURRVAL在被引用之前，必须先使用NEXTVAL来产生一个序 列值；</li><li>可用语句 序列名.CURRVAL或 序列名.NEXTVAL来访问序列;</li></ul></li><li>您可以在下列情况使用NEXTVAL 和 CURRVAL： <ul><li>SELECT 语句的SELECT列表中，但不包括子查询中的 SELECT语句</li><li>INSERT 语句中的子查询SELECT列表中</li><li>INSERT 语句的VALUES子句中</li><li>UPDATE 语句的SET子句中</li></ul></li><li>下列情况不能使用 NEXTVAL 和 CURRVAL： <ul><li>在视图的SELECT列表中</li><li>包含DISTINCT关键字的 SELECT语句中</li><li>含有 GROUP BY, HAVING, ORDER BY子句的SELECT语句 中</li><li>SELECT, DELETE, UPDATE 语句的子查询中</li><li>含有 DEFAULT表达式的 CREATE TABLE、 ALTER TABLE 语句中</li></ul></li><li>ROWID <ul><li>是一个伪列，系统自动产生。</li><li>ROWID能唯一标识每一条数据库行记录的物理地址，通过 ROWID 能快速定位到一条行记录</li></ul></li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_59_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>索引( INDEX ): <ul><li>是对数据库表中一个或多个列的值进行排序的一种数据库 对象。</li><li>在数据库中,通过索引可以加速对表的查询速度;</li></ul></li></ul><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--------------------------------------------------------------</span>
