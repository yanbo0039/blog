import{_ as s,X as a,Y as c,a1 as o,Z as t,$ as e,a2 as i,a0 as r,F as l}from"./framework-68dd73a2.js";const u={},d=r(`<h1 id="oracle-sql考试试题0-未完成" tabindex="-1"><a class="header-anchor" href="#oracle-sql考试试题0-未完成" aria-hidden="true">#</a> Oracle SQL考试试题0-未完成</h1><p><strong>一</strong>**、执行以下创建<strong><strong>S</strong></strong>tudent****、Teacher、Course、<strong><strong>SC</strong></strong>表****语句，并初始化表格数据**</p><pre><code>create table student(  sno varchar2(10) primary key,  sname varchar2(20),  sage number(2),  ssex varchar2(5)  ); 
