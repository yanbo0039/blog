import{_ as s,X as t,Y as d,a1 as a,Z as e,$ as n,a2 as l,a0 as o,F as r}from"./framework-68dd73a2.js";const c={},v={id:"_133-java-collections集合工具类介绍-md",tabindex:"-1"},u=e("a",{class:"header-anchor",href:"#_133-java-collections集合工具类介绍-md","aria-hidden":"true"},"#",-1),_={href:"http://xn--133-Java-Collections-nv75a670bzlopv1d517jkvmady1n.md",target:"_blank",rel:"noopener noreferrer"},m=o(`<ul><li>Collections 是类</li><li>Collection 是接口（单例集合祖宗）</li></ul><p><strong>示例代码：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>List&lt;Integer&gt; list = new ArrayList&lt;Integer&gt;();//前面声明咯类型后面也要这样写，然后构造方法一组圆括号
    list.add(123);
//		list.add(null);
    list.add(234);
    list.add(123);
