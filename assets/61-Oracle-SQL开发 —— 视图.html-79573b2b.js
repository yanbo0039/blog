import{_ as e,X as p,Y as o,a1 as t,Z as n,$ as s,a2 as c,a0 as l,F as i}from"./framework-68dd73a2.js";const r="/blog/assets/Oracle_61_1.png",k="/blog/assets/Oracle_61_2.png",d="/blog/assets/Oracle_61_3.png",u={},m={id:"_61-oracle-sql开发-——-视图-md",tabindex:"-1"},v=n("a",{class:"header-anchor",href:"#_61-oracle-sql开发-——-视图-md","aria-hidden":"true"},"#",-1),b={href:"http://xn--wcsr59i.md",target:"_blank",rel:"noopener noreferrer"},w=l('<h4 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h4><figure><img src="'+r+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+k+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>为什么使用视图 <ul><li>限制其它用户对数据库表的访问,因为视图可以 有选择性的显示数据库表的一部分；</li><li>容易实现复杂的查询；</li><li>对于相同的数据可以产生不同的视图</li></ul></li></ul><figure><img src="'+d+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--------------------------------------------------------------</span>
