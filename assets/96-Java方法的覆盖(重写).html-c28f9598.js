import{_ as l,X as s,Y as t,a1 as a,Z as e,$ as n,a2 as d,a0 as r,F as c}from"./framework-68dd73a2.js";const o={},v=r(`<h1 id="_96-java方法的覆盖-重写-md" tabindex="-1"><a class="header-anchor" href="#_96-java方法的覆盖-重写-md" aria-hidden="true">#</a> 96-Java方法的覆盖(重写).md</h1><ul><li><p>方法的覆盖（override)</p><ul><li>重写（rewrite）</li><li>对从父类中继承来的方法进行改造</li><li>在子类继承父类时发生</li></ul></li><li><p>方法覆盖的规则</p><ul><li>在子类中的覆盖方法与父类中被覆盖的方法应具有 <ul><li>相同的方法名</li><li>相同的参数列表（参数数量、参数类型、参数顺序都要相同）</li><li>相同的返回值类型</li><li>子类覆盖方法的访问权限要不小于父类中被覆盖方法的访问权限</li></ul></li></ul></li></ul><p><strong>方法的覆盖也叫方法的重写</strong></p><p><strong>代码示例</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package 方法的重写;
