import{_ as l,X as r,Y as t,a1 as d,Z as e,$ as n,a2 as s,a0 as a,F as u}from"./framework-68dd73a2.js";const v={},c={id:"_93-java-super关键字-md",tabindex:"-1"},m=e("a",{class:"header-anchor",href:"#_93-java-super关键字-md","aria-hidden":"true"},"#",-1),o={href:"http://xn--93-Java-Super-u30v446i5n7q.md",target:"_blank",rel:"noopener noreferrer"},p=a(`<p>现在有Person类Consumer类(继承Person类)和Test类，需求：实例化Consumer，并给username属性赋值</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package super关键字;
