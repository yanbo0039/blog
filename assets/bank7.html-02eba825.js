import{_ as n,X as i,Y as e,a1 as a,a0 as d}from"./framework-68dd73a2.js";const s="/blog/assets/bank_7_1.png",l="/blog/assets/bank_7_2.png",r={},c=d(`<h1 id="七彩神龙" tabindex="-1"><a class="header-anchor" href="#七彩神龙" aria-hidden="true">#</a> 七彩神龙</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="源码" tabindex="-1"><a class="header-anchor" href="#源码" aria-hidden="true">#</a> 源码</h4><div class="language-tn6 line-numbers-mode" data-ext="tn6"><pre class="language-tn6"><code>M:=13;N:=30;
A01:=(C+O+L+H)/4;
...
套牢: (100.000 - MA(A02,M)),COLORGREEN,LINETHICK3;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+l+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',10);function v(t,u){return i(),e("div",null,[a(" more "),c])}const b=n(r,[["render",v],["__file","bank7.html.vue"]]);export{b as default};
