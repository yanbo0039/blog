...
</code></pre><p><img src="`+n+`" alt="" loading="lazy"> --练习二 --1.员工转正后，月薪上调20%，请查询出所有员工转正后的月薪。</p><pre><code>select ename,sal,sal * 1.2 转正后月薪
from emp;
...
</code></pre><p><img src="`+f+'" alt="" loading="lazy"> --2.分别查看员工表、部门表、薪资等级表的表结构。</p><p>左侧 Objects--&gt;Tables--&gt;某表(emp/dept/salgrade)--&gt;右键--&gt;Edit</p><p><img src="'+b+'" alt="" loading="lazy"><img src="'+h+'" alt="" loading="lazy"><img src="'+O+'" alt="" loading="lazy"></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Oracle初级测试题二-编写简单的查询语句</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',33);function z(v,x){return a(),s("div",null,[o(" more "),y])}const j=e(u,[["render",z],["__file","oracle13.html.vue"]]);export{j as default};
