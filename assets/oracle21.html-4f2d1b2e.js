import{_ as d,X as l,Y as t,a1 as s,Z as e,$ as a,a2 as i,a0 as r,F as c}from"./framework-68dd73a2.js";const o={},u=r(`<h1 id="oracle初级测试题十三-12-12-创建和维护表" tabindex="-1"><a class="header-anchor" href="#oracle初级测试题十三-12-12-创建和维护表" aria-hidden="true">#</a> Oracle初级测试题十三(12-12)--创建和维护表</h1><h2 id="练习1" tabindex="-1"><a class="header-anchor" href="#练习1" aria-hidden="true">#</a> 练习1</h2><ol><li>学校想做一个选课系统，其中涉及到课程表，学生表，请分别创建这两个表，自己思考表中应有的列及数据类型。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>--课程表：
...
select * from tab_date_test;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_21_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="3"><li>创建与dept表相同表结构的表dtest，将dept表中部门编号在40之前的信息插入该表。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>create table tab_dtest
as select * from dept
where deptno &lt; 40;

select * from tab_dtest;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_21_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="4"><li>创建与emp表结构相同的表empl，并将其部门编号为前30号的员工信息复制到empl表。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>create table tab_empl
as select * from emp
where deptno &lt;= 30;

select * from tab_empl;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_21_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>试为学生表student增加一列学生性别gender 默认值 “女”。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>alter table tab_student_13 add (gender char(2));
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="拓展知识" tabindex="-1"><a class="header-anchor" href="#拓展知识" aria-hidden="true">#</a> 拓展知识：</h4>`,57),v={href:"https://www.cnblogs.com/dt520/p/10141797.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.cnblogs.com/hijushen/p/4223557.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://blog.csdn.net/msh2016/article/details/86805428",target:"_blank",rel:"noopener noreferrer"},p={href:"https://www.cnblogs.com/lukelook/p/11068258.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://blog.csdn.net/ShadowerWArden/article/details/80658127",target:"_blank",rel:"noopener noreferrer"},h=e("hr",null,null,-1),x=e("h3",{id:"分割线",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),a(" 分割线")],-1),_=e("hr",null,null,-1),f=e("p",null,[e("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function y(k,O){const n=c("ExternalLinkIcon");return l(),t("div",null,[s(" more "),u,e("p",null,[e("a",v,[a("oracle VARCHAR2和NVARCHAR2的区别"),i(n)])]),e("p",null,[e("a",m,[a("Oracle 日期类型timestamp(时间戳)和date类型使用"),i(n)])]),e("p",null,[e("a",b,[a("Oracle入门精读79-Oracle时间操作详解（TIMESTAMP 类型）"),i(n)])]),e("p",null,[e("a",p,[a("ORACLE （BLOB、CLOB、NCLOB、BFILE）"),i(n)])]),e("p",null,[e("a",g,[a("在oracle数据库中存储BLOB类型的数据"),i(n)])]),h,x,_,f])}const B=d(o,[["render",y],["__file","oracle21.html.vue"]]);export{B as default};
