...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_4_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="变量-布尔表达式-语句1-语句2" tabindex="-1"><a class="header-anchor" href="#变量-布尔表达式-语句1-语句2" aria-hidden="true">#</a> 变量 = 布尔表达式 ? 语句1:语句2</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>如果布尔表达式的值为true，则执行语句1
如果布尔表达式的值为false，则执行语句2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="if语句-1" tabindex="-1"><a class="header-anchor" href="#if语句-1" aria-hidden="true">#</a> if语句</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_4_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="☻-练习-ifelse-exercise-java" tabindex="-1"><a class="header-anchor" href="#☻-练习-ifelse-exercise-java" aria-hidden="true">#</a> ☻ 练习 IfElse_exercise.java</h3><p>有两个整型变量x，y，请在控制台上输出x与y中值较大的那个数。</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_4_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>int x = 88;
if(x&lt;60){
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_4_9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="示例-for-sample-java" tabindex="-1"><a class="header-anchor" href="#示例-for-sample-java" aria-hidden="true">#</a> 示例 For_sample.java</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>for(int x=1;x&lt;3;x++){
       System.out.println(&quot;x=&quot;+x);
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="循环的中断" tabindex="-1"><a class="header-anchor" href="#循环的中断" aria-hidden="true">#</a> 循环的中断</h3><p>在使用循环语句时， 只有循环条件表达式的 值为false时，才能结束 循环。有时，我们想提前 中断循环，要实现这一点， 只需要在循环语句块中 添加break或continue语句</p><p>break语句用于终止某个语句块的执行。用在循环语句体中，可以强行退出循环。 “break;”语句：可以出现在while、do…while、for、switch语句体中。 “break label”语句 ：可以出现在任何语句体中。</p><h3 id="示例-break-sample-java" tabindex="-1"><a class="header-anchor" href="#示例-break-sample-java" aria-hidden="true">#</a> 示例 Break_Sample.java</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_4_10.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Test {
    public static void main(String[] args) {
