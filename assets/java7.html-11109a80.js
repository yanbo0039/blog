...
</code></pre><h3 id="java中的字面常量" tabindex="-1"><a class="header-anchor" href="#java中的字面常量" aria-hidden="true">#</a> Java中的字面常量</h3><h3 id="常量指程序里持续不变的值-在整个程序运行过程中它是不可改变的" tabindex="-1"><a class="header-anchor" href="#常量指程序里持续不变的值-在整个程序运行过程中它是不可改变的" aria-hidden="true">#</a> 常量指程序里持续不变的值，在整个程序运行过程中它是不可改变的</h3><h3 id="常见的字面量类型有" tabindex="-1"><a class="header-anchor" href="#常见的字面量类型有" aria-hidden="true">#</a> 常见的字面量类型有：</h3><pre><code>整型字面常量，如：123，067，0X1D，123L
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="常量—java7特性" tabindex="-1"><a class="header-anchor" href="#常量—java7特性" aria-hidden="true">#</a> 常量—java7特性</h3><h3 id="数值常量对下划线支持" tabindex="-1"><a class="header-anchor" href="#数值常量对下划线支持" aria-hidden="true">#</a> 数值常量对下划线支持</h3><pre><code>JDK 7中，你可以在数值常量中使用&#39;_&#39;来提升可读性。
...
操作数转换成字符串类型，然后进行连接
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="自增运算" tabindex="-1"><a class="header-anchor" href="#自增运算" aria-hidden="true">#</a> 自增运算: ++, --</h3><pre><code>i++, 后++, 先将i的值作为整个表达的值, 然后将i增加1.
...
表达式的运算顺序 
</code></pre><h2 id="课后作业" tabindex="-1"><a class="header-anchor" href="#课后作业" aria-hidden="true">#</a> 课后作业</h2><ol><li>已知a,b均是整型变量，写出将a,b两个变量中的值互换的程序。（知识点：变量和运算符综合应用） [必做题]</li><li>给定一个0～1000的整数，求各位数的和，例如345的结果是3+4+5＝12注：分解数字既可以先除后模也可以先模后除（知识点：变量和运算符综合应用） [必做题]</li><li>华氏温度和摄氏温度互相转换，从华氏度变成摄氏度你只要减去32，乘以5再除以9就行了，将摄氏度转成华氏度，直接乘以9，除以5，再加上32即行。[选做题]</li><li>给定一个任意的大写字母A~Z，转换为小写字母。 （知识点：变量和运算符） [选做题]</li></ol><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Java基础应用编程—— 变量和运算符</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,150);function p(g,x){return i(),n("div",null,[a(" more "),o])}const _=e(m,[["render",p],["__file","java7.html.vue"]]);export{_ as default};
