import{_ as n,X as i,Y as t,a1 as e,a0 as s}from"./framework-68dd73a2.js";const l={},d=s(`<h1 id="java-编写一个程序现从命令行参数输入两个字符串类型的数值并计算输出两个数值的和xxx" tabindex="-1"><a class="header-anchor" href="#java-编写一个程序现从命令行参数输入两个字符串类型的数值并计算输出两个数值的和xxx" aria-hidden="true">#</a> Java-编写一个程序现从命令行参数输入两个字符串类型的数值并计算输出两个数值的和XXX</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package MyTask;
