import{_ as t,X as e,Y as i,a1 as n,a0 as s}from"./framework-68dd73a2.js";const l="/blog/assets/Java_48_1.png",d="/blog/assets/Java_48_3.png",u="/blog/assets/Java_48_1.gif",a={},r=s('<h1 id="java-实现自动登录功能" tabindex="-1"><a class="header-anchor" href="#java-实现自动登录功能" aria-hidden="true">#</a> Java-实现自动登录功能</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p><strong>勾选自动登录：</strong><em>会写cookie:</em> 其实是一个文件 保存在本地硬盘下面 可以通过资源管理器访问到</p><p>cookie文件中保存了你的username password 用户类型，用于下次登陆，只不过是自动的</p><p>如图所示，页面中有一个自动登陆的复选框</p><figure><img src="'+l+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>**login.jsp：**核心代码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;form name=&quot;form1&quot; method=&quot;post&quot; action=&quot;&lt;%=request.getContextPath()%&gt;/LoginServlet&quot; id=&quot;loginForm&quot;&gt;
...
%&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h3><p><img src="`+d+'" alt="" loading="lazy"> 登陆进去之后，可以看到浏览器里是有记录对应的cookie值</p><p>下面见证奇迹的时刻到咯。。。。。。 <img src="'+u+'" alt="" loading="lazy"></p><h4 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h4><p>从上面的动态图可以看到，输入登录页面直接跳过咯输入用户名跟密码的页面直接跳到咯主页面，以后自动登录功能实现成功。</p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Java-实现自动登录功能</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',21);function o(v,c){return e(),i("div",null,[n(" more "),r])}const g=t(a,[["render",o],["__file","java48.html.vue"]]);export{g as default};
