import{_ as e,X as a,Y as r,a1 as s,a0 as c}from"./framework-68dd73a2.js";const t="/blog/assets/Oracle_5_1.png",o="/blog/assets/Oracle_5_2.png",n="/blog/assets/Oracle_5_3.png",i="/blog/assets/Oracle_5_4.png",d={},h=c(`<h1 id="初识oracle" tabindex="-1"><a class="header-anchor" href="#初识oracle" aria-hidden="true">#</a> 初识ORACLE</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="oracle" tabindex="-1"><a class="header-anchor" href="#oracle" aria-hidden="true">#</a> Oracle</h4><h4 id="使用系统用户登录oracle" tabindex="-1"><a class="header-anchor" href="#使用系统用户登录oracle" aria-hidden="true">#</a> 使用系统用户登录oracle</h4><pre><code>系统用户：
