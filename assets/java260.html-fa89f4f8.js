import{_ as l,X as i,Y as c,a1 as o,Z as n,$ as s,a2 as t,a0 as e,F as p}from"./framework-68dd73a2.js";const u={},d={id:"_260-javaweb-jdni数据库连接池使用及测试-md",tabindex:"-1"},r=n("a",{class:"header-anchor",href:"#_260-javaweb-jdni数据库连接池使用及测试-md","aria-hidden":"true"},"#",-1),v={href:"http://xn--260-JavaWeb-JDNI-cx4zh97c1k2cjkub7ap9xgt5bhve2v3dmh1iy0wa.md",target:"_blank",rel:"noopener noreferrer"},m=e(`<h4 id="前置条件" tabindex="-1"><a class="header-anchor" href="#前置条件" aria-hidden="true">#</a> 前置条件</h4><ol><li><p>新建了一个JAVA-WEB项目，并运行成功</p></li><li><p>mysql数据库可以通过可视化工具连接成功</p></li><li><p>使用工具ECLIPSE</p></li></ol><h4 id="项目配置" tabindex="-1"><a class="header-anchor" href="#项目配置" aria-hidden="true">#</a> 项目配置</h4><ol><li><p>mysql-connector-java-5.1.39-bin.jar mysql的项目驱动放置在WEB-INF的lib目录下</p></li><li><p>WEB-INF目录下的web.xml的配置如下,仅供参考，按自己所需自行更改</p></li></ol><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token prolog">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span>
...
&lt;/body&gt;
&lt;/html&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15),b={start:"3"},k={href:"http://localhost:8080/tickets/TestDBUtils_pool.jsp",target:"_blank",rel:"noopener noreferrer"},g=n("li",null,[n("p",null,"根据浏览器提示点击")],-1),h=e('<figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_260_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>在跳转后查看Eclipse的控制台</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_260_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>如下图所示则表示连接池配置成功</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_260_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>以上就是我关于 <em>JavaWeb-JDNI数据库连接池使用及测试</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p><hr><h4 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h4><hr><h4 id="扩展知识" tabindex="-1"><a class="header-anchor" href="#扩展知识" aria-hidden="true">#</a> 扩展知识</h4>',10),q={href:"https://blog.csdn.net/weixin_41544662/article/details/121788033",target:"_blank",rel:"noopener noreferrer"},x=n("hr",null,null,-1),_=n("p",null,"分割线",-1),f=n("hr",null,null,-1),j=n("p",null,[n("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function w(S,D){const a=p("ExternalLinkIcon");return i(),c("div",null,[o(" more "),n("h1",d,[r,s(),n("a",v,[s("260-JavaWeb-JDNI数据库连接池使用及测试.md"),t(a)])]),m,n("ol",b,[n("li",null,[n("p",null,[s("启动TOMcatServer并在启动成功后在浏览器中输入 "),n("a",k,[s("http://localhost:8080/tickets/TestDBUtils_pool.jsp"),t(a)]),s(" 仅供参考，按自己所需更改")])]),g]),h,n("ol",null,[n("li",null,[n("a",q,[s("javax.naming.NameNotFoundException: 名称[jdbc/HelixDB]未在此上下文中绑定。找不到[jdbc]"),t(a)])])]),x,_,f,j])}const C=l(u,[["render",w],["__file","java260.html.vue"]]);export{C as default};
