import{_ as e,X as s,Y as l,a1 as i,Z as n,$ as a,a0 as d}from"./framework-68dd73a2.js";const v="/blog/assets/Java_174_1.png",r={},t=n("h1",{id:"_174-java习题-一-md",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_174-java习题-一-md","aria-hidden":"true"},"#"),a(" 174-Java习题(一).md")],-1),u=d(`<ol><li><p>在么是继承，什么是多态，方法的重载和覆盖有何区别(10分)</p></li><li><p>定义类A和类B如下：（10分）</p></li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>    class A{
        int a=1；
        doubled=2.0；
        void show（）{
