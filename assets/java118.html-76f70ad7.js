import{_ as d,X as n,Y as l,a1 as r,Z as t,$ as e,a2 as i,a0 as s,F as c}from"./framework-68dd73a2.js";const u={},o={id:"_118-java-日期类与字符串类之间互转-md",tabindex:"-1"},m=t("a",{class:"header-anchor",href:"#_118-java-日期类与字符串类之间互转-md","aria-hidden":"true"},"#",-1),v={href:"http://xn--118-Java--3c6nmm4jy5as12k7c7atdels7hk9eea6908gfx2a.md",target:"_blank",rel:"noopener noreferrer"},b=s(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h3 id="日期类" tabindex="-1"><a class="header-anchor" href="#日期类" aria-hidden="true">#</a> 日期类</h3><ul><li><p>Date 类</p><ul><li>java.util.Date。</li><li>Date 类表示指定的时间信息，可以精确到毫秒。</li><li>不支持国际化。</li><li>该类的许多方法已过时。</li><li>获取当前系统时间：</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>new  Date();
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>Calendar类常用属性</li></ul><table><thead><tr><th>属性</th><th>含义</th></tr></thead><tbody><tr><td>static int HOUR</td><td>小时时间</td></tr><tr><td>static int MINUTE</td><td>分时间</td></tr><tr><td>static int SECOND</td><td>秒时间</td></tr><tr><td>static int DATE</td><td>日期的Date部分</td></tr><tr><td>static int MONTH</td><td>日期的Month部分</td></tr><tr><td>static int YEAR</td><td>日期的年部分</td></tr></tbody></table><h3 id="simpledateformat类" tabindex="-1"><a class="header-anchor" href="#simpledateformat类" aria-hidden="true">#</a> SimpleDateFormat类</h3><ul><li>SimpleDateFormat类 <ul><li>java.text.SimpleDateFormat 。</li><li>一个以与语言环境相关的方式来格式化和分析日期的具体类。是抽象类java.text.DateFormat类的子类。</li><li>SimpleDateFormat 使得可以选择任何用户定义的日期-时间格式的模式 。</li></ul></li><li>SimpleDateFormat类的使用 <ul><li>获取SimpleDateFormat的实例</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SimpleDateFormat sdf = new SimpleDateFormat(&quot;yyyy-MM-dd HH:mm:ss&quot;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr>`,31),p={class:"hint-container info"},h=t("p",{class:"hint-container-title"},"相关信息",-1),g=t("em",null,"Java-日期类与字符串类之间互转",-1),x={href:"https://github.com/javaobjects/demo516",target:"_blank",rel:"noopener noreferrer"};function D(S,f){const a=c("ExternalLinkIcon");return n(),l("div",null,[r(" more "),t("h1",o,[m,e(),t("a",v,[e("118-Java-日期类与字符串类之间互转.md"),i(a)])]),b,t("div",p,[h,t("p",null,[t("strong",null,[e("以上就是我关于 "),g,e(" 知识点的整理与总结的全部内容，"),t("a",x,[e("另附源码"),i(a)])])])])])}const y=d(u,[["render",D],["__file","java118.html.vue"]]);export{y as default};
