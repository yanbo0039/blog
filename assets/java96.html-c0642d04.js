...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>拓展知识：</strong></p><p>方法的重写与方法的重载的区别：</p><ol><li><strong>方法的重写</strong>参数一定要相同;<strong>方法重载</strong>参数一定不同</li><li><strong>方法的重写</strong>是子类重写父类的方法，至少要两个类;<strong>而方法的重载</strong>是发生在一个类中。</li><li><strong>方法的重写</strong>返回值类型必须相同;而<strong>方法的重载</strong>的返回值类型可以相同也可以不同。</li><li><strong>方法的重写</strong>要求方法的访问权限不小于父类中被覆盖方法的访问权限;而<strong>方法的重载</strong>对权限不作要求。</li></ol><p>方法的重写与方法的重载的相同点：</p><p>唯一的相同点就是<strong>方法名称必须相同</strong>。</p>`,13),u=n("em",null,"Java方法的覆盖(重写)",-1),m={href:"https://github.com/javaobjects/demo514_1",target:"_blank",rel:"noopener noreferrer"},b=n("hr",null,null,-1),g=n("h3",{id:"分割线",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),e(" 分割线")],-1),p=n("hr",null,null,-1),_=n("p",null,[n("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function h(x,f){const i=c("ExternalLinkIcon");return s(),t("div",null,[a(" more "),v,n("p",null,[n("strong",null,[e("以上就是我关于 "),u,e(" 知识点的整理与总结的全部内容，"),n("a",m,[e("另附源码"),d(i)])])]),b,g,p,_])}const k=l(o,[["render",h],["__file","java96.html.vue"]]);export{k as default};
