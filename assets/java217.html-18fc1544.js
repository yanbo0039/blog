import{_ as e,X as s,Y as l,a1 as r,Z as n,$ as t,a2 as d,a0 as a,F as v}from"./framework-68dd73a2.js";const c={},u={id:"_217-java工具类-string类常用方法练习-md",tabindex:"-1"},o=n("a",{class:"header-anchor",href:"#_217-java工具类-string类常用方法练习-md","aria-hidden":"true"},"#",-1),m={href:"http://xn--217-Java-String-bo4x879apq8ckkbz56f9g5apj2b5g9aha817l.md",target:"_blank",rel:"noopener noreferrer"},b=a(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="字符串】编写一个程序-实现从命令行参数输入一字符串-统计该字符串中字符-e-出现的次数" tabindex="-1"><a class="header-anchor" href="#字符串】编写一个程序-实现从命令行参数输入一字符串-统计该字符串中字符-e-出现的次数" aria-hidden="true">#</a> 字符串】编写一个程序，实现从命令行参数输入一字符串，统计该字符串中字符“e”出现的次数</h4><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter01.String类.练习;
