import{_ as l,X as r,Y as a,a1 as s,Z as i,$ as e,a2 as t,a0 as d,F as u}from"./framework-68dd73a2.js";const c={},v={id:"_120-java-字符串类string对象的创建原理-md",tabindex:"-1"},g=i("a",{class:"header-anchor",href:"#_120-java-字符串类string对象的创建原理-md","aria-hidden":"true"},"#",-1),o={href:"http://xn--120-Java-String-313xn00ctngp64b1wcpvw1h3if8l960avmhw05i.md",target:"_blank",rel:"noopener noreferrer"},m=d(`<ul><li><p>字符串是我们在编程中最常使用的一种数据类型，它的表现形式可以分为两种：String和StringBuffer。</p></li><li><p>它不属于8种基本的数据类型，而是一种引用类型。</p></li><li><p>String对象代表一组不可改变的Unicode字符序列，对它的任何修改实际上又产生一个新的字符串，String类对象的内容一旦被初始化就不能再改变。</p></li><li><p>StringBuffer对象代表一组可改变的Unicode字符序列。</p></li><li><p>同时，String类是final类型的类。</p></li><li><p>String的创建：有两种方式:</p><ul><li>静态方式（常用）。像是给变量直接赋值一样来使用。如：String s1 = “abc”; String s2 = “abc”;</li><li>动态方式。动态的内存分配，使用new运算符。如：String s3= new String(“abc”); String s4= new String(“abc”);</li></ul></li></ul><p>那么这两种方式创建的字符串是同一个字符串对象嘛？不，是有区别的。 在于：使用静态方式创建的字符串，在方法区的常量池中只会产生唯一一个字符串对象，使用该方式产生同样一个字符串时，内存中不再开辟另外一块空间，而是两个引用变量指向同一个字符串对象。使用动态方式创建的字符串，在堆内存中会产生出不同的对象。</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_120_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>String对象的创建 <ul><li>String类的构造方法 <ul><li>初始化一个新创建的 String 对象，它表示一个空字符序列。</li></ul></li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>String 变量名 = new String () ;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_120_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,26),b=i("em",null,"Java-字符串类String对象的创建原理",-1),S={href:"https://github.com/javaobjects/demo516",target:"_blank",rel:"noopener noreferrer"},p=i("hr",null,null,-1),h=i("h3",{id:"分割线",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),e(" 分割线")],-1),x=i("hr",null,null,-1),f=i("p",null,[i("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function _(y,q){const n=u("ExternalLinkIcon");return r(),a("div",null,[s(" more "),i("h1",v,[g,e(),i("a",o,[e("120-Java-字符串类String对象的创建原理.md"),t(n)])]),m,i("p",null,[i("strong",null,[e("以上就是我关于 "),b,e(" 知识点的整理与总结的全部内容，"),i("a",S,[e("另附源码"),t(n)])])]),p,h,x,f])}const k=l(c,[["render",_],["__file","java120.html.vue"]]);export{k as default};
