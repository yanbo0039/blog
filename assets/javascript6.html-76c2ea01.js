import{_ as i,X as n,Y as e,a1 as t,a0 as a}from"./framework-68dd73a2.js";const s="/blog/assets/JavaScript_6_1.png",r="/blog/assets/JavaScript_6_2.gif",l="/blog/assets/JavaScript_6_3.png",d={},v=a('<h1 id="javascript实践数据结构和算法——插入排序" tabindex="-1"><a class="header-anchor" href="#javascript实践数据结构和算法——插入排序" aria-hidden="true">#</a> JavaScript实践数据结构和算法——插入排序</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p><img src="'+s+'" alt="" loading="lazy"><img src="'+r+`" alt="" loading="lazy"></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!DOCTYPE html&gt;
&lt;html lang=&quot;en&quot;&gt;
&lt;head&gt;
    &lt;meta charset=&quot;UTF-8&quot;&gt;
    &lt;title&gt;插入排序&lt;/title&gt;
