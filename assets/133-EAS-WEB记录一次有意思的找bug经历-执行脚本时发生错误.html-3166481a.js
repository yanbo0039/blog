...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>其它辅助信息</li></ol><figure><img src="`+v+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>就以上信息，目的是去解决它！！！！？？？</p></blockquote><h4 id="解决步骤" tabindex="-1"><a class="header-anchor" href="#解决步骤" aria-hidden="true">#</a> 解决步骤</h4><blockquote><p>此刻我的脑瓜子是蒙的，但冷静下来并且消夏大量时间后用以下步骤</p></blockquote><ol><li>查看错误日志</li></ol><figure><img src="'+m+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>拿到如下错误日志</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>执行脚本时发生错误,脚本:java.sql.Connection con =com.kingdee.bos.framework.ejb.EJBFactory.getConnection ( __bosContext);
java.sql.Statement batchStatement=con.createStatement();
java.lang.StringBuffer Sql = new java.lang.StringBuffer();
Sql.append(&quot;select a.famount*0.8  amt from T_CON_ContractBill as a inner join T_CON_PayRequestBill as b on a.fid=b.fcontractid where b.fid =&#39;&quot;+ID+&quot;&#39;&quot;);
rs=batchStatement.executeQuery(Sql.toString());
