...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="对象的读写总结" tabindex="-1"><a class="header-anchor" href="#对象的读写总结" aria-hidden="true">#</a> 对象的读写总结：</h4><ol><li>对象的序列化和反序列化</li></ol><p>在互联网上传输数据，一般都是二进制数据， Object-&gt;二进制数据： 对象的序列化 二进制数据-&gt;Object: 对象的反序列化</p><ol start="2"><li><p>为什么要进行序列化和反序列化？传输效率高，传输安全</p></li><li><p>技术实现，要让传输的类实现序列化接口，生成序列号</p></li><li><p>transient关键字可以忽略要序列化的属性，不会对这个属性序列化，起到保护数据的作用</p></li></ol><h4 id="拓展知识点" tabindex="-1"><a class="header-anchor" href="#拓展知识点" aria-hidden="true">#</a> 拓展知识点：</h4>`,14),p={href:"https://blog.csdn.net/weixin_38080573/article/details/90213901",target:"_blank",rel:"noopener noreferrer"},h={href:"https://www.cnblogs.com/zhzhlong/p/10000138.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://blog.csdn.net/sphinx1122/article/details/89789929",target:"_blank",rel:"noopener noreferrer"},_=e("em",null,"对象的读与写以及对象的序列化和反序列化",-1),x={href:"https://github.com/javaobjects/demo520",target:"_blank",rel:"noopener noreferrer"},f=e("hr",null,null,-1),j=e("h3",{id:"分割线",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),n(" 分割线")],-1),S=e("hr",null,null,-1),w=e("p",null,[e("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function O(k,F){const t=c("ExternalLinkIcon");return s(),l("div",null,[d(" more "),e("h1",v,[o,n(),e("a",m,[n("144-Java-对象的读与写以及对象的序列化和反序列化.md"),i(t)])]),b,e("p",null,[e("a",p,[n("新增的文件无法用git status检测到"),i(t)])]),e("p",null,[e("a",h,[n("git status检测不到文件变化"),i(t)])]),e("p",null,[e("a",g,[n("git add 多个文件和文件夹的方法"),i(t)])]),e("p",null,[e("strong",null,[n("以上就是我关于 "),_,n(" 知识点的整理与总结的全部内容,"),e("a",x,[n("另附源码"),i(t)])])]),f,j,S,w])}const q=a(u,[["render",O],["__file","java144.html.vue"]]);export{q as default};
