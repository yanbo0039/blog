import{_ as e,X as a,Y as n,a1 as t,a0 as r}from"./framework-68dd73a2.js";const o="/blog/assets/Oracle_15_1.png",i="/blog/assets/Oracle_15_2.png",s="/blog/assets/Oracle_15_3.png",p="/blog/assets/Oracle_15_4.png",c="/blog/assets/Oracle_15_5.png",l="/blog/assets/Oracle_15_6.png",g="/blog/assets/Oracle_15_7.png",d="/blog/assets/Oracle_15_8.png",m="/blog/assets/Oracle_15_9.png",_="/blog/assets/Oracle_15_10.png",f="/blog/assets/Oracle_15_11.png",h="/blog/assets/Oracle_15_12.png",u="/blog/assets/Oracle_15_13.png",b="/blog/assets/Oracle_15_14.png",y="/blog/assets/Oracle_15_15.png",x="/blog/assets/Oracle_15_16.png",O="/blog/assets/Oracle_15_17.png",z="/blog/assets/Oracle_15_18.png",A="/blog/assets/Oracle_15_19.png",R="/blog/assets/Oracle_15_20.png",w="/blog/assets/Oracle_15_21.png",D="/blog/assets/Oracle_15_22.png",N="/blog/assets/Oracle_15_23.png",M="/blog/assets/Oracle_15_24.png",Y="/blog/assets/Oracle_15_25.png",q={},$=r(`<h1 id="oracle初级测试题四-单行函数" tabindex="-1"><a class="header-anchor" href="#oracle初级测试题四-单行函数" aria-hidden="true">#</a> Oracle初级测试题四--单行函数</h1><p>--练习1</p><p>--1.写一个查询,用首字母大写，其它字母小写显示雇员的 ename， --显示名字的长度，并给每列一个适当的标签，条件是满足所有雇员名字的开始字母是J、A 或 M 的雇员， --并对查询结果按雇员的ename升序排序。（提示：使用initcap、length、substr）</p><pre><code>select initcap(ename) as 首字母大写,
...
order by ename asc;
</code></pre><figure><img src="`+o+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--练习2</p><p>--1.查询员工姓名中中包含大写或小写字母A的员工姓名。</p><pre><code>select ename,
instr(ename,&#39;a&#39;),
instr(ename,&#39;A&#39;)
from emp
where instr(ename,&#39;a&#39;) &lt;&gt; 0 or instr(ename,&#39;A&#39;) &lt;&gt; 0;
</code></pre><figure><img src="`+i+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--2.查询部门编号为10或20，入职日期在81年5月1日之后，并且姓名中包含大写字母A的员工姓名，员工姓名长度（提示，要求使用INSTR函数，不能使用like进行判断)</p><pre><code>select ename,
length(ename),
hiredate,
deptno,
instr(ename,&#39;A&#39;)
...
from emp;
</code></pre><figure><img src="`+_+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--2.查询部门10,20的员工截止到2000年1月1日，工作了多少个月，入职的月份。(提示：使用months_between,extract)</p><pre><code>select hiredate,
trunc(months_between(&#39;01-1月-00&#39;,hiredate)) 工作月数,
extract(month from hiredate)
from emp
where deptno in(10,20);
</code></pre><figure><img src="`+f+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--3.如果员工试用期6个月，查询职位不是MANAGER的员工姓名，入职日期，转正日期，入职日期后的第一个星期一,入职当月的最后一天日期。（提示：使用add_months,next_day,last_day)</p><pre><code>select hiredate as 入职日期,
...
from emp;
</code></pre><figure><img src="`+Y+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>',96);function E(v,S){return a(),n("div",null,[t(" more "),$])}const B=e(q,[["render",E],["__file","15-Oracle初级测试题四--单行函数.html.vue"]]);export{B as default};
