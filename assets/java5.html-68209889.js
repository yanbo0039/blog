import{_ as e,X as a,Y as i,a1 as n,a0 as d}from"./framework-68dd73a2.js";const r={},s=d(`<h1 id="java基础应用编程——-数组" tabindex="-1"><a class="header-anchor" href="#java基础应用编程——-数组" aria-hidden="true">#</a> Java基础应用编程—— 数组</h1><h2 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h2><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="一维数组" tabindex="-1"><a class="header-anchor" href="#一维数组" aria-hidden="true">#</a> 一维数组</h2><h3 id="数组的定义和创建" tabindex="-1"><a class="header-anchor" href="#数组的定义和创建" aria-hidden="true">#</a> 数组的定义和创建</h3><p>数组可以看成是多个相同类型数据的组合，实现对这些数据的统一管理</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{1，2，3，4，5}
...
数组的类型 -- type
数组的名称 – name
</code></pre><h3 id="数组的定义和创建-1" tabindex="-1"><a class="header-anchor" href="#数组的定义和创建-1" aria-hidden="true">#</a> 数组的定义和创建</h3><p>数组类型 数组名 [ ]</p><p>或</p><p>数组类型[ ] 数组名</p><h3 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="数组的定义和创建-2" tabindex="-1"><a class="header-anchor" href="#数组的定义和创建-2" aria-hidden="true">#</a> 数组的定义和创建</h3><p>数组名 = new 数据元素类型[ 元素个数 ]</p><h3 id="示例-1" tabindex="-1"><a class="header-anchor" href="#示例-1" aria-hidden="true">#</a> 示例</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="数组的内存模型" tabindex="-1"><a class="header-anchor" href="#数组的内存模型" aria-hidden="true">#</a> 数组的内存模型</h3><p>数组是存储多个相同类型变量的对象。数组的所有元素保存在堆内存中。 创建一个数组就是在堆中创建一个数组对象。 数组创建后立即拥有默认值。 索引从0开始。 连续分配</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="数组的初始化" tabindex="-1"><a class="header-anchor" href="#数组的初始化" aria-hidden="true">#</a> 数组的初始化</h3><p>在创建数组的同时就为数组元素分配空间并赋值</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>声明数组：和使用变量要先声明一样，先声明数组的类型和名称</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>int[] = myNumbers;
...
myNumbers[2] = 15;
myNumbers[3] = 20;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="数组元素的访问" tabindex="-1"><a class="header-anchor" href="#数组元素的访问" aria-hidden="true">#</a> 数组元素的访问</h2><p>Java中，数组元素的下标从0开始</p><p>元素的下标可以是整型常量或整型表达式</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="数组的属性" tabindex="-1"><a class="header-anchor" href="#数组的属性" aria-hidden="true">#</a> 数组的属性</h3><p>数组的长度(length)必须&gt;=0；</p><p>length为只读。</p><p>利用length遍历数组</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>   示例      Test.java
   int[ ] array ;
   array  = new int [4] ;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="多维数组的创建" tabindex="-1"><a class="header-anchor" href="#多维数组的创建" aria-hidden="true">#</a> 多维数组的创建</h3><p>Java中没有真正的多维数组，只有数组的数组 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_8.png" alt="" loading="lazy"></p><h3 id="锯齿数组" tabindex="-1"><a class="header-anchor" href="#锯齿数组" aria-hidden="true">#</a> 锯齿数组</h3><p>Java中多维数组不一定是规则矩阵形式</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="多维数组的创建-1" tabindex="-1"><a class="header-anchor" href="#多维数组的创建-1" aria-hidden="true">#</a> 多维数组的创建</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>数组类型   数组名 [  ] [  ]
数组类型[  ] [  ]   数组名
数组类型[  ]   数组名 [  ]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_10.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="☻-练习" tabindex="-1"><a class="header-anchor" href="#☻-练习" aria-hidden="true">#</a> ☻ 练习</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    int[ ][ ]a = new int[3][4]; 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="冒泡排序法-bubble-sort" tabindex="-1"><a class="header-anchor" href="#冒泡排序法-bubble-sort" aria-hidden="true">#</a> 冒泡排序法（Bubble Sort）</h3><p>冒泡排序法是一种简单的排序算法 它重复地走访过要排序的数组，一次比较两个元素，如果他们的顺序错误就把他们交换过来。走访数组的工作是重复地进行直到没有再需要交换，也就是说该数组已经排序完成。</p><h3 id="冒泡排序法-bubble-sort-1" tabindex="-1"><a class="header-anchor" href="#冒泡排序法-bubble-sort-1" aria-hidden="true">#</a> 冒泡排序法（Bubble Sort）</h3><p>假设输入6个数为：9，8，5，4，2，0。 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_11.png" alt="" loading="lazy"></p><p>经过第一趟(共5次比较与交换)后，最大的数9已“沉底” 。</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_5_12.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>然后进行对余下的前面5个数第二趟比较，如果有n个数，则要进行n-1趟比较。在第1趟比较中要进行n-1次两两比较，在第j趟比较中要进行n-j次两两比较。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>按上面的规律，要将n个元素排序，其核心代码表示如下：
  for（i = 1; i &lt; n; i++）
   {
      for（j = 0; j &lt; n-i; j++）
       {
