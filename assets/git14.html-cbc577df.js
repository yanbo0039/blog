import{_ as i,X as e,Y as t,a1 as n,a0 as a}from"./framework-68dd73a2.js";const s="/blog/assets/Git_14_1.png",l="/blog/assets/Git_14_2.png",d="/blog/assets/Git_14_3.png",r="/blog/assets/Git_14_4.png",c="/blog/assets/Git_14_5.png",o="/blog/assets/Git_14_6.png",g="/blog/assets/Git_14_7.png",u={},v=a('<h1 id="_14-git-如何将本地项目上传到gitee或github-md" tabindex="-1"><a class="header-anchor" href="#_14-git-如何将本地项目上传到gitee或github-md" aria-hidden="true">#</a> 14-Git-如何将本地项目上传到Gitee或Github？.md</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="需求背景" tabindex="-1"><a class="header-anchor" href="#需求背景" aria-hidden="true">#</a> 需求背景</h4><blockquote><p>如果我们在本地完成了一个 项目 那么我们想将其远程传入Github 或者 Gitee 那么应该如何操作呢？</p></blockquote><h4 id="实现过程" tabindex="-1"><a class="header-anchor" href="#实现过程" aria-hidden="true">#</a> 实现过程</h4><blockquote><p>以 Github 为例</p></blockquote><ol><li>在 Github 上新建一个与 <strong>项目同名</strong> 文件夹</li></ol><figure><img src="'+s+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+l+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+d+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>根据其提示可知 需要先git进入到本地项目</li></ol><blockquote><p>例如我的项目路径在 E:\\Tencent\\FileCrud 那么我只需在git界面运行如下代码即可进入</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>cd /E/Tencent/fileCurd
