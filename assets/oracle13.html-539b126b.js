import{_ as e,X as a,Y as s,a1 as o,a0 as t}from"./framework-68dd73a2.js";const r="/blog/assets/Oracle_13_1.png",c="/blog/assets/Oracle_13_2.png",l="/blog/assets/Oracle_13_3.png",n="/blog/assets/Oracle_13_4.png",p="/blog/assets/Oracle_13_5.png",i="/blog/assets/Oracle_13_6.png",g="/blog/assets/Oracle_13_7.png",m="/blog/assets/Oracle_13_8.png",_="/blog/assets/Oracle_13_9.png",d="/blog/assets/Oracle_13_10.png",f="/blog/assets/Oracle_13_11.png",b="/blog/assets/Oracle_13_12.png",h="/blog/assets/Oracle_13_13.png",u="/blog/assets/Oracle_13_14.png",O={},y=t(`<h1 id="oracle初级测试题二-编写简单的查询语句" tabindex="-1"><a class="header-anchor" href="#oracle初级测试题二-编写简单的查询语句" aria-hidden="true">#</a> Oracle初级测试题二-编写简单的查询语句</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p>--练习一</p><p>--1.使用两种方式查询所有员工(EMP)信息</p><pre><code>select * from emp;
...
from emp;
</code></pre><p><img src="`+l+`" alt="" loading="lazy"> --2.员工试用期6个月，转正后月薪上调20%， --请查询出所有员工工作第一年的年薪所得（不考虑奖金部分,年薪的试用期6个月的月薪+转正后6个月的月薪)</p><pre><code>select ename,sal * 6 + sal * 1.2 * 6 as 第一年年薪
from emp;
