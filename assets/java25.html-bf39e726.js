import{_ as i,X as n,Y as t,a1 as e,a0 as s}from"./framework-68dd73a2.js";const l={},d=s(`<h1 id="java初级测试题四-数组-9-9" tabindex="-1"><a class="header-anchor" href="#java初级测试题四-数组-9-9" aria-hidden="true">#</a> Java初级测试题四- 数组(9-9)</h1><ol><li>编写一个简单程序，要求数组长度为5，分别赋值10，20，30，40，50，在控制台输出该数组的值。（知识点：数组定义和创建、一维数组初始化）</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Task {
	/*
	 * 1. 编写一个简单程序，要求数组长度为5
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>有2个多维数组分别是</li></ol><table><thead><tr><th>A</th><th>B</th></tr></thead><tbody><tr><td>2 3 4</td><td>1 5 2 8</td></tr><tr><td>4 6 8</td><td>5 9 10 3</td></tr><tr><td></td><td>2 7 -5 -18</td></tr><tr><td>按照如下方式进行运算。生成一个2行4列的数组。此数组的第1行1列是2<em>1+3</em>5+4<em>2第1行2列是2</em>5+3<em>9+4</em>7 第2行1列是4<em>1+6</em>5+8*2 依次类推。（知识点：多维数组定义和创建、数组遍历、数组元素访问）</td><td></td></tr></tbody></table><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_25_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public static void arraySum() {
