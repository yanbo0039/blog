import{_ as a,X as t,Y as d,a1 as l,Z as e,$ as n,a2 as r,a0 as s,F as o}from"./framework-68dd73a2.js";const c={},v={id:"_142-eas-gui单据头值改变事件案例-md",tabindex:"-1"},u=e("a",{class:"header-anchor",href:"#_142-eas-gui单据头值改变事件案例-md","aria-hidden":"true"},"#",-1),m={href:"http://xn--142-EAS-GUI-jz9qp7bv9c11drutx7bt76bgn8bmrh5vq.md",target:"_blank",rel:"noopener noreferrer"},b=s(`<h4 id="需求背景" tabindex="-1"><a class="header-anchor" href="#需求背景" aria-hidden="true">#</a> 需求背景</h4><blockquote><p>笔者有遇到这么一个需求，一个F7字段在前，另一F7字段在后，当A F7字段进行选择时，B F7 根据A F7 字段选择的值进行过滤</p></blockquote><h4 id="实现步骤" tabindex="-1"><a class="header-anchor" href="#实现步骤" aria-hidden="true">#</a> 实现步骤</h4><ol><li>找到AF7字段的Edit.ui并选择此字段的属性，在事件里找到datachange将其方法放出来,并保存</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_142_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li><p>在<strong>业务建模</strong>视图将此单据重新发布</p></li><li><p>在Edit类里重写此方法</p></li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_142_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>/**
