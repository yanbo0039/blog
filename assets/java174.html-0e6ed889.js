...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="7"><li><p>用JAVA实现冒泡排序。(15分)</p></li><li><p>数据库题目，有3张表(20分)</p></li></ol><p>Student 学生表 (学号、姓名、性别、年龄、组织部门）</p><p>Course课程表（编号、课程名称）</p><p>Sc选课表（学号、课程编号、成绩）</p><figure><img src="`+v+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>1、写一个SQL语句，查询选修了&quot;计算机原理&quot;的学生学号和姓名(5分)</p><p>2、写一个SQL语句，查询&quot;周星驰&quot;同学选修了的课程名称(5分)</p><p>3、写一个SQL语句，查询选修了至少3门课程以上的学生学号和姓名(10分)</p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>Java习题(一)</em> 知识点整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',28);function m(o,b){return s(),a("div",null,[n(" more "),r,u,n(" 凯通"),c])}const g=e(t,[["render",m],["__file","java174.html.vue"]]);export{g as default};
