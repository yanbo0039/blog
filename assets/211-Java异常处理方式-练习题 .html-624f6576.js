import{_ as n,X as i,Y as e,a1 as t,a0 as s}from"./framework-68dd73a2.js";const l={},d=s(`<h1 id="_211-java异常处理方式-练习题-md" tabindex="-1"><a class="header-anchor" href="#_211-java异常处理方式-练习题-md" aria-hidden="true">#</a> 211-Java异常处理方式-练习题 .md</h1><h4 id="编写应用程序-从命令行传入两个整型数作为除数和被除数。" tabindex="-1"><a class="header-anchor" href="#编写应用程序-从命令行传入两个整型数作为除数和被除数。" aria-hidden="true">#</a> 编写应用程序，从命令行传入两个整型数作为除数和被除数。</h4><blockquote><p>1、编写应用程序，从命令行传入两个整型数作为除数和被除数。要求程序中捕获NumberFormatException 异常和ArithmeticException 异常，而且无论在哪种情况下，“总是被执行”这句话都会在控制台输出。 [必作题] 在命令行输入不同的参数时能输出如下各种结果：</p></blockquote><pre><code>	1.1 在命令行输入 &lt;零个参数&gt;
	1.2 在命令行输入   1  和  2
	1.3 在命令行输入  1  和   3a
	1.4 在命令行输入  1  和   0 
