...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="云苍穹插件编程原理" tabindex="-1"><a class="header-anchor" href="#云苍穹插件编程原理" aria-hidden="true">#</a> 云苍穹插件编程原理</h3><blockquote><p>理解云苍穹插件原理只需要明白三个概念即可</p></blockquote><h3 id="什么是表单视图模型" tabindex="-1"><a class="header-anchor" href="#什么是表单视图模型" aria-hidden="true">#</a> 什么是表单视图模型？</h3><blockquote><p>金蝶云苍穹，是B/S结构的，使用不同的客户端（PC端、移动端），通过网络连接到统一的服务端。 用户看到的交互界面，是运行在客户端的，而业务逻辑和业务插件，则运行在服务端；业务插件运行在服务端， 没办法直接获取到客户端界面上控件句柄，不能直接控制前端控件。但插件可以通过系统封装的视图模型接口IFormView， 间接的访问、控制前端界面。所以<strong>IFormView则是表单视图模型</strong>，插件可以通过this.getView()方法，获取表单的视图模型接口实例；</p></blockquote><h3 id="什么是控件编程模型" tabindex="-1"><a class="header-anchor" href="#什么是控件编程模型" aria-hidden="true">#</a> 什么是控件编程模型？</h3><blockquote><p>通过系统封装的各种控件代理对象，间接的访问、控制前端界面上的控件；<strong>这些运行在服务端的控件代理对象，称为控件编程模型，</strong> 或简称为控件、编程模型等。可以通过this.getView().getControl(String key)方法，获取到控件编程模型实例；</p></blockquote><h3 id="什么是表单数据模型" tabindex="-1"><a class="header-anchor" href="#什么是表单数据模型" aria-hidden="true">#</a> 什么是表单数据模型？</h3><blockquote><p>表单的界面与数据，是分离：</p></blockquote><ul><li>界面显示在客户端浏览器或者移动端，在服务端，系统封装了视图模型及控件编程模型来间接控制前端界面及前端控件；</li><li>数据存储在服务端，在服务端，系统封装了数据模型，来控制界面上的数据；</li></ul><blockquote><p>表单的数据模型，提供各种方法访问界面数据，并且持有：</p></blockquote><ul><li>主实体模型：MainEntityType，表单运行时元数据对象，包含： <ul><li>子实体：EntityType，对应单据体、子单据体等；</li><li>属性：DynamicProperty，对应字段；</li></ul></li><li>界面数据包：DynamicObject，基于主实体模型构建的一个数据字典，存储单据体、字段值；</li></ul><figure><img src="`+o+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="插件的简单试验" tabindex="-1"><a class="header-anchor" href="#插件的简单试验" aria-hidden="true">#</a> 插件的简单试验</h3><ol><li>视图模型</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package kd.bos.dynamicform.plugin;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用案例" tabindex="-1"><a class="header-anchor" href="#使用案例" aria-hidden="true">#</a> 使用案例</h3><blockquote><p>使用案例在后续写出来。。</p></blockquote><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>金蝶云苍穹插件原理理解与使用</em> 知识点的整理与总结的全部内容,希望对你有帮助。。。。。。</strong></p></div>`,34);function g(h,w){const n=v("ExternalLinkIcon");return l(),d("div",null,[s(" more "),e("h1",u,[m,i(),e("a",b,[i("64-金蝶云苍穹插件原理理解与使用.md"),a(n)])]),p])}const q=t(c,[["render",g],["__file","kingdee64.html.vue"]]);export{q as default};
