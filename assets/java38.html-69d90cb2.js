import{_ as e,X as i,Y as n,a1 as s,a0 as t}from"./framework-68dd73a2.js";const r={},a=t(`<h1 id="java-参数配置化" tabindex="-1"><a class="header-anchor" href="#java-参数配置化" aria-hidden="true">#</a> Java-参数配置化</h1><p>使用工具：</p><p>eclipse</p><h6 id="首先在自己项目文件的src文件夹上右键-new-file-输入-文件名-properties" tabindex="-1"><a class="header-anchor" href="#首先在自己项目文件的src文件夹上右键-new-file-输入-文件名-properties" aria-hidden="true">#</a> 首先在自己项目文件的src文件夹上右键-----&gt;new-----&gt;file----&gt;输入 文件名.properties</h6><p>如图：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_38_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>项目目录 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_38_2.png" alt="" loading="lazy"></p><p>以下以sql的配置为例，其它工程同理：</p><p>jdbc.properties:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>jdbc_url=jdbc:oracle:thin:@localhost:1521:orcl
jdbc_username=scott
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,18);function d(l,v){return i(),n("div",null,[s(" more "),a])}const u=e(r,[["render",d],["__file","java38.html.vue"]]);export{u as default};
