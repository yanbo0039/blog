import{_ as a,X as l,Y as d,a1 as s,Z as i,$ as e,a2 as t,a0 as r,F as v}from"./framework-68dd73a2.js";const c={},u={id:"_4-idea-java注释详细设置大全-md",tabindex:"-1"},m=i("a",{class:"header-anchor",href:"#_4-idea-java注释详细设置大全-md","aria-hidden":"true"},"#",-1),o={href:"http://xn--4-IDEA-Java-u56rs91f1g7dk9zc2gc7s8fsual90g.md",target:"_blank",rel:"noopener noreferrer"},p=r(`<h4 id="设置最终效果" tabindex="-1"><a class="header-anchor" href="#设置最终效果" aria-hidden="true">#</a> 设置最终效果</h4><blockquote><p>如下所未是我常用的注释最终效果,分享给大家</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>    /**
     * @methodName copyDir
     * &lt;p&gt;
     *    Description:
     * &lt;/p&gt; 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>只贴一个示意图，方便大家理解,设置完成apply一下就行了</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/IDEA_4_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>备注：网络上一大把博客，你抄我抄你的叫我们设置Includes，本人亲测，不用设置，如果你设置了那么恭喜你，新建类等在它的开头会出现两段注释，不用感谢我！！！！！！！！</strong></p><ol start="2"><li>设置 Live Templates</li></ol><ul><li><p>1.点击右边 + 号选择 Template Group 新建一个分组命名为 Custom</p></li><li><ol start="2"><li>然后再在这个分组下新建一个 Live Template</li></ol></li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/IDEA_4_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li><ol start="3"><li>Abbreviation: * Description：方法注释</li></ol></li><li><ol start="4"><li>Template text：</li></ol></li></ul><p><strong>注：如下代码是没有/*的是以*开头的不要弄错了</strong></p><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>*
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/IDEA_4_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/IDEA_4_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/IDEA_4_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h4><ol><li>测试新建 class / interface / Enum / annationtype</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.yoyling;
/**
 * @className TestClass
 * &lt;p&gt;
