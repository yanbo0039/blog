import{_ as e,X as i,Y as n,a1 as a,a0 as l}from"./framework-68dd73a2.js";const s={},r=l(`<h1 id="_104-eas客户端打开list界面时报错getmainbizorgtype-should-return-a-correct-value-如何解决-md" tabindex="-1"><a class="header-anchor" href="#_104-eas客户端打开list界面时报错getmainbizorgtype-should-return-a-correct-value-如何解决-md" aria-hidden="true">#</a> 104-EAS客户端打开List界面时报错getMainBizOrgType() should return a correct value 如何解决？.md</h1><h4 id="导读" tabindex="-1"><a class="header-anchor" href="#导读" aria-hidden="true">#</a> 导读</h4><hr><blockquote><p>有种男人思想上流氓，生活中好男人，兄弟面前不要脸，熟人面前神经病，看似百毒不侵，却被一个女的要了半条命！</p></blockquote><hr><h4 id="操作步骤" tabindex="-1"><a class="header-anchor" href="#操作步骤" aria-hidden="true">#</a> 操作步骤</h4><blockquote><p>如下图所示配置了客户端菜单后点击list界面想要进入查看，报如下所示错误</p></blockquote><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_104_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>详细报错如下</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>错误信息：getMainBizOrgType() should return a correct value.
