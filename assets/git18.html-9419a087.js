import{_ as n,X as s,Y as a,a1 as e,a0 as t}from"./framework-68dd73a2.js";const i={},l=t(`<h1 id="git-githubaction实现提交代码至私有库自动打包编译提交部署至公开库" tabindex="-1"><a class="header-anchor" href="#git-githubaction实现提交代码至私有库自动打包编译提交部署至公开库" aria-hidden="true">#</a> Git-GithubAction实现提交代码至私有库自动打包编译提交部署至公开库？</h1><h3 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求</h3><ol><li>我有这样一个需求，如果我能够通过Git提交代码它能帮我自动打包部署至Github服务器那我不就会很省事</li></ol><ul><li>当然很幸运github action提供了这样一个功能</li></ul><h3 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h3><ol><li>我是这样实现的，我有一个源码仓库 vuepress-theme-hope 这是不公开的 一个公开库 blog 这是展示打包编译后的代码的库</li><li>私有库 vuepress-theme-hope 只有一个分支 master</li><li>私有库 vuepress-theme-hope 在仓库的setting --&gt; Sercets and variables --&gt; Actions --&gt; New repository secrets 里新建四个变量值以备后续使用</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>AS_TOKEN ： 页面右上解用户名的setting --&gt; Developer settings --&gt; Presonal access tokens --&gt; Tokens(classic) 
...
<span class="token comment">#        4. 执行打包命令</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> 部署到 Gitee 服务器
        ...
        <span class="token key atrule">with</span><span class="token punctuation">:</span>
          ...
          <span class="token key atrule">branch</span><span class="token punctuation">:</span> gh<span class="token punctuation">-</span>pages
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>照如上步骤配置完成后，即可实现每次向 vuepress-theme-hope 的 master 分支提交代码后则会自动打包提交部署至Github 以及 Gitee 的blog仓库 即可通过github生成的url进行访问生成的网页</li><li>当前前提是你的Github 及 Gitee 里 对应的仓库</li></ul><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h3><ul><li>下图是我多次测试成功的记录</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Git_18_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>以上就是我关于 <em>Git-GithubAction实现提交代码至私有库自动打包编译提交部署至公开库</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p>`,19);function p(c,u){return s(),a("div",null,[e(" more "),l])}const r=n(i,[["render",p],["__file","git18.html.vue"]]);export{r as default};
