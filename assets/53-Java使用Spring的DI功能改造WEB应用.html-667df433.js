...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="6"><li>启动项目测试是否配置成功 <img src="`+T+'" alt="" loading="lazy"><img src="'+V+'" alt="" loading="lazy"></li></ol><p><strong>如图所示,测试成功</strong></p><figure><img src="'+D+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',23),O=e("strong",null,"拓展知识：",-1),Y={href:"https://www.jianshu.com/p/c6961258679a",target:"_blank",rel:"noopener noreferrer"},Z=e("ol",{start:"7"},[e("li",null,"带参访问UserServlet")],-1),$={href:"http://localhost:9090/demo_spring03_init_web/UserServlet?username=zhangsan&password=123456",target:"_blank",rel:"noopener noreferrer"},G=t('<figure><img src="'+R+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h5 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h5><p>第一步：导入jar包</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>beans context  core  expression  test web  commons-logging
