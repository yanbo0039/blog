import{_ as t,X as d,Y as l,a1 as s,Z as i,$ as e,a2 as r,a0 as v,F as a}from"./framework-68dd73a2.js";const u="/blog/assets/Kingdee_83_1.png",b="/blog/assets/Kingdee_83_2.png",c="/blog/assets/Kingdee_83_3.png",m="/blog/assets/Kingdee_83_4.png",o={},p={id:"_83-金蝶云苍穹左树右表单据列表插件refreshnode事件案例-md",tabindex:"-1"},g=i("a",{class:"header-anchor",href:"#_83-金蝶云苍穹左树右表单据列表插件refreshnode事件案例-md","aria-hidden":"true"},"#",-1),_={href:"http://xn--83-refreshNode-3w8voc03gma54zf4t1kgkvdz76fb01aqbcmz0c8jb868zrq3bsh3asegda9950f.md",target:"_blank",rel:"noopener noreferrer"},h=v('<h4 id="导读" tabindex="-1"><a class="header-anchor" href="#导读" aria-hidden="true">#</a> 导读</h4><hr><blockquote><p>坎坷并不可怕，可怕是的没有淡然的心态,没有面对的勇气，没有战胜的智慧，甚至没有站起来的毅力。</p></blockquote><hr><ol><li><p>新建模板单据</p></li><li><p>设置单据表名</p></li><li><p>添加基础资料并将其资料类型设置为业务应用实体</p></li><li><p>如下图所示设置列表属性</p></li></ol><blockquote><p>列表表单模板: bos_templatetreelist</p></blockquote><blockquote><p>F7列表表单模板: bos_templatetreelistf7</p></blockquote><figure><img src="'+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>编码</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package kd.bos.zsybbill.plugin;
