...
</code></pre><figure><img src="`+O+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>select &#39;hsql sourseh&#39;,trim(leading &#39;h&#39; from &#39;hsql sourseh&#39;) from dual;
</code></pre><figure><img src="`+z+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>select &#39;hsql sourseh&#39;,trim(trailing &#39;h&#39; from &#39;hsql sourseh&#39;) from dual;
...
</code></pre><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Oracle---函数</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,222);function ye(xe,Oe){return a(),i("div",null,[o(" more "),be])}const we=e(he,[["render",ye],["__file","oracle8.html.vue"]]);export{we as default};
