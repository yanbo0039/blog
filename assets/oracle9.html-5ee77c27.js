import{_ as e,X as p,Y as n,a1 as a,a0 as o}from"./framework-68dd73a2.js";const t="/blog/assets/Oracle_9_1.png",r="/blog/assets/Oracle_9_2.png",d="/blog/assets/Oracle_9_3.png",s="/blog/assets/Oracle_9_4.png",c="/blog/assets/Oracle_9_5.png",l="/blog/assets/Oracle_9_6.png",i="/blog/assets/Oracle_9_7.png",m="/blog/assets/Oracle_9_8.png",g="/blog/assets/Oracle_9_9.png",_="/blog/assets/Oracle_9_10.png",f="/blog/assets/Oracle_9_11.png",h="/blog/assets/Oracle_9_12.png",b="/blog/assets/Oracle_9_13.png",u="/blog/assets/Oracle_9_14.png",O="/blog/assets/Oracle_9_15.png",y="/blog/assets/Oracle_9_16.png",w="/blog/assets/Oracle_9_17.png",x={},z=o(`<h1 id="oracle-多表链接" tabindex="-1"><a class="header-anchor" href="#oracle-多表链接" aria-hidden="true">#</a> Oracle-多表链接</h1><h2 id="多表链接查询-嵌套子查询-相关子查询-约束-事务" tabindex="-1"><a class="header-anchor" href="#多表链接查询-嵌套子查询-相关子查询-约束-事务" aria-hidden="true">#</a> --多表链接查询 嵌套子查询 相关子查询 （约束 事务）</h2><h2 id="多表链接-查询" tabindex="-1"><a class="header-anchor" href="#多表链接-查询" aria-hidden="true">#</a> --多表链接 查询</h2><p>--笛卡尔积 14*4</p><pre><code>select emp.empno,
emp.ename,emp.job,emp.mgr,
emp.hiredate,emp.sal,
emp.deptno,dept.deptno,
dept.dname
from emp,dept;
</code></pre><p><img src="`+t+'" alt="" loading="lazy"><img src="'+r+'" alt="" loading="lazy"><img src="'+d+`" alt="" loading="lazy"></p><pre><code>select emp.empno,
emp.ename,emp.job,emp.mgr,
emp.hiredate,emp.sal,
emp.deptno,dept.deptno,
dept.dname
...
</code></pre><figure><img src="`+l+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--现在只想查询工作地点在NEW YORK的员工编号，姓名，部门编号，工作地点</p><pre><code>select empno,ename,dept.deptno,loc
from emp,dept
where dept.deptno = emp.deptno and loc = &#39;NEW YORK&#39;;
</code></pre><figure><img src="`+i+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--给定表别名</p><pre><code>select e.empno,e.ename,d.deptno,d.loc
from emp e,dept d
...
select * from dept;
select * from emp;
</code></pre><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,48);function C(N,A){return p(),n("div",null,[a(" more "),z])}const Y=e(x,[["render",C],["__file","oracle9.html.vue"]]);export{Y as default};
