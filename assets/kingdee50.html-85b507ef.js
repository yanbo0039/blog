import{_ as l,X as n,Y as a,a1 as r,Z as e,$ as i,a2 as s,a0 as c,F as d}from"./framework-68dd73a2.js";const u={},o={id:"_50-金蝶云苍穹之数据服务-md",tabindex:"-1"},b=e("a",{class:"header-anchor",href:"#_50-金蝶云苍穹之数据服务-md","aria-hidden":"true"},"#",-1),v={href:"http://xn--50--db9dnm51sg26aqmdiseq80ebft8ymwy6a.md",target:"_blank",rel:"noopener noreferrer"},p=c(`<h4 id="orm概述" tabindex="-1"><a class="header-anchor" href="#orm概述" aria-hidden="true">#</a> ORM概述</h4><ul><li>什么是ORM？</li></ul><blockquote><p>对象关系映射(Object Relation Mappint)的简称，把实体模型映射到数据库中，提供对象的操作，在数据库中则体现为CRUD。</p></blockquote><ul><li><p>市面上有哪些开源ORM框架？</p><ul><li><p>Hibernate</p></li><li><p>Mybatis</p></li><li><p>JPA</p></li></ul></li><li><p>为什么需要ORM？</p><ul><li><p>多数库访问的需要: 应用主库、基础资料、工作流、日志、权限</p></li><li><p>自动处理繁琐的关联操作: 分录、子分录、多语言表、扩展表(动态)、多选基础资料</p></li><li><p>基于表单实体元数据，更符合业务逻辑</p></li><li><p>集成计算框架接口，可便捷地使用复杂的计算、大数据量的访问</p></li></ul></li></ul><h4 id="businessdataservicehelper-业务操作" tabindex="-1"><a class="header-anchor" href="#businessdataservicehelper-业务操作" aria-hidden="true">#</a> BusinessDataServiceHelper(业务操作)</h4><ul><li>创建对象</li></ul><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public static DynamicObject newDynamicObject(String entityName)
{
    //创建单据对象
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="saveservicehelper-数据保存" tabindex="-1"><a class="header-anchor" href="#saveservicehelper-数据保存" aria-hidden="true">#</a> SaveServiceHelper(数据保存)</h4><ul><li><p>保存对象到数据库</p><ul><li>public static Object[] save(IDataEntityType type, Object[] dataEntities)</li><li>public static Object[] save(DynamicObject[] dataEntities)</li></ul></li><li><p>调用业务对象的保存操作，会触发操作校验，操作插件等服务</p><ul><li>public static OperationResult saveOperate(String entityNumber, DynamicObject[] dataEntities)</li><li>public static OperationResult saveOperate(String entityNumber, DynamicObject[] dataEntities, OperateOption option)</li><li>public static OperationResult saveOperate(String operationKey, String entityNumber, DynamicObject[] dataEntities)</li><li>public static OperationResult saveOperate(String operationKey, String entityNumber, DynamicObject[] dataEntities, OperateOption option)</li></ul></li></ul><h4 id="deleteservicehelper-数据删除" tabindex="-1"><a class="header-anchor" href="#deleteservicehelper-数据删除" aria-hidden="true">#</a> DeleteServiceHelper(数据删除)</h4><ul><li>直接从数据库删除 <ul><li>public static void delete(IDataEntityType type, Object[] pks)</li><li>public static int delete(String entityName, QFilter[] qFilters)</li></ul></li><li>调用业务对象的删除操作，会触发删除校验，插件等服务 <ul><li>public OperationResult deleteOperate(String operationKey, String entityName, Object[] pks)</li><li>public OperationResult deleteOperate(String operationKey, String entityName, Object[] pks, OperateOption option)</li><li>public OperationResult deleteOperate(String entityName, Object[] pks)</li><li>public OperationResult deleteOperate(String entityName, Object[] pks, OperateOption option)</li></ul></li></ul><h4 id="queryservicehelper-数据查询" tabindex="-1"><a class="header-anchor" href="#queryservicehelper-数据查询" aria-hidden="true">#</a> QueryServiceHelper(数据查询)</h4><ul><li><p>查询平铺对象</p><ul><li>public static DynamicObjectCollection query(String entityName, String selectFields, QFilter[] filters)</li><li>public static DynamicObjectCollection query(String entityName, String selectFields, QFilter[] filters, String orderBys)</li><li>public static DynamicObjectCollection query(String entityName, String selectFields, QFilter[] filters, String orderBys, int top)</li><li>public static DynamicObjectCollection query(String algoKey, String entityName, String selectFields, QFilter[] filters, String orderBys)</li><li>public static DynamicObjectCollection query(String algoKey, String entityName, String selectFields,QFilter[] filters, String orderBys, int top)</li></ul></li><li><p>eg :</p></li></ul><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>BillList list = this.getControl(&quot;billlistap&quot;);
...
+ kd.bos.db.DB-直接执行SQL的类
 ...
 kd.bos.db.DBRoute
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>什么是DBRoute？</p></blockquote><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_50_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public static final DBRoute other = new DBRoute(&quot;&quot;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>以上就是我关于 <em>金蝶云苍穹之ORM介绍</em> 知识点的整理与总结的全部内容,希望对你有帮助。。。。。。</strong></p><hr><p>分割线</p><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,28);function m(g,y){const t=d("ExternalLinkIcon");return n(),a("div",null,[r(" more "),e("h1",o,[b,i(),e("a",v,[i("50-金蝶云苍穹之数据服务.md"),s(t)])]),p])}const q=l(u,[["render",m],["__file","kingdee50.html.vue"]]);export{q as default};
