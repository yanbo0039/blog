import{_ as e,X as s,Y as a,a1 as i,Z as n,$ as l,a0 as d}from"./framework-68dd73a2.js";const v={},r=n("h1",{id:"_174-java习题-一-md",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_174-java习题-一-md","aria-hidden":"true"},"#"),l(" 174-Java习题(一).md")],-1),t=d(`<ol><li><p>在么是继承，什么是多态，方法的重载和覆盖有何区别(10分)</p></li><li><p>定义类A和类B如下：（10分）</p></li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>    class A{
        int a=1；
        doubled=2.0；
        void show（）{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="7"><li><p>用JAVA实现冒泡排序。(15分)</p></li><li><p>数据库题目，有3张表(20分)</p></li></ol><p>Student 学生表 (学号、姓名、性别、年龄、组织部门）</p><p>Course课程表（编号、课程名称）</p><p>Sc选课表（学号、课程编号、成绩）</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_174_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>1、写一个SQL语句，查询选修了&quot;计算机原理&quot;的学生学号和姓名(5分)</p><p>2、写一个SQL语句，查询&quot;周星驰&quot;同学选修了的课程名称(5分)</p><p>3、写一个SQL语句，查询选修了至少3门课程以上的学生学号和姓名(10分)</p><p><strong>以上就是我关于 <em>Java习题(一)</em> 知识点整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,29);function u(c,m){return s(),a("div",null,[i(" more "),r,i(" 凯通"),t])}const b=e(v,[["render",u],["__file","java174.html.vue"]]);export{b as default};
