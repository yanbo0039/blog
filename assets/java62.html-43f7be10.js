import{_ as n,X as e,Y as i,a1 as s,a0 as a}from"./framework-68dd73a2.js";const t="/blog/assets/Java_62_1.png",l="/blog/assets/Java_62_2.png",d="/blog/assets/Java_62_3.png",r={},v=a(`<h1 id="java-spring使用注解配置自动装配电脑" tabindex="-1"><a class="header-anchor" href="#java-spring使用注解配置自动装配电脑" aria-hidden="true">#</a> Java-Spring使用注解配置自动装配电脑</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p><strong>题目</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>电脑爱好者会自己去电脑城组装电脑，我们用代码完成一台电脑的配置：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>运行测试，报错信息如下</strong><img src="`+l+`" alt="" loading="lazy"></p><p>说明：违反唯一，容器里有多个bean不知道要哪一个</p><p><strong>解决：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@Autowired @Qualifier(&quot;goldenField&quot;)//此处的值默认为首字母小写 
private ComputerCase jixiang;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>再次测试,如图所示测试成功</strong></p><figure><img src="`+d+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 Java-Spring使用注解配置自动装配电脑 知识点的整理与总结的全部内容</strong></p></div>',28);function c(o,u){return e(),i("div",null,[s(" more "),v])}const p=n(r,[["render",c],["__file","java62.html.vue"]]);export{p as default};
