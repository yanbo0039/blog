import{_ as e,X as t,Y as i,a1 as n,a0 as s}from"./framework-68dd73a2.js";const r="/blog/assets/Java_46_2.png",l={},d=s(`<h1 id="java-servlet跳转servlet以及传参" tabindex="-1"><a class="header-anchor" href="#java-servlet跳转servlet以及传参" aria-hidden="true">#</a> Java-Servlet跳转Servlet以及传参</h1><p>最近项目中有这么一个需求：</p><p><strong>JSP中的按钮点击-------&gt;Servlet-1---------&gt;Servlet-2作出判断并传参------JSP页面接收参数并展示</strong></p><h3 id="jsp跳转servlet" tabindex="-1"><a class="header-anchor" href="#jsp跳转servlet" aria-hidden="true">#</a> JSP跳转Servlet</h3><p><strong>login.jsp button2跳转到ToRegisterViewServlet</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;form name=&quot;form1&quot; method=&quot;post&quot; action=&quot;&lt;%=request.getContextPath()%&gt;/LoginServlet&quot; id=&quot;loginForm&quot;&gt;
