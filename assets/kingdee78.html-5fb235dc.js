import{_ as n,X as l,Y as s,a1 as a,Z as i,$ as t,a2 as d,a0 as r,F as v}from"./framework-68dd73a2.js";const u="/blog/assets/Kingdee_78_1.png",c="/blog/assets/Kingdee_78_2.png",m="/blog/assets/Kingdee_78_3.png",o={},b={id:"_78-金蝶云苍穹标准单据列表插件beforecreatelistcolumns事件案例-md",tabindex:"-1"},g=i("a",{class:"header-anchor",href:"#_78-金蝶云苍穹标准单据列表插件beforecreatelistcolumns事件案例-md","aria-hidden":"true"},"#",-1),p={href:"http://xn--78-beforeCreateListColumns-en45bee50kya337bkpwnoc5uq955l56cos0dqbcku81atvvcq6wbwkimt9h.md",target:"_blank",rel:"noopener noreferrer"},f=r('<ol><li><p>新建带组织模板单据</p></li><li><p>在表单界面设置好表名之后管理员账号登录授权</p></li><li><p>预览之后添加数据后保存不提交，最好添加多条数据</p></li><li><p>在列表界面的常用条件添加单据状态字段后保存</p></li></ol><figure><img src="'+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>编码</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package kd.bos.bill.plugin;
