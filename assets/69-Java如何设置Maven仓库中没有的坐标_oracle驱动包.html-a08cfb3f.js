...
cd E:\\app\\yanbo\\product\\11.2.0\\dbhome_1\\jdbc\\lib
  ...
  &lt;/build&gt; 
&lt;/project&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16),w={href:"https://github.com/javaobjects/pay",target:"_blank",rel:"noopener noreferrer"},k=t("hr",null,null,-1),J=t("h3",{id:"分割线",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),e(" 分割线")],-1),E=t("hr",null,null,-1),M=t("p",null,[t("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function N(P,O){const n=o("ExternalLinkIcon");return d(),s("div",null,[r(" more "),f,h,t("ol",null,[t("li",null,[e("查询Oracle的版本 select * from v$version; 或参考博客 "),t("a",x,[e("Oracle-查看版本号"),i(n)])])]),j,t("ol",I,[t("li",null,[e("确定自已已经安装好Maven的环境，若未安装好参考博客 "),t("a",y,[e("Java-Window10-Maven环境搭建"),i(n)]),e(",cmd 中输入 mvn -v 进行验证,如图所示表明环境欧克。")])]),D,t("p",null,[t("strong",null,[e("以上就是我关于 Java如何设置Maven仓库中没有的坐标_oracle驱动包 知识点的整理与总结的全部内容 "),t("a",w,[e("另附源码"),i(n)])])]),k,J,E,M])}const L=l(_,[["render",N],["__file","69-Java如何设置Maven仓库中没有的坐标_oracle驱动包.html.vue"]]);export{L as default};
