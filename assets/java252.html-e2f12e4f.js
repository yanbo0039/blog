import{_ as i,X as d,Y as s,a1 as l,Z as n,$ as e,a2 as a,a0 as u,F as v}from"./framework-68dd73a2.js";const r={},o={id:"_252-javagui界面编程-安装windowbuilder插件并新建jframe简单窗体-页面交互-常用的表单域-获取表单域的值-md",tabindex:"-1"},c=n("a",{class:"header-anchor",href:"#_252-javagui界面编程-安装windowbuilder插件并新建jframe简单窗体-页面交互-常用的表单域-获取表单域的值-md","aria-hidden":"true"},"#",-1),m={href:"http://xn--hxq58eblk7kzq2cftqiqh.md",target:"_blank",rel:"noopener noreferrer"},b=u(`<h4 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h4><ol><li><p>在 Eclipse的 <strong>dropins</strong> 文件夹 放入 <strong>WinBuilder_v1.8.0_mars</strong> 文件</p></li><li><p>重启 Eclipse 若 window--&gt; preferences --&gt; 下有WindowBuilder 则安装成功</p></li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_252_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter06.gui;
