import{_ as e,X as p,Y as t,a1 as o,Z as n,$ as s,a2 as c,a0 as l,F as i}from"./framework-68dd73a2.js";const r={},u={id:"_47-oracle-sql开发-编写简单的查询语句-md",tabindex:"-1"},m=n("a",{class:"header-anchor",href:"#_47-oracle-sql开发-编写简单的查询语句-md","aria-hidden":"true"},"#",-1),d={href:"http://xn--g7q15bmmt47dywqy0gtvg7u2a3c.md",target:"_blank",rel:"noopener noreferrer"},k=l(`<h4 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h4><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_47_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_47_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_47_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_47_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_47_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li><p>原义字符串</p><ul><li><p>原义字符串是包含在SELECT列表中的一个字符、一个数字或一个日期。</p></li><li><p>日期和字符字面值必须用单引号引起来。</p></li><li><p>每个原义字符串都会在每个数据行输出中出现。</p></li></ul></li><li><p>消除重复行</p><ul><li>在SELECT字句中使用关键字DISTINCT可消除重复行。</li></ul></li><li><p>显示表的结构</p><ul><li>在SQL*Plus中，可以使用DESCRIBE 命令来查 看表结构</li></ul></li></ul><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">------------------------------------</span>
