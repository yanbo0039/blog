import{_ as t,X as a,Y as r,a1 as o,Z as e,$ as n,a2 as l,a0 as s,F as d}from"./framework-68dd73a2.js";const c={},v={id:"_133-eas-web记录一次有意思的找bug经历-执行脚本时发生错误-md",tabindex:"-1"},m=e("a",{class:"header-anchor",href:"#_133-eas-web记录一次有意思的找bug经历-执行脚本时发生错误-md","aria-hidden":"true"},"#",-1),u={href:"http://xn--133-EAS-WEBbug--bf3x500evgbf25kljdg9foyi7oav10efegj0af59e147drpi318d93odk8c7mxa22b8z9l.md",target:"_blank",rel:"noopener noreferrer"},b=s(`<h4 id="故事背景" tabindex="-1"><a class="header-anchor" href="#故事背景" aria-hidden="true">#</a> 故事背景</h4><blockquote><p>事情是这样子的，最近有在接盘我厂大佬的一EAS项目。但另一项目由于之前小伙伴跑路，暂无人维护，突然客户点点点发现有bug，于是乎项目经理一声令下，当当当当，我就闪亮登场了。。。好高兴。。。。额。。 <em>^^</em> ,突然接手一个不熟悉的项目，虽然有点小激动，但同时也存在其最大的问题，可能是一个很小的问题都会由于业务不熟悉，而导致花费大量的时间，调用大量的求助资源才有可能排查到这个问题。。。比如笔者这次就基本是这样子的。。。。</p></blockquote><h4 id="出现场景" tabindex="-1"><a class="header-anchor" href="#出现场景" aria-hidden="true">#</a> 出现场景</h4><blockquote><p>那是某年某月某日的清晨，我还依然清楚的记得，那天晚上的月亮很美，那天早上的太阳也特别明亮，突然项目经理在群里给了我如下信息:</p></blockquote><ol><li>一张截图</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_133_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>一段报错信息</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>执行脚本时发生错误,脚本:java.sql.Connection con =com.kingdee.bos.framework.ejb.EJBFactory.getConnection ( __bosContext);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>其它辅助信息</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_133_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>就以上信息，目的是去解决它！！！！？？？</p></blockquote><h4 id="解决步骤" tabindex="-1"><a class="header-anchor" href="#解决步骤" aria-hidden="true">#</a> 解决步骤</h4><blockquote><p>此刻我的脑瓜子是蒙的，但冷静下来并且消夏大量时间后用以下步骤</p></blockquote><ol><li>查看错误日志</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_133_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>拿到如下错误日志</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>执行脚本时发生错误,脚本:java.sql.Connection con =com.kingdee.bos.framework.ejb.EJBFactory.getConnection ( __bosContext);
java.sql.Statement batchStatement=con.createStatement();
java.lang.StringBuffer Sql = new java.lang.StringBuffer();
Sql.append(&quot;select a.famount*0.8  amt from T_CON_ContractBill as a inner join T_CON_PayRequestBill as b on a.fid=b.fcontractid where b.fid =&#39;&quot;+ID+&quot;&#39;&quot;);
rs=batchStatement.executeQuery(Sql.toString());
...
select a.famount*0.8  amt from T_CON_ContractBill as a inner join T_CON_PayRequestBill as b on a.fid=b.fcontractid where b.fid =&#39;xwLM6KaVQFOJggfX/nSzB8mlqGk=&#39;
	...
	at com.apusic.jdbc.adapter.StatementHandle.executeQuery(StatementHandle.java:89)
	... 75 more
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>将其sql复制到查询分析器中执行</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_133_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="4"><li><p>从上图我得到结论，同样的sql语句，上一句可以正常得到结果，而下一句执行则报错则我初步怀疑是sql语句拼接得有问题，通过比对我发现是第二句sql多写一个空格所致。。。哼哼哼哼哼。。。。</p></li><li><p>找到对应的kScript脚本，将其sql中的空格去掉保存后重新发布对应的后缀为.kdwf文件</p></li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_133_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Kingdee_133_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="6"><li>重新发布后，最终解决了此问题。</li></ol><h4 id="感悟" tabindex="-1"><a class="header-anchor" href="#感悟" aria-hidden="true">#</a> 感悟</h4><blockquote><p>最后我想说一句，世界无难事，只要肯放弃，在编码的路上且行且珍惜吧。</p></blockquote><p><strong>以上就是我关于 <em>EAS-WEB记录一次有意思的找bug经历-执行脚本时发生错误</em> 知识点整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p><hr><p>分割线</p><hr><h4 id="扩展知识" tabindex="-1"><a class="header-anchor" href="#扩展知识" aria-hidden="true">#</a> 扩展知识</h4><hr><blockquote><p>男人玩不过女人 因为她是天生的情感说客 女人出轨后通常会怎么做呢，她会痛哭流涕向你哭诉，然后下意识的把她的恶行转化成你的错，她会说;如果不是因为你这样对我我会这样吗，都是你的错，当你下意识的被她引导到自己的错时，她就华丽转身了，她是一个善良的好女人，由于你的错导致了她犯错，你必须原谅她。</p></blockquote><hr>`,33);function k(p,g){const i=d("ExternalLinkIcon");return a(),r("div",null,[o(" more "),e("h1",v,[m,n(),e("a",u,[n("133-EAS-WEB记录一次有意思的找bug经历-执行脚本时发生错误.md"),l(i)])]),b])}const j=t(c,[["render",k],["__file","kingdee133.html.vue"]]);export{j as default};
