...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>拓展知识：</strong></p><p>方法的重写与方法的重载的区别：</p><ol><li><strong>方法的重写</strong>参数一定要相同;<strong>方法重载</strong>参数一定不同</li><li><strong>方法的重写</strong>是子类重写父类的方法，至少要两个类;<strong>而方法的重载</strong>是发生在一个类中。</li><li><strong>方法的重写</strong>返回值类型必须相同;而<strong>方法的重载</strong>的返回值类型可以相同也可以不同。</li><li><strong>方法的重写</strong>要求方法的访问权限不小于父类中被覆盖方法的访问权限;而<strong>方法的重载</strong>对权限不作要求。</li></ol><p>方法的重写与方法的重载的相同点：</p><p>唯一的相同点就是<strong>方法名称必须相同</strong>。</p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr>`,16),u={class:"hint-container tip"},m=i("p",{class:"hint-container-title"},"提示",-1),b=i("em",null,"Java方法的覆盖(重写)",-1),p={href:"https://github.com/javaobjects/demo514_1",target:"_blank",rel:"noopener noreferrer"};function g(h,_){const n=c("ExternalLinkIcon");return s(),t("div",null,[a(" more "),v,i("div",u,[m,i("p",null,[i("strong",null,[e("以上就是我关于 "),b,e(" 知识点的整理与总结的全部内容，"),i("a",p,[e("另附源码"),r(n)])])])])])}const f=l(o,[["render",g],["__file","java96.html.vue"]]);export{f as default};
