import{_ as i,X as l,Y as p,a1 as o,Z as n,$ as s,a2 as e,a0 as t,F as c}from"./framework-68dd73a2.js";const u="/blog/assets/Vue_12_1.png",r="/blog/assets/Vue_12_2.png",d="/blog/assets/Vue_12_3.png",k="/blog/assets/Vue_12_4.png",m="/blog/assets/Vue_12_5.png",v="/blog/assets/Vue_12_6.png",b="/blog/assets/Vue_12_7.png",g="/blog/assets/Vue_12_8.png",h="/blog/assets/Vue_12_9.png",_={},f=n("h1",{id:"vue如何用vuepress-theme-hope搭建属于自己的博客",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue如何用vuepress-theme-hope搭建属于自己的博客","aria-hidden":"true"},"#"),s(" Vue如何用vuepress-theme-hope搭建属于自己的博客?")],-1),y=n("h4",{id:"找到官网",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#找到官网","aria-hidden":"true"},"#"),s(" 找到官网")],-1),x=n("ol",null,[n("li",null,"点击如下地址进入官网")],-1),E={href:"https://vuepress-theme-hope.gitee.io/v2/zh/",target:"_blank",rel:"noopener noreferrer"},V=t('<h4 id="本地安装启动项目" tabindex="-1"><a class="header-anchor" href="#本地安装启动项目" aria-hidden="true">#</a> 本地安装启动项目</h4><ol><li>本地新建文件夹 vuepress-hope-myblog 并在此文件夹路径下启动cmd或power shell 但不能是git bash 因为需要一个交互式的命令窗口</li></ol><figure><img src="'+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>运行如下命令</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pnpm create vuepress-theme-hope add docs
...
<span class="token comment">#        4. 执行打包命令</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> 部署到 Gitee 服务器
        ...
        <span class="token key atrule">with</span><span class="token punctuation">:</span>
          ...
          <span class="token key atrule">branch</span><span class="token punctuation">:</span> gh<span class="token punctuation">-</span>pages
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="项目难点" tabindex="-1"><a class="header-anchor" href="#项目难点" aria-hidden="true">#</a> 项目难点</h4><ol><li>上面的3至5条都是官网上写得清清楚楚需要对于官网文档阅读理解即可</li><li>配置留言我用的 vercel 但现在还是有没有申请成功,暂时用的别人配置的</li></ol><figure><img src="`+v+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>2023年05月17日完成了留言注册，我犯了一个致命的错误，使用了国内的 leancloud 事实证明用国际版的哪有那么多事</li><li>有几个注意点</li><li>一是 leancloud必须使用国际版本</li><li>二是 部署 waline 时的键值对时 键是用官方提供的键 值却必须是 leancloud的值</li><li>其它照常做 反正这玩意把我坑不少时间</li></ul><ol start="3"><li>第7条需要你有两个库一个私有库放源码一个公开库放打包编译好的代码，且在私有库配置四个变量，在公开库配置允许github action访问的权限,公开库的路径则为你的博客的路径。 相关的参考链接己放入本文的底部</li></ol><figure><img src="'+b+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+g+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+h+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>以上就是我关于 <em>Vue如何用vuepress-theme-hope搭建属于自己的博客</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p><hr><h4 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h4><hr><h4 id="扩展知识" tabindex="-1"><a class="header-anchor" href="#扩展知识" aria-hidden="true">#</a> 扩展知识</h4>',15),z={href:"https://zhuanlan.zhihu.com/p/364366127",target:"_blank",rel:"noopener noreferrer"},T={href:"https://github.com/yanglbme/gitee-pages-action",target:"_blank",rel:"noopener noreferrer"},w={href:"https://github.com/Yikun/hub-mirror-action",target:"_blank",rel:"noopener noreferrer"},I={href:"https://hbuecx.com/post/github-action-gou-jian-shi-bai-chu-li/",target:"_blank",rel:"noopener noreferrer"},A={href:"https://github.com/JamesIves/github-pages-deploy-action",target:"_blank",rel:"noopener noreferrer"},N={href:"https://theme-hope.vuejs.press/zh/",target:"_blank",rel:"noopener noreferrer"},O={href:"https://waline.js.org/",target:"_blank",rel:"noopener noreferrer"},R=n("li",null,[n("a",{href:"yanbo0039.gitee.io/blog/zh"},"我的博客请参考")],-1),P={href:"https://console.leancloud.app/",target:"_blank",rel:"noopener noreferrer"},j={href:"https://waline.js.org/guide/get-started/",target:"_blank",rel:"noopener noreferrer"},H=n("hr",null,null,-1),Y=n("p",null,"分割线",-1),K=n("hr",null,null,-1);function $(J,B){const a=c("ExternalLinkIcon");return l(),p("div",null,[o(" more "),f,y,x,n("p",null,[n("a",E,[s("vuepress-theme-hope"),e(a)])]),V,n("p",null,[n("a",G,[s("这里我写了一些Java方法处理头部博客文件，可能你用得上"),e(a)])]),S,n("ol",null,[n("li",null,[n("a",z,[s("GitHub Actions入门教程-自动部署静态博客"),e(a)])]),n("li",null,[n("a",T,[s("gitee-pages-action"),e(a)])]),n("li",null,[n("a",w,[s("Hub Mirror Action"),e(a)])]),n("li",null,[n("a",I,[s("GitHub Action: The process '/usr/bin/git' failed with exit code 128"),e(a)])]),n("li",null,[n("a",A,[s("github-pages-deploy-action"),e(a)])]),n("li",null,[n("a",N,[s("hope主题官网"),e(a)])]),n("li",null,[n("a",O,[s("Waline"),e(a)])]),R,n("li",null,[n("a",P,[s("leancloud国际版"),e(a)])]),n("li",null,[n("a",j,[s("waline官网"),e(a)])])]),H,Y,K])}const D=i(_,[["render",$],["__file","12-Vue如何用vuepress-theme-hope搭建属于自己的博客.html.vue"]]);export{D as default};
