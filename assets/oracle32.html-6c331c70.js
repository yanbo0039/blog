import{_ as l,X as a,Y as t,a1 as n,Z as e,$ as i,a2 as r,a0 as s,F as c}from"./framework-68dd73a2.js";const u={},v={id:"_32-oracle-视图-md",tabindex:"-1"},m=e("a",{class:"header-anchor",href:"#_32-oracle-视图-md","aria-hidden":"true"},"#",-1),h={href:"http://xn--32-Oracle--h32r5889b.md",target:"_blank",rel:"noopener noreferrer"},o=s(`<h4 id="章节目标" tabindex="-1"><a class="header-anchor" href="#章节目标" aria-hidden="true">#</a> 章节目标</h4><ul><li>通过本章学习，学员应达到如下目标： <ul><li>理解视图的作用、分类；</li><li>掌握视图创建、修改、删除；</li><li>掌握如何从视图中检索数据；</li></ul></li></ul><h4 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h4><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_32_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="数据库对象" tabindex="-1"><a class="header-anchor" href="#数据库对象" aria-hidden="true">#</a> 数据库对象</h4><table><thead><tr><th></th><th></th></tr></thead><tbody><tr><td>表</td><td>表是用来存放用户数据的对象，由行和列组成，列就是字段，行就是表中的记录</td></tr><tr><td>约束</td><td>保证数据完整性的规则，设置在单个字段或者多个字段组合上，写入这些字段的数据必须符合约束的限制</td></tr><tr><td>视图</td><td>是一个命名的查询，用于改变基表数据的显示，通过视图能简化查询;访问方式与表相同</td></tr><tr><td>索引</td><td>构建于表的单字段或都字段组合上，用于加速对表中数据的查询</td></tr><tr><td>序列</td><td>产生顺序的不重复数据字串，被作为主键的束值的参照</td></tr><tr><td>同义词</td><td>数据库对象的别名</td></tr></tbody></table><h4 id="什么是视图" tabindex="-1"><a class="header-anchor" href="#什么是视图" aria-hidden="true">#</a> 什么是视图？</h4><ul><li>视图是逻辑上来自一个或多个表的数据集合。</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_32_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="为什么使用视图" tabindex="-1"><a class="header-anchor" href="#为什么使用视图" aria-hidden="true">#</a> 为什么使用视图</h4><ul><li>限制其它用户对数据库表的访问,因为视图可以有选择性的显示数据库表的一部分；</li><li>容易实现复杂的查询；</li><li>对于相同的数据可以产生不同的视图；</li></ul><h4 id="视图分类" tabindex="-1"><a class="header-anchor" href="#视图分类" aria-hidden="true">#</a> 视图分类</h4><ul><li>视图分为简单视图和复杂视图，最基本差别在DML操作上</li></ul><table><thead><tr><th></th><th></th><th></th></tr></thead><tbody><tr><td>特征</td><td>简单视图</td><td>复杂视图</td></tr><tr><td>基表数量</td><td>一个</td><td>一个或多个</td></tr><tr><td>包含函数</td><td>没有</td><td>有</td></tr><tr><td>包含数据组</td><td>没有</td><td>有</td></tr><tr><td>通过视图实现DML操作</td><td>可以</td><td>不一定</td></tr></tbody></table><h4 id="创建视图" tabindex="-1"><a class="header-anchor" href="#创建视图" aria-hidden="true">#</a> 创建视图</h4><ul><li>创建视图语法；</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>CREATE [OR REPLACE] [FORCE|NOFORCE] VIEW viewname
  [(column[, column]...)]
AS subquery
