import{_ as e,X as n,Y as a,a1 as i,a0 as o}from"./framework-68dd73a2.js";const r="/blog/assets/Oracle_14_1.png",t="/blog/assets/Oracle_14_2.png",p="/blog/assets/Oracle_14_3.png",c="/blog/assets/Oracle_14_4.png",s="/blog/assets/Oracle_14_5.png",g="/blog/assets/Oracle_14_6.png",l="/blog/assets/Oracle_14_7.png",d="/blog/assets/Oracle_14_8.png",m="/blog/assets/Oracle_14_9.png",f="/blog/assets/Oracle_14_10.png",_="/blog/assets/Oracle_14_11.png",b="/blog/assets/Oracle_14_12.png",h="/blog/assets/Oracle_14_13.png",u="/blog/assets/Oracle_14_14.png",A="/blog/assets/Oracle_14_15.png",w="/blog/assets/Oracle_14_16.png",x="/blog/assets/Oracle_14_17.png",S="/blog/assets/Oracle_14_18.png",y="/blog/assets/Oracle_14_19.png",O="/blog/assets/Oracle_14_20.png",z="/blog/assets/Oracle_14_21.png",E="/blog/assets/Oracle_14_22.png",N="/blog/assets/Oracle_14_23.png",M="/blog/assets/Oracle_14_24.png",j={},L=o(`<h1 id="oracle初级测试题三-限制数据和对数据排序" tabindex="-1"><a class="header-anchor" href="#oracle初级测试题三-限制数据和对数据排序" aria-hidden="true">#</a> Oracle初级测试题三--限制数据和对数据排序</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p>--练习一</p><p>--1.查询职位为SALESMAN的员工编号、职位、入职日期。</p><pre><code>select empno,job,hiredate from emp
where job = &#39;SALESMAN&#39;;
...
from emp
where comm is null;
</code></pre><figure><img src="`+f+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--练习四 --1.查询工资超过2000并且职位是MANAGER,或者职位是SALESMAN的员工姓名、职位、工资</p><pre><code>select ename,job,sal
from emp
where sal &gt; 2000 and job = &#39;MANAGER&#39; or job = &#39;SALESMAN&#39;;
</code></pre><figure><img src="`+_+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--2.查询工资超过2000并且职位是 MANAGER或SALESMAN的员工姓名、职位、工资。</p><pre><code>select ename,job,sal
from emp
...
</code></pre><figure><img src="`+h+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--4.查询入职日期在81年，并且职位不是SALES开头的员工姓名、入职日期、职位。</p><pre><code>select ename,hiredate,job
from emp
where hiredate between &#39;01-1月-81&#39; and &#39;31-12月-81&#39; and job not like &#39;SALES%&#39;;
</code></pre><figure><img src="`+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--5.查询职位为SALESMAN或MANAGER，部门编号为10或者20，姓名包含A的员工姓名、职位、部门编号。</p><pre><code>select ename,job,deptno
from emp
...
</code></pre><figure><img src="`+M+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Oracle初级测试题三--限制数据和对数据排序</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',82);function k(v,G){return n(),a("div",null,[i(" more "),L])}const B=e(j,[["render",k],["__file","oracle14.html.vue"]]);export{B as default};
