import{_ as r,X as i,Y as t,a1 as c,Z as e,$ as a,a2 as s,a0 as l,F as o}from"./framework-68dd73a2.js";const d={},v={id:"_131-sql查询时报错caused-exception-message-is-ora-00904-umyaaabslyg7c00s-标识符无效-md",tabindex:"-1"},u=e("a",{class:"header-anchor",href:"#_131-sql查询时报错caused-exception-message-is-ora-00904-umyaaabslyg7c00s-标识符无效-md","aria-hidden":"true"},"#",-1),m={href:"http://xn--fcv1m68cp57a85s.md",target:"_blank",rel:"noopener noreferrer"},b=l(`<blockquote><p>报错如下所示</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>错误信息：null
...
sql_lx.append(fnumber + &quot;&#39; WHERE fid = &#39;&quot; + id + &quot;&#39;&quot;);
FMIsqlFacadeFactory.getRemoteInstance().executeSql(sql_lx.toString());
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>以上就是我关于 <em>SQL查询时报错Caused exception message is ORA-00904 UMYAAABSLYG7C00S 标识符无效</em> 知识点整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p><hr><p>分割线</p><hr><h4 id="扩展知识" tabindex="-1"><a class="header-anchor" href="#扩展知识" aria-hidden="true">#</a> 扩展知识</h4><hr><blockquote><p>如果你赶不上凌晨五点的日出 可以去看看 傍晚六点的夕阳 我的意思是你不妨选择后者 人的出场顺序真的很重要 不要再沉迷过去了 多珍惜此刻</p></blockquote><hr>`,14);function p(S,k){const n=o("ExternalLinkIcon");return i(),t("div",null,[c(" more "),e("h1",v,[u,a(" 131-SQL查询时报错Caused exception message is ORA-00904 UMYAAABSLYG7C00S "),e("a",m,[a("标识符无效.md"),s(n)])]),b])}const j=r(d,[["render",p],["__file","kingdee131.html.vue"]]);export{j as default};
