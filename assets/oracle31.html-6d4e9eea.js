...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="本章重点总结" tabindex="-1"><a class="header-anchor" href="#本章重点总结" aria-hidden="true">#</a> 本章重点总结</h3><ul><li>理解约束作用；</li><li>掌握五种约束类型及每种约束能达到的效果；</li><li>掌握在创建表的同时创建约束写法；</li><li>理解追加、删除、启用、禁用约束；</li><li>了解约束相关数据字典；</li></ul><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Oracle-约束</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,84);function g(A,T){const l=c("ExternalLinkIcon");return a(),d("div",null,[t(" more "),e("h1",E,[h,i(),e("a",N,[i("31-Oracle约束.md"),s(l)])]),R])}const L=n(b,[["render",g],["__file","oracle31.html.vue"]]);export{L as default};
