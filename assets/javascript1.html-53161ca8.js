import{_ as r,X as s,Y as t,a1 as d,Z as e,$ as n,a2 as a,a0 as l,F as c}from"./framework-68dd73a2.js";const o="/blog/assets/JavaScript_1_1.png",u={},v=e("h1",{id:"javascript跳出循环的方法区别",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#javascript跳出循环的方法区别","aria-hidden":"true"},"#"),n(" JavaScript跳出循环的方法区别")],-1),m=e("div",{class:"hint-container warning"},[e("p",{class:"hint-container-title"},"注意"),e("p",null,"本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。")],-1),b={href:"https://www.cnblogs.com/jrystal/p/7067390.html",target:"_blank",rel:"noopener noreferrer"},h={href:"https://blog.csdn.net/fxss5201/article/details/52980138",target:"_blank",rel:"noopener noreferrer"},p=l(`<h2 id="break" tabindex="-1"><a class="header-anchor" href="#break" aria-hidden="true">#</a> break</h2><p>break语句会使运行的程序立刻退出包含在最内层的循环或者退出一个switch语句。</p><p>由于它是用来退出循环或者switch语句，所以只有当它出现在这些语句时，这种形式的break语句才是合法的。</p><p>如果一个循环的终止条件非常复杂，那么使用break语句来实现某些条件比用一个循环表达式来表达所有的条件容易得多。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>for(var i=1;i&lt;=10;i++) { 
    if(I==7) { 
        break; 
    } 
    console.log(i); 
...
...
&lt;/form&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>JavaScript跳出循环的方法区别</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,21);function g(f,x){const i=c("ExternalLinkIcon");return s(),t("div",null,[d(" more "),v,m,e("p",null,[e("a",b,[n("参考链接1"),a(i)]),e("a",h,[n("参考链接2"),a(i)]),n(" 今天无意中用到一个跳出循环的的方法，许久未用到跳出循环，发现自己居然这么简单的一个功能，居然恬不知耻的要问度娘咯！！！！，简直不能忍，此文只为自己归纳总结所用。")]),p])}const k=r(u,[["render",g],["__file","javascript1.html.vue"]]);export{k as default};
