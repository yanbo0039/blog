import{_ as e,X as i,Y as n,a1 as s,a0 as l}from"./framework-68dd73a2.js";const r="/blog/assets/Java_61_1.png",a="/blog/assets/Java_61_2.png",t="/blog/assets/Java_61_3.png",d="/blog/assets/Java_61_4.png",v={},c=l('<h1 id="java-spring两种自动装配-autowired-resoure的区别" tabindex="-1"><a class="header-anchor" href="#java-spring两种自动装配-autowired-resoure的区别" aria-hidden="true">#</a> Java-Spring两种自动装配@Autowired&amp;@Resoure的区别</h1><p><em>沿用上一个项目</em></p><ol><li>将@Autowired换成@Resoure</li></ol><figure><img src="'+r+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>换成@Resoure之后</p><figure><img src="'+a+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>从中可以看出 @utowired导入的包是Spring的包 而@Resoure导入的包是Java的包</strong></p><p><strong>若有这么一个需求 项目中都使用controller不再使用以前的servlet，禁止大家在controller里使用Java底层的API ，那么此时就理解成不使用用 @Resource 使用 @Autowired</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>建议大家使用框架的时候后专心使用框架API，不要一边使用框架API，一边使用JavaAPI，所以使用@Autowired
