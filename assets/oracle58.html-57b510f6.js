import{_ as e,X as p,Y as t,a1 as c,Z as n,$ as s,a2 as o,a0 as l,F as i}from"./framework-68dd73a2.js";const u={},r={id:"_58-oracle-sql开发-——-创建和维护表-md",tabindex:"-1"},d=n("a",{class:"header-anchor",href:"#_58-oracle-sql开发-——-创建和维护表-md","aria-hidden":"true"},"#",-1),k={href:"http://xn--5br62d36oixdox0c53l.md",target:"_blank",rel:"noopener noreferrer"},m=l(`<h4 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h4><ul><li>数据定义语言： (Data Definition Language, DDL) 是SQL语言集中负责数据结构定义与数据库 对象定义的语言，由CREATE、ALTER与DROP三个 语法所组成。</li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_58_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>Oracle中数据库对象命名原则 <ul><li>必须由字母开始，长度在 1–30个字符之间。</li><li>名字中只能包含 A–Z, a–z, 0–9, _ (下划线)，$ 和 #。</li><li>同一个Oracle服务器用户所拥有的对象名字不能重复。</li><li>名字不能为Oracle的保留字。</li><li>名字是大小写不敏感</li></ul></li><li>建表语法</li></ul><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> <span class="token punctuation">[</span><span class="token keyword">schema</span><span class="token punctuation">.</span><span class="token punctuation">]</span><span class="token keyword">table</span>
...
</code></pre><p>表空间名字)</p><ul><li><p>您需要指定:</p><ul><li>表名</li><li>列名、列的类型及列的宽度</li></ul></li><li><p>DEFAULT 选项</p><ul><li>指定在插入或更新数据时，列的默认值</li><li>合法的值可以是字面值、表达式或SQL函数</li><li>非法的值是另一个列的名称或虚拟列</li><li>默认值的数据类型必须和列的类型匹配</li></ul></li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_58_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_58_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>NUMBER(p,s)：数值型：总长度为p，小数位最大为s位 ，整数位最 大为p-s位，p的范围从1到38，s的范围从-84到127。 <ul><li>S&gt;0：只能表示小数，精确到小数点右边s位，并四舍五入，然后 检验有效数位是否&lt;=p</li><li>S&lt;0：只能表示整数，并且精确到小数点左边s位，进行四舍五入 ，然后检验有效数位是否&lt;=p+|s|</li><li>S=0：只能表示整数</li><li>p&lt;s：只能表示数字是绝对值小于1的数字，且从小数点右边开始 的前s-p位必须是0，保留s位小数。</li></ul></li></ul><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_58_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_58_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_58_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>数据查询语言 DQL<span class="token punctuation">(</span><span class="token keyword">Data</span> Query <span class="token keyword">Language</span><span class="token punctuation">)</span>: <span class="token keyword">select</span>
