import{_ as t,X as e,Y as n,a1 as i,a0 as s}from"./framework-68dd73a2.js";const a="/blog/assets/Java_249_1.png",d={},r=s(`<h1 id="_249-java网络编程-实现客户端与服务器一对一循环聊天-md" tabindex="-1"><a class="header-anchor" href="#_249-java网络编程-实现客户端与服务器一对一循环聊天-md" aria-hidden="true">#</a> 249-Java网络编程-实现客户端与服务器一对一循环聊天..md</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter05;
