import{_ as s,X as a,Y as c,a1 as o,Z as n,$ as e,a2 as i,a0 as t,F as l}from"./framework-68dd73a2.js";const u="/blog/assets/Oracle_10_1.png",d="/blog/assets/Oracle_10_2.png",b="/blog/assets/Oracle_10_3.png",p="/blog/assets/Oracle_10_4.png",h={},v=t(`<h1 id="oracle-sql考试试题0-未完成" tabindex="-1"><a class="header-anchor" href="#oracle-sql考试试题0-未完成" aria-hidden="true">#</a> Oracle SQL考试试题0-未完成</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p><strong>一</strong>**、执行以下创建<strong><strong>S</strong></strong>tudent****、Teacher、Course、<strong><strong>SC</strong></strong>表****语句，并初始化表格数据**</p><pre><code>create table student(  sno varchar2(10) primary key,  sname varchar2(20),  sage number(2),  ssex varchar2(5)  ); 
...
create table sc(  sno varchar2(10),  cno varchar2(10),  score number(4,2),  constraint pk_sc primary key (sno,cno)  ); 
 ...
 --/*******初始化学生表的数据******/ 
  ...
  commit;
</code></pre><h3 id="练习" tabindex="-1"><a class="header-anchor" href="#练习" aria-hidden="true">#</a> 练习</h3>`,5),m={href:"https://www.2cto.com/database/",target:"_blank",rel:"noopener noreferrer"},g=t(`<pre><code>select * from student;
