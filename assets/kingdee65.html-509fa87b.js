import{_ as t,X as l,Y as s,a1 as d,Z as i,$ as e,a2 as r,a0 as v,F as a}from"./framework-68dd73a2.js";const m="/blog/assets/Kingdee_65_1.png",c="/blog/assets/Kingdee_65_1.gif",u={},b={id:"_65-金蝶云苍穹动态表单插件loadcustomcontrolmetas事件案例-md",tabindex:"-1"},o=i("a",{class:"header-anchor",href:"#_65-金蝶云苍穹动态表单插件loadcustomcontrolmetas事件案例-md","aria-hidden":"true"},"#",-1),p={href:"http://xn--65-loadCustomControlMetas-jc83b8dw6jxa485bgx5ag4ev80kee1azw6ah30l2nsch9ub2yh7i2h.md",target:"_blank",rel:"noopener noreferrer"},g=v('<ol><li><p>新建对话模态框动态表单</p></li><li><p>向其内容区添加Flex面板(更改标识为myfieldcontainer)和单据体后保存</p></li></ol><figure><img src="'+m+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="3"><li>新建插件类进行编码</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package kd.bos.dynamicform.plugin;
