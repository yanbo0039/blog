import{_ as i,X as n,Y as e,a1 as s,a0 as l}from"./framework-68dd73a2.js";const a={},d=l(`<h1 id="_20190401学习复盘" tabindex="-1"><a class="header-anchor" href="#_20190401学习复盘" aria-hidden="true">#</a> 20190401学习复盘</h1><h3 id="移动端" tabindex="-1"><a class="header-anchor" href="#移动端" aria-hidden="true">#</a> 移动端</h3><pre><code>1.必须有&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no&quot;/&gt;
2.宽度 尽量都是百分比
3.rem的使用
...
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Jquery_6_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="精灵图片" tabindex="-1"><a class="header-anchor" href="#精灵图片" aria-hidden="true">#</a> 精灵图片</h3><pre><code>1.图片要比较小
2.修饰图片
3.三个以上
...
颜色 inset内阴影/外阴影（默认)
text-shadow 
</code></pre><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,23);function t(r,o){return n(),e("div",null,[s(" more "),d])}const c=i(a,[["render",t],["__file","jquery6.html.vue"]]);export{c as default};
