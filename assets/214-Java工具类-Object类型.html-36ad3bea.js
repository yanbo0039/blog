...
equals（）：只能比较引用类型，且默认情况下比较引用地址
    ...
    但是具体是否相等，需看子类是否重写父类的equals（）方法
</code></pre><hr><p>分割线</p><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,18);function g(j,f){const i=c("ExternalLinkIcon");return t(),s("div",null,[l(" more "),e("h1",m,[h,n(),e("a",p,[n("214-Java工具类-Object类型.md"),d(i)])]),_])}const q=a(u,[["render",g],["__file","214-Java工具类-Object类型.html.vue"]]);export{q as default};
