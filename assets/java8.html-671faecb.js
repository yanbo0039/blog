import{_ as e,X as i,Y as a,a1 as n,a0 as d}from"./framework-68dd73a2.js";const s="/blog/assets/Java_8_1.png",r="/blog/assets/Java_8_2.png",l="/blog/assets/Java_8_3.png",t="/blog/assets/Java_8_4.png",c="/blog/assets/Java_8_5.png",h="/blog/assets/Java_8_6.png",v="/blog/assets/Java_8_7.png",o={},u=d(`<h1 id="java基础应用编程——-面向对象基础" tabindex="-1"><a class="header-anchor" href="#java基础应用编程——-面向对象基础" aria-hidden="true">#</a> Java基础应用编程—— 面向对象基础</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h2 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>节	知识点	掌握程度	难易程度
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="从面向过程到面向对象-不仅仅是编程方式的改变-更重要的是思考方式的改变。" tabindex="-1"><a class="header-anchor" href="#从面向过程到面向对象-不仅仅是编程方式的改变-更重要的是思考方式的改变。" aria-hidden="true">#</a> 从面向过程到面向对象，不仅仅是编程方式的改变，更重要的是思考方式的改变。</h3><h3 id="面向对象基本概念" tabindex="-1"><a class="header-anchor" href="#面向对象基本概念" aria-hidden="true">#</a> 面向对象基本概念</h3><h3 id="抽象-abstract" tabindex="-1"><a class="header-anchor" href="#抽象-abstract" aria-hidden="true">#</a> 抽象（abstract）：</h3><pre><code>从事物中舍弃个别的非本质特征，抽取共同的本质特征
只考虑与问题域相关的信息，而忽略与问题域不相关的部分
</code></pre><h3 id="对象-object-是系统中用来描述客观事物的一个实体。" tabindex="-1"><a class="header-anchor" href="#对象-object-是系统中用来描述客观事物的一个实体。" aria-hidden="true">#</a> 对象（object）：是系统中用来描述客观事物的一个实体。</h3><pre><code>可以是有形的，也可以是无形的（如一个客户，一张银行卡，窗体中的一个按钮等等）
对象是构成世界的一个独立单位
...
</code></pre><h3 id="面向对象主要特征" tabindex="-1"><a class="header-anchor" href="#面向对象主要特征" aria-hidden="true">#</a> 面向对象主要特征</h3><h3 id="封装-encapsulation" tabindex="-1"><a class="header-anchor" href="#封装-encapsulation" aria-hidden="true">#</a> 封装（encapsulation）：</h3><pre><code>所谓封装是把对象的属性和行为结合在一个独立的系统单位内部
尽可能隐蔽对象的内部细节，只向外部提供接口
降低对象间的耦合度
封装的重要意义：
    使对象能够集中而完整地描述并对应一个具体事物
    体现了事物的相对独立性，使对象外部不能随意存取对象的内部数据
</code></pre><h3 id="继承-inheritance" tabindex="-1"><a class="header-anchor" href="#继承-inheritance" aria-hidden="true">#</a> 继承（inheritance）：</h3><pre><code>也称泛化，继承性是子类自动共享父类属性和方法的机制，在定义和实现一个
...
</code></pre><h3 id="多态-polymorphism" tabindex="-1"><a class="header-anchor" href="#多态-polymorphism" aria-hidden="true">#</a> 多态（polymorphism）：</h3><pre><code>指同一个命名可具有不同的语义
...
</code></pre><figure><img src="`+v+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="g1垃圾回收器" tabindex="-1"><a class="header-anchor" href="#g1垃圾回收器" aria-hidden="true">#</a> G1垃圾回收器</h3><p>JDK7中引入了一个新的垃圾回收器，G1，它是Garbage First的缩写。G1回收器优先回收垃圾最多的区域。为了实现这个策略它把堆分成了多个区域，就好比Java 7之前分成三个区域那样（新生代，老生代和持久代）。G1回收器是一个可预测的回收器，同时对那些内存密集型的程序它还能保证较高的吞吐量。</p><h3 id="变量的作用域" tabindex="-1"><a class="header-anchor" href="#变量的作用域" aria-hidden="true">#</a> 变量的作用域</h3><h3 id="类变量" tabindex="-1"><a class="header-anchor" href="#类变量" aria-hidden="true">#</a> 类变量</h3><p>用static修饰的成员变量，它们在类被载入时创建，只要类存在，static变量就存在</p><h3 id="实例变量" tabindex="-1"><a class="header-anchor" href="#实例变量" aria-hidden="true">#</a> 实例变量</h3><p>类体中声明的成员变量，即非static的属性</p><h3 id="局部变量" tabindex="-1"><a class="header-anchor" href="#局部变量" aria-hidden="true">#</a> 局部变量</h3><p>方法体中声明的变量，方法中的参数，或代码块中声明的变量，都是局部变量 局部变量只在方法调用的过程中有效，方法调用结束后失效</p><h3 id="变量的作用域-1" tabindex="-1"><a class="header-anchor" href="#变量的作用域-1" aria-hidden="true">#</a> 变量的作用域</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>class Employee {
