import{_ as t,X as s,Y as l,a1 as d,Z as e,$ as i,a2 as r,a0 as a,F as v}from"./framework-68dd73a2.js";const u={},c={id:"_262-javaweb实现验证码登录验证功能-md",tabindex:"-1"},o=e("a",{class:"header-anchor",href:"#_262-javaweb实现验证码登录验证功能-md","aria-hidden":"true"},"#",-1),m={href:"http://xn--262-JavaWEB-h79rs94go4kjn8e4ljopg7m9b8z5bda6360fea.md",target:"_blank",rel:"noopener noreferrer"},b=a(`<h4 id="前置条件" tabindex="-1"><a class="header-anchor" href="#前置条件" aria-hidden="true">#</a> 前置条件</h4><ol><li><p>jdk系统环境与IDE工具配置完成</p></li><li><p>IDE工具与tomcat服务器配置完成</p></li><li><p>JavaWEB项目创建好并自行测试完成</p></li><li><p>所需要的jar包请自行配置完成</p></li></ol><h4 id="实现步骤" tabindex="-1"><a class="header-anchor" href="#实现步骤" aria-hidden="true">#</a> 实现步骤</h4><ol><li>后端 Java 类</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package net.tencent.tickets.servlet.login;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>前端所需要输入框请自行补全</li></ol><h4 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h4><ol><li>测试URL接口</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_262_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_262_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>测试前端页面</li></ol><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_262_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>如上所示测试完成，其核心原理在于后端Java生成图片前端获取，而后更改前端图片的路径即可 而后用户根据图上所示的字母输入前端传入后端进行服务端验证，后端返回前端结果而后前端对用户进行提示即可</li></ul><p><strong>以上就是我关于 <em>JavaWEB实现验证码登录验证功能</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p><hr><h4 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h4><hr><h4 id="扩展知识" tabindex="-1"><a class="header-anchor" href="#扩展知识" aria-hidden="true">#</a> 扩展知识</h4><hr><p>分割线</p><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,25);function p(g,h){const n=v("ExternalLinkIcon");return s(),l("div",null,[d(" more "),e("h1",c,[o,i(),e("a",m,[i("262-JavaWEB实现验证码登录验证功能.md"),r(n)])]),b])}const x=t(u,[["render",p],["__file","java262.html.vue"]]);export{x as default};
