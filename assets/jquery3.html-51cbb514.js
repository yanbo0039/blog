...
4.创建雨滴对象：
 ...
 5.实例化雨滴    
 6.雨滴的移动及其变化；                                
</code></pre><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>雨滴项目复盘</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,49);function s(u,r){return e(),i("div",null,[l(" more "),a])}const c=n(t,[["render",s],["__file","jquery3.html.vue"]]);export{c as default};
