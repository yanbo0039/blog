import{_ as l,X as s,Y as t,a1 as d,Z as i,$ as e,a2 as a,a0 as r,F as v}from"./framework-68dd73a2.js";const c={},u={id:"_206-java面向对象高级特性-多态-抽象类-练习题-md",tabindex:"-1"},b=i("a",{class:"header-anchor",href:"#_206-java面向对象高级特性-多态-抽象类-练习题-md","aria-hidden":"true"},"#",-1),m={href:"http://xn--206-Java----sk9qz50dwtq79j3hqnsaq68aql9eg3zbnsj4rah91wia7251e0ug7lq.md",target:"_blank",rel:"noopener noreferrer"},o=r(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="rectangle表示矩形类-增加两个属性" tabindex="-1"><a class="header-anchor" href="#rectangle表示矩形类-增加两个属性" aria-hidden="true">#</a> Rectangle表示矩形类，增加两个属性</h4><blockquote><p>3.2.1 Rectangle表示矩形类，增加两个属性，Width表示长度、height表示宽度，</p></blockquote><ul><li>重写getPer、getArea和showAll三个方法，另外又增加一个构造方法（一个是默认的、一个是为高度、宽度、颜色赋值的）。</li></ul><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h4><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package com.tencent.chapter07.抽象类.练习;
