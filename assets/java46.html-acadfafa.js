import{_ as e,X as t,Y as i,a1 as n,a0 as s}from"./framework-68dd73a2.js";const r={},l=s(`<h1 id="java-servlet跳转servlet以及传参" tabindex="-1"><a class="header-anchor" href="#java-servlet跳转servlet以及传参" aria-hidden="true">#</a> Java-Servlet跳转Servlet以及传参</h1><p>最近项目中有这么一个需求：</p><p><strong>JSP中的按钮点击-------&gt;Servlet-1---------&gt;Servlet-2作出判断并传参------JSP页面接收参数并展示</strong></p><h3 id="jsp跳转servlet" tabindex="-1"><a class="header-anchor" href="#jsp跳转servlet" aria-hidden="true">#</a> JSP跳转Servlet</h3><p><strong>login.jsp button2跳转到ToRegisterViewServlet</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;form name=&quot;form1&quot; method=&quot;post&quot; action=&quot;&lt;%=request.getContextPath()%&gt;/LoginServlet&quot; id=&quot;loginForm&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>user_register.jsp</strong><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_46_2.png" alt="" loading="lazy"> 核心代码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;form action=&quot;&lt;%=request.getContextPath()%&gt;/UserServlet&quot; method=&quot;post&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>拓展:</strong> EL表达式\${message}默认从请求域拿数据 第一个是request 第二个是session 第三个是Application 并且EL表达式会默认进行非空判断</p><h6 id="效果如下" tabindex="-1"><a class="header-anchor" href="#效果如下" aria-hidden="true">#</a> 效果如下：</h6><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,24);function d(a,v){return t(),i("div",null,[n(" more "),l])}const o=e(r,[["render",d],["__file","java46.html.vue"]]);export{o as default};
