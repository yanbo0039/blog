import{_ as r,X as t,Y as s,a1 as c,Z as e,$ as n,a2 as i,a0 as d,F as p}from"./framework-68dd73a2.js";const l={},o=d(`<h1 id="java基础应用编程——-面向对象高级特性" tabindex="-1"><a class="header-anchor" href="#java基础应用编程——-面向对象高级特性" aria-hidden="true">#</a> Java基础应用编程—— 面向对象高级特性</h1><h2 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h2><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="类的继承" tabindex="-1"><a class="header-anchor" href="#类的继承" aria-hidden="true">#</a> 类的继承</h2><h3 id="理解继承的含义" tabindex="-1"><a class="header-anchor" href="#理解继承的含义" aria-hidden="true">#</a> 理解继承的含义</h3><pre><code>在Java中定义一个类时，让该类通过关键字extends继承一个已有的类，这就是类的继承(泛化)。

被继承的类称为父类（超类，基类），新的类称为子类（派生类）。
    
子类继承父类的所有属性和方法，同时也可以增加自己的属性和方法。
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>Java中只能单继承，也就是说每个类只能有一个直接父类；一个父类可以有多个子类。</p><p>其实，在继承关系中我们还能发现一个规律：子类是父类的一种，也可以说“子类就是父类”。如：人类就是动物，动物就是生物。记住这个定律对我们理解继承的概念非常有帮助。但是，反过来看，父类是子类的说法正确吗？</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="继承的语法和规则" tabindex="-1"><a class="header-anchor" href="#继承的语法和规则" aria-hidden="true">#</a> 继承的语法和规则</h3><p>示例 Employee.java Worker.java</p><pre><code>[修饰符]  class  子类名  extends  父类名
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="☻-练习-officer-java-testofficer-java" tabindex="-1"><a class="header-anchor" href="#☻-练习-officer-java-testofficer-java" aria-hidden="true">#</a> ☻ 练习 Officer.java TestOfficer.java</h3><p>用java中类的继承机制，实现Officer类，并设计一个测试程序TestOfficer类，来访问Officer类</p><h3 id="继承的好处" tabindex="-1"><a class="header-anchor" href="#继承的好处" aria-hidden="true">#</a> 继承的好处</h3><pre><code>使编码更高效
易维护
代码的重用
...
示例     TestWorker.java
</code></pre><h3 id="子类实例化的过程" tabindex="-1"><a class="header-anchor" href="#子类实例化的过程" aria-hidden="true">#</a> 子类实例化的过程</h3><p>子类实例化时先实例化其父类，然后实例化子类。</p><p>要先调用父类的构造器，父类构造器运行完毕，才调用子类的构造器。</p><p>如果实例化类D，说出构造器执行的顺序。</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="super和this关键字" tabindex="-1"><a class="header-anchor" href="#super和this关键字" aria-hidden="true">#</a> super和this关键字</h3><p>super()</p><pre><code>作用：调用父类的构造器
...
实例化。
</code></pre><p>给定以下代码： <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_8.png" alt="" loading="lazy"></p><pre><code> 下列描述哪些是正确的_____?
...
</code></pre>`,61),h={href:"http://java.io",target:"_blank",rel:"noopener noreferrer"},v=e("pre",null,[e("code",null,`这个包由对您的输入/输出操作有用的类组成。
`)],-1),u=e("p",null,"java.util",-1),b=e("pre",null,[e("code",null,`该包提供了许多创建如：lists, calendar, date等所需要的类和接口。
`)],-1),g={href:"http://java.net",target:"_blank",rel:"noopener noreferrer"},m=d(`<pre><code>该包提供了许多进行TCP/IP网络编程的类和接口。
...
</code></pre><p>“隐藏属性、方法或实现细节的过程称为封装。”</p><p>隐藏类的实现细节</p><p>让使用者只能通过事先定制好的方法来访问数据，可以方便地加入控制逻辑，限制对属性的不合理操作</p><p>便于修改，增强代码的可维护性</p><p>可进行数据检查</p><p>示例 Employor.java TestEmployer.java</p><h3 id="访问权限修饰符" tabindex="-1"><a class="header-anchor" href="#访问权限修饰符" aria-hidden="true">#</a> 访问权限修饰符</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>用来控制类的成员和类的使用范围</p><p>类成员的访问权限修饰符：private、default、protected、public</p><p>类的访问权限修饰符：public、default</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_10.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>       示例：Access.java    TestAccess.java
</code></pre><p>☻ 练习<br> 给定以下代码：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_11.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>下列选项正确的是？
A. 编译失败         B. 成功编译并执行
...
示例       Worker.java
</code></pre><h3 id="☻-练习" tabindex="-1"><a class="header-anchor" href="#☻-练习" aria-hidden="true">#</a> ☻ 练习</h3><p>给定下列代码： <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_12.png" alt="" loading="lazy"> 当在第6行加入什么方法时会引起编译错误？ <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_13.png" alt="" loading="lazy"> 答案：B</p><h3 id="☻-练习-1" tabindex="-1"><a class="header-anchor" href="#☻-练习-1" aria-hidden="true">#</a> ☻ 练习</h3><p>给定类</p><pre><code>class A {
...
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_14.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="下溯造型-示例-teststudent-java" tabindex="-1"><a class="header-anchor" href="#下溯造型-示例-teststudent-java" aria-hidden="true">#</a> 下溯造型 示例：TestStudent.java</h3><p>向下转型（Downcasting）：强制转换</p><pre><code>将父类对象显示的转换成子类类型。
...
</code></pre><p>它的返回值是boolean型的</p><p>示例 TestStudent.java</p><h2 id="多态" tabindex="-1"><a class="header-anchor" href="#多态" aria-hidden="true">#</a> 多态</h2><h3 id="多态-1" tabindex="-1"><a class="header-anchor" href="#多态-1" aria-hidden="true">#</a> 多态</h3><p>简单来说，多态是具有表现多种形态的能力的特征 同一个实现接口，使用不同的实例而执行不同操作</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_15.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="多态-动态绑定、polymorphism" tabindex="-1"><a class="header-anchor" href="#多态-动态绑定、polymorphism" aria-hidden="true">#</a> 多态（动态绑定、Polymorphism )</h3><p>不同的对象对同一行为作出的不同响应</p><p>多态存在的三个必要条件</p><pre><code>要有继承，或实现
要有重写
父类引用指向子类对象
...
轿车：8元/小时
编写java程序完成此功能
</code></pre><h2 id="static关键字" tabindex="-1"><a class="header-anchor" href="#static关键字" aria-hidden="true">#</a> static关键字</h2><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_16.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="静态变量" tabindex="-1"><a class="header-anchor" href="#静态变量" aria-hidden="true">#</a> 静态变量</h3><p>所有对象共享</p><p>也称为类变量</p><p>用static修饰的成员变量，它们在类被载入时创建，只要类存在，static变量就存在（参考java虚拟机视频）</p><p>两种方式访问：</p><pre><code>直接访问：类名.属性；
实例化后访问：对象名.属性
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_17.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="静态方法" tabindex="-1"><a class="header-anchor" href="#静态方法" aria-hidden="true">#</a> 静态方法</h3><p>不需要实例化，可以直接访问</p><pre><code>也称为类方法
...
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_18.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="静态代码块" tabindex="-1"><a class="header-anchor" href="#静态代码块" aria-hidden="true">#</a> 静态代码块</h2><p>一个类中由static关键字修饰的，不包含在任何方法体中的代码块</p><p>当类被载入时，静态代码块被执行，且只被执行一次</p><p>静态块经常用来进行类属性的初始化</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_19.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>以下代码的执行结果是_____？ <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_20.png" alt="" loading="lazy"></p><pre><code>A. 编译失败     
B. 编译成功，输出“0”
C. 编译成功，输出“1”
D. 编译成功，输出“2”
答案：A
...
答案：BE
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="接-口-interface" tabindex="-1"><a class="header-anchor" href="#接-口-interface" aria-hidden="true">#</a> 接 口（interface）</h2><h3 id="接口的概念-示例-audiodevice-java-videodevice-java" tabindex="-1"><a class="header-anchor" href="#接口的概念-示例-audiodevice-java-videodevice-java" aria-hidden="true">#</a> 接口的概念 示例 AudioDevice.java VideoDevice.java</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_23.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>接口对类来说是一套规范，是一套行为协议；</p><p>接口不是一个类，不能实例化</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[访问权限修饰符]  interface   接口名 {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意： 接口不是一个类，没有构造器，不能被实例化 接口使用interface关键字来定义，而不是class 接口默认： <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_24.png" alt="" loading="lazy"> 常量：public static final 抽象方法： public abstract</p><h3 id="☻-练习-4" tabindex="-1"><a class="header-anchor" href="#☻-练习-4" aria-hidden="true">#</a> ☻ 练习</h3><p>给定以下代码：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public interface Foo{
    int k = 4;
}
下列选项中，哪些选项可以用来替代第2行代码？
![](http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_25.png)
public int k =4;
static int k = 4;
private int k = 4;
abstract int k = 4;
...
</code></pre><h3 id="静态内部类" tabindex="-1"><a class="header-anchor" href="#静态内部类" aria-hidden="true">#</a> 静态内部类</h3><p>用static标识的内部类为静态内部类。</p><p>静态内部类作为外部类的静态成员，不能访问外部类非静态成员。</p><p>非静态内部类只能定义非静态成员，而静态内部类可以定义静态成员和非静态成员。</p><p>使用Outer.Inner inn=new Outer.Inner()方式实例化静态内部类。 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_9_28.png" alt="" loading="lazy"> 非静态内部类不可以使用上面的方式实例化。</p><h3 id="局部内部类" tabindex="-1"><a class="header-anchor" href="#局部内部类" aria-hidden="true">#</a> 局部内部类</h3><p>在一个类的方法体中或程序块内定义的内部类</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>class  A{
    int a;
    public void method(){     
    }
    class B{ }
