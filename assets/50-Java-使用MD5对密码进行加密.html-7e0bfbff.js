import{_ as t,X as e,Y as i,a1 as n,a0 as s}from"./framework-68dd73a2.js";const r="/blog/assets/Java_50_1.png",l="/blog/assets/Java_50_2.png",d={},a=s(`<h1 id="java-使用md5对密码进行加密" tabindex="-1"><a class="header-anchor" href="#java-使用md5对密码进行加密" aria-hidden="true">#</a> Java-使用MD5对密码进行加密</h1><p><strong>Md5Utils.java</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package net.ptcs.my12306.util;
