import{_ as e,X as i,Y as n,a1 as l,a0 as t}from"./framework-68dd73a2.js";const s={},d=t(`<h1 id="java初级测试题七-面向对象高级特性-6-6" tabindex="-1"><a class="header-anchor" href="#java初级测试题七-面向对象高级特性-6-6" aria-hidden="true">#</a> Java初级测试题七-面向对象高级特性(6-6)</h1><ol><li>创建一个球员类，并且该类最多只允许创建十一个对象。提示利用 static 和 封装性来完成。</li></ol><p>类图如下：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_28_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>效果如下：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_28_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package chapter7;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>类图如下：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_28_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>5.3 要求从控制台输入一个字符串，根据字符串的值来判断创建三种水果中哪个类的对象</p><p>如图：</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_28_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package chapter7;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>`,71);function a(r,v){return i(),n("div",null,[l(" more "),d])}const c=e(s,[["render",a],["__file","java28.html.vue"]]);export{c as default};
