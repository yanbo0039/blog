...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,17),f=e("em",null,"Java-处理流介绍&装饰模式分析",-1),h={href:"https://github.com/javaobjects/demo520",target:"_blank",rel:"noopener noreferrer"},_=e("hr",null,null,-1),g=e("h3",{id:"分割线",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),t(" 分割线")],-1),S=e("hr",null,null,-1),x=e("p",null,[e("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function y(B,I){const i=u("ExternalLinkIcon");return r(),a("div",null,[l(" more "),e("h1",m,[o,t(" 141-Java-处理流介绍&"),e("a",b,[t("装饰模式分析.md"),d(i)])]),p,e("p",null,[e("strong",null,[t("以上就是我关于 "),f,t(" 知识点的整理与总结的全部内容,"),e("a",h,[t("另附源码"),d(i)])])]),_,g,S,x])}const k=n(v,[["render",y],["__file","141-Java-处理流介绍 装饰模式分析.html.vue"]]);export{k as default};
