import{_ as t,X as s,Y as l,a1 as r,Z as e,$ as i,a2 as a,a0 as d,F as o}from"./framework-68dd73a2.js";const v="/blog/assets/Kingdee_76_1.png",c="/blog/assets/Kingdee_76_2.png",m={},u={id:"_76-金蝶云苍穹动态表单插件beforedooperation事件案例-md",tabindex:"-1"},b=e("a",{class:"header-anchor",href:"#_76-金蝶云苍穹动态表单插件beforedooperation事件案例-md","aria-hidden":"true"},"#",-1),p={href:"http://xn--76-beforeDoOperation-8r65ajd83isa938aqy1aqfegt6itexapw3ac31jiy7b1e6aizg262g.md",target:"_blank",rel:"noopener noreferrer"},g=d('<ol><li><p>新建空白动态表单</p></li><li><p>添加一个按钮</p></li><li><p>为其添加事件后保存</p></li></ol><blockquote><p>以关闭事件为例，将其操作代码项更改为pay</p></blockquote><figure><img src="'+v+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="4"><li>编码</li></ol><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package kd.bos.dynamicform.plugin;
