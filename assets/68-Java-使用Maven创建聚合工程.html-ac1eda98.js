import{_ as a,X as l,Y as s,a1 as d,Z as t,$ as e,a2 as n,a0 as o,F as r}from"./framework-68dd73a2.js";const c="/blog/assets/Java_68_1.png",g="/blog/assets/Java_68_2.png",v="/blog/assets/Java_68_3.png",m="/blog/assets/Java_68_4.png",u="/blog/assets/Java_68_5.png",p="/blog/assets/Java_68_6.png",b="/blog/assets/Java_68_7.png",_="/blog/assets/Java_68_8.png",f="/blog/assets/Java_68_9.png",x="/blog/assets/Java_68_10.png",h="/blog/assets/Java_68_11.png",M="/blog/assets/Java_68_12.png",I="/blog/assets/Java_68_13.png",J="/blog/assets/Java_68_14.png",y="/blog/assets/Java_68_15.png",q="/blog/assets/Java_68_16.png",S="/blog/assets/Java_68_17.png",z={},k={id:"_68-java-使用maven创建聚合工程-md",tabindex:"-1"},w=t("a",{class:"header-anchor",href:"#_68-java-使用maven创建聚合工程-md","aria-hidden":"true"},"#",-1),N={href:"http://xn--68-Java-Maven-pe5u071an3hpl9bocefx7kepua6i4a.md",target:"_blank",rel:"noopener noreferrer"},j=o('<ol><li>新建一个Maven工程</li></ol><figure><img src="'+c+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>勾选 Create a simple project (skip archetype selection)</p><p>如图所示，location里会有默认为别的项目的空间，我进行的尝如下：</p><p>去掉勾选 Use default Workspace location 清空Location：里的路径 完成之后再次勾选 Use default Workspace location</p><figure><img src="'+g+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>结果就成这样咯。。。。不能点击Next。。。显示我是没有解决这个bug</p><p><strong>最终解决方法：</strong></p><p>windows ---&gt; Preferences ---&gt; Global Settings (open file) 配置好即可解决这个bug</p><figure><img src="'+v+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+m+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+u+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>这样一个Maven工程就创建好咯。。。</p><figure><img src="'+p+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li>因tct-commons这个总的工程下面有很多子的工程，所以再创建一个Maven Module</li></ol><p>File ---&gt; NEW ---&gt; Maven ---&gt; Maven Module ---&gt; Next</p><figure><img src="'+b+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+_+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+f+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+x+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>打开txt-commons里的pom.xml,可以看到这里面已经有子级txt-domain的配置咯</li></ul><figure><img src="'+h+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="3"><li>同样的操作再创建一个Maven Module tct-dao</li></ol><figure><img src="'+M+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+I+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>这里父级工程里的pom.xml已经自动更新</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;project xmlns=&quot;http://maven.apache.org/POM/4.0.0&quot; xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot; xsi:schemaLocation=&quot;http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd&quot;&gt;
  ...
  &lt;/modules&gt;
&lt;/project&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>同样的操作再创建一个Maven Module tct-service</li></ol><p><strong>注：</strong></p><p>刚刚起错名咯。。将前缀名为txt的工程更改为tct</p><ol start="4"><li>创建一个Maven Module tct-controller 需要勾选war包因为是web工程</li></ol><figure><img src="`+J+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>tct-commons里的pom.xml</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;project xmlns=&quot;http://maven.apache.org/POM/4.0.0&quot; xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot; xsi:schemaLocation=&quot;http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd&quot;&gt;
  &lt;modelVersion&gt;4.0.0&lt;/modelVersion&gt;
  &lt;groupId&gt;com.tencent&lt;/groupId&gt;
  &lt;artifactId&gt;tct-commons&lt;/artifactId&gt;
  &lt;version&gt;0.0.1-SNAPSHOT&lt;/version&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+y+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>原因：</strong> 之前的命名错误，将前缀txt更改为tct之后pom.xml里的artifactId标签里依然是txt-dao</p><p><strong>解决方法：</strong> 将所有工程里的pom.xml里的artifactId标签里前缀为txt更改为 tct，更改完成之后，如图所示报错解决</p><figure><img src="'+q+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>在domain工程里写一个实体类</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package com.tencent.easyJava.domain;
/**
 * User实体类
* &lt;p&gt;Title: User&lt;/p&gt;  
* &lt;p&gt;Description: &lt;/p&gt;  
