import{_ as e,X as t,Y as n,a1 as i,a0 as s}from"./framework-68dd73a2.js";const a="/blog/assets/Java_59_1.png",r={},o=s(`<h1 id="java-spring根据类型自动装配属性" tabindex="-1"><a class="header-anchor" href="#java-spring根据类型自动装配属性" aria-hidden="true">#</a> Java-Spring根据类型自动装配属性</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><p><em>沿用上一个项目</em></p><ol><li>修改beans_set.xml;修改后结果如下</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>以上就是我对于 Java-Spring根据类型自动装配属性 知识点整理的全部内容</strong></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>Java-Spring根据类型自动装配属性</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,14);function l(d,u){return t(),n("div",null,[i(" more "),o])}const v=e(r,[["render",l],["__file","java59.html.vue"]]);export{v as default};
