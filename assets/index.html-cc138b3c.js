...
select * from v_sal2000M;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+x+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>delete v_sal2000M; -- ok
select * from v_sal2000M;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+h+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>drop v_sal2000M;-- 表数据与结构都被删除，表没了
select * from v_sal2000M;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="拓展链接" tabindex="-1"><a class="header-anchor" href="#拓展链接" aria-hidden="true">#</a> 拓展链接</h4>`,35),y={href:"https://blog.csdn.net/bb_code_exchange/article/details/81365813",target:"_blank",rel:"noopener noreferrer"},M=e("hr",null,null,-1),O=e("h3",{id:"分割线",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),a(" 分割线")],-1),k=e("hr",null,null,-1),S=e("p",null,[e("strong",null,"博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。")],-1);function z(N,A){const i=c("ExternalLinkIcon");return l(),s("div",null,[d(" more "),w,e("p",null,[e("a",y,[a("第十五章视图课后练习和作业"),t(i)])]),M,O,k,S])}const E=n(f,[["render",z],["__file","index.html.vue"]]);export{E as default};
