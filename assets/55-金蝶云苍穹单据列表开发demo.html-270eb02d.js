import{_ as t,X as l,Y as s,a1 as d,Z as i,$ as e,a2 as r,a0 as a,F as v}from"./framework-68dd73a2.js";const u="/blog/assets/Kingdee_55_1.png",m="/blog/assets/Kingdee_55_2.png",c="/blog/assets/Kingdee_55_3.png",o="/blog/assets/Kingdee_55_4.png",b="/blog/assets/Kingdee_55_5.png",g="/blog/assets/Kingdee_55_6.png",p="/blog/assets/Kingdee_55_7.png",h="/blog/assets/Kingdee_55_8.png",f="/blog/assets/Kingdee_55_9.png",C="/blog/assets/Kingdee_55_10.png",k="/blog/assets/Kingdee_55_11.png",_={},y={id:"_55-金蝶云苍穹单据列表开发demo-md",tabindex:"-1"},L=i("a",{class:"header-anchor",href:"#_55-金蝶云苍穹单据列表开发demo-md","aria-hidden":"true"},"#",-1),S={href:"http://xn--55-demo-ds4k15x3jd9sbu73ffbmtt2fyd0alupzydy29c.md",target:"_blank",rel:"noopener noreferrer"},F=a('<h4 id="控件使用" tabindex="-1"><a class="header-anchor" href="#控件使用" aria-hidden="true">#</a> 控件使用</h4><h5 id="列表分组字段" tabindex="-1"><a class="header-anchor" href="#列表分组字段" aria-hidden="true">#</a> 列表分组字段</h5><blockquote><p>在左侧大纲中选择表格视图后在实体列表元素中选择列表字段分组，而后将申请数据和已订货数量拖进列表分组字段中，并更改列表分组字段名称为数量</p></blockquote><figure><img src="'+u+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h5 id="合并列表字段" tabindex="-1"><a class="header-anchor" href="#合并列表字段" aria-hidden="true">#</a> 合并列表字段</h5><blockquote><p>同上述步骤一样，只不过在实体列表元素中选择合并列表字段，申请人和申请部门移进合并列表字段中，并更改合并列表字段名称为申请信息</p></blockquote><figure><img src="'+m+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h5 id="动态文本列表字段" tabindex="-1"><a class="header-anchor" href="#动态文本列表字段" aria-hidden="true">#</a> 动态文本列表字段</h5><blockquote><p>同上述步骤一样，只不过在实体列表元素中选择动态文本列表字段，将其名称更改为申请信息2并设置列表字段配置属性值为申请人姓名和申请部门名称</p></blockquote><figure><img src="'+c+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>上述三个功能预览效果</p></blockquote><figure><img src="'+o+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h5 id="操作列" tabindex="-1"><a class="header-anchor" href="#操作列" aria-hidden="true">#</a> 操作列</h5><blockquote><p>同上述步骤一样，只不过在实体列表元素中选择操作列并设置其操作项的值为提交撤销</p></blockquote><figure><img src="'+b+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>预览效果</p></blockquote><figure><img src="'+g+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="自定义常用过滤查询条件" tabindex="-1"><a class="header-anchor" href="#自定义常用过滤查询条件" aria-hidden="true">#</a> 自定义常用过滤查询条件</h4><h5 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求：</h5><ol><li>以采购申请单为案例，在单据列表界面的常用过滤条件中添加采购组织字段；</li><li>默认取当前组织，对单据列表数据进行过滤；</li><li>如果用户在过滤面板中，设置了采购组织值，则按照用户设置的组织过滤数据。</li></ol><h5 id="实现步骤" tabindex="-1"><a class="header-anchor" href="#实现步骤" aria-hidden="true">#</a> 实现步骤</h5><blockquote><p>编码且重启服务</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code> 
