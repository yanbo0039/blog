...
this.getTreeModel().setTextFormat(&quot;涎涎{name}(编码{code})&quot;);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>效果如下</p></blockquote><figure><img src="`+u+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>金蝶云苍穹树形基础资料initializeTree事件案例</em> 知识点整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',16);function _(f,T){const n=o("ExternalLinkIcon");return l(),s("div",null,[a(" more "),e("h1",b,[g,i(),e("a",p,[i("82-金蝶云苍穹树形基础资料initializeTree事件案例.md"),d(n)])]),h])}const x=t(m,[["render",_],["__file","kingdee82.html.vue"]]);export{x as default};
