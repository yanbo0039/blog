import{_ as n,X as l,Y as a,a1 as d,Z as e,$ as i,a2 as s,a0 as r,F as v}from"./framework-68dd73a2.js";const u="/blog/assets/Kingdee_87_1.png",c="/blog/assets/Kingdee_87_2.png",m="/blog/assets/Kingdee_87_3.png",o="/blog/assets/Kingdee_87_1.gif",b={},p={id:"_87-金蝶云苍穹单据转换插件afterbuildqueryparemetersample事件案例-md",tabindex:"-1"},g=e("a",{class:"header-anchor",href:"#_87-金蝶云苍穹单据转换插件afterbuildqueryparemetersample事件案例-md","aria-hidden":"true"},"#",-1),y={href:"http://xn--87-AfterBuildQueryParemeterSample-et86cefl9l5a677c5x8b9f8kboaq9k8r7dpi9lel4c510b5g0er9xa.md",target:"_blank",rel:"noopener noreferrer"},_=r('<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><hr><p>最幸运的大概是被一个人坚定选择，那种对你说非你不可的人，真的是人间宝藏呀</p><hr><h4 id="前置条件" tabindex="-1"><a class="header-anchor" href="#前置条件" aria-hidden="true">#</a> 前置条件</h4><blockquote><p>要有目标单与源单，例笔者有做一个采购申请单与采购订单</p></blockquote><h4 id="为目标单添加字段" tabindex="-1"><a class="header-anchor" href="#为目标单添加字段" aria-hidden="true">#</a> 为目标单添加字段</h4><blockquote><p>在采购订单的单据头中添加一个文本字段，并按下图所示更改名称与标识</p></blockquote><figure><img src="'+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="编码" tabindex="-1"><a class="header-anchor" href="#编码" aria-hidden="true">#</a> 编码</h4><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>package kd.bos.billzh.plugin;
