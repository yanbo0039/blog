import{_ as n,X as e,Y as i,a1 as l,a0 as d}from"./framework-68dd73a2.js";const t={},a=d(`<h1 id="雨滴项目" tabindex="-1"><a class="header-anchor" href="#雨滴项目" aria-hidden="true">#</a> 雨滴项目</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h2 id="雨滴项目-1" tabindex="-1"><a class="header-anchor" href="#雨滴项目-1" aria-hidden="true">#</a> 雨滴项目：</h2><pre><code>1. 以js为核心
...
4.创建雨滴对象：
 ...
 5.实例化雨滴    
 6.雨滴的移动及其变化；                                
</code></pre><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container info"><p class="hint-container-title">相关信息</p><p><strong>以上就是我关于 <em>雨滴项目复盘</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>`,49);function s(u,r){return e(),i("div",null,[l(" more "),a])}const c=n(t,[["render",s],["__file","jquery3.html.vue"]]);export{c as default};
