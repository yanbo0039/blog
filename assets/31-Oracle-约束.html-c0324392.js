...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>其中: <ul><li>约束既可以写在每个对应列的后面，称之为列级别约束，一个列级别约束只能作用在一个列上；</li><li>也可以写完所有列之后，再写约束，称之为表级别约束，一个表级别约束既可以作用在一个列上，也可以作用在列的组合上；</li><li>NOT NULL约束只能定义在列级别上，联合主键或联合唯一性约束只能定义在表级别上，其它约束既可以定义成表级别，也可以定义成列级别；</li><li>列级别约束和表级别约束达到的作用完全相同,只是书写的位置不同;</li><li>CONSTRAINT:约束的关键字；constraint_name:约束名字；constraint_type：约束的类型；</li></ul></li></ul><h4 id="not-null-约束" tabindex="-1"><a class="header-anchor" href="#not-null-约束" aria-hidden="true">#</a> NOT NULL 约束</h4><ul><li>NOT NULL约束 ：也叫非空约束，确保被约束列的所有行记录都不能为空值。</li></ul><figure><img src="`+v+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>NOT NULL约束只能定义在在列级上。</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SQL&gt; CREATE TABLE emp_nn(
  2  	empno 	NUMBER(4),
