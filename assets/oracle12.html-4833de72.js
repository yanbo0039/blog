import{_ as e,X as a,Y as n,a1 as r,a0 as d}from"./framework-68dd73a2.js";const i={},t=d(`<h1 id="章节目标" tabindex="-1"><a class="header-anchor" href="#章节目标" aria-hidden="true">#</a> 章节目标</h1><h2 id="通过本章学习-应达到如下目标" tabindex="-1"><a class="header-anchor" href="#通过本章学习-应达到如下目标" aria-hidden="true">#</a> 通过本章学习，应达到如下目标：</h2><h3 id="掌握子查询可以解决的问题" tabindex="-1"><a class="header-anchor" href="#掌握子查询可以解决的问题" aria-hidden="true">#</a> 掌握子查询可以解决的问题；</h3><p>了解子查询的分类；</p><p>掌握单行子查询、多行子查询、多列子查询；</p><p>掌握在WHERE、HAVING、FROM子句中编写子查询；</p><p>理解子查询返回空值对主查询所产生的影响；</p><p>掌握T0P-N及分页查询;</p><h2 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h2><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="为什么使用子查询" tabindex="-1"><a class="header-anchor" href="#为什么使用子查询" aria-hidden="true">#</a> 为什么使用子查询</h2><h3 id="思考如下问题" tabindex="-1"><a class="header-anchor" href="#思考如下问题" aria-hidden="true">#</a> 思考如下问题？</h3><p>查询工资比Jones工资高的员工信息？</p><p>查询工资最低的员工姓名？</p><h2 id="为什么使用子查询-1" tabindex="-1"><a class="header-anchor" href="#为什么使用子查询-1" aria-hidden="true">#</a> 为什么使用子查询</h2><p>“谁的薪水比 Jones还高呢？”</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="使用子查询" tabindex="-1"><a class="header-anchor" href="#使用子查询" aria-hidden="true">#</a> 使用子查询</h2><pre><code>SELECT	select_list
FROM	table
WHERE	expr operator
            (SELECT	select_list
            FROM		table);
...
对于单行子查询要使用单行运算符
对于多行子查询要使用多行运算符
</code></pre><h2 id="子查询的类型" tabindex="-1"><a class="header-anchor" href="#子查询的类型" aria-hidden="true">#</a> 子查询的类型</h2><h3 id="根据子查询返回的行和列数量-分为" tabindex="-1"><a class="header-anchor" href="#根据子查询返回的行和列数量-分为" aria-hidden="true">#</a> 根据子查询返回的行和列数量，分为：</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="单行子查询" tabindex="-1"><a class="header-anchor" href="#单行子查询" aria-hidden="true">#</a> 单行子查询</h2><p>子查询只返回一行一列</p><p>使用单行运算符</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>显示和雇员7369从事相同工作并且工资大于雇员7876的雇员的姓名和工作。</p><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>子查询中使用组函数</p><p>查询工资最低的员工姓名，岗位及工资 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_6.png" alt="" loading="lazy"></p><h3 id="having子句中使用子查询" tabindex="-1"><a class="header-anchor" href="#having子句中使用子查询" aria-hidden="true">#</a> HAVING子句中使用子查询</h3><p>查询部门最低工资比20部门最低工资高的部门编号及最低工资 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_7.png" alt="" loading="lazy"></p><h3 id="having子句中使用子查询-1" tabindex="-1"><a class="header-anchor" href="#having子句中使用子查询-1" aria-hidden="true">#</a> HAVING子句中使用子查询</h3><p>查询哪个部门的员工人数 高于各部门平均人数。</p><pre><code>SQL&gt; SELECT	deptno, COUNT(empno)
2  FROM	emp
3  GROUP BY	deptno
...
6		  FROM	emp
7		  GROUP BY deptno);
</code></pre><p>这个语句错在哪？ <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_8.png" alt="" loading="lazy"></p><p>这条语句会工作吗? <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_9.png" alt="" loading="lazy"></p><h2 id="练习1" tabindex="-1"><a class="header-anchor" href="#练习1" aria-hidden="true">#</a> 练习1</h2><ol><li><p>查询入职日期最早的员工姓名，入职日期</p></li><li><p>查询工资比SMITH工资高并且工作地点在CHICAGO的员工姓名，工资，部门名称</p></li><li><p>查询入职日期比20部门入职日期最早的员工还要早的员工姓名，入职日期</p></li><li><p>查询部门人数大于所有部门平均人数的的部门编号，部门名称，部门人数</p></li></ol><h2 id="多行子查询" tabindex="-1"><a class="header-anchor" href="#多行子查询" aria-hidden="true">#</a> 多行子查询</h2><h3 id="多行子查询-1" tabindex="-1"><a class="header-anchor" href="#多行子查询-1" aria-hidden="true">#</a> 多行子查询</h3><pre><code>子查询返回记录的条数 可以是一条或多条。
...
多列子查询通常用IN操作符完成。
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Oracle_12_10.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>查询出和1981年入职的任意一个员工的部门和职位完全相同员工姓名、部门、职位、入职日期,不包括1981年入职员工。</p><pre><code>SQL&gt; SELECT	ename, deptno, job, hiredate
2  FROM	emp
