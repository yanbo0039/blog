import{_ as e,X as i,Y as a,a1 as n,a0 as d}from"./framework-68dd73a2.js";const r={},s=d(`<h1 id="java基础应用编程——-面向对象基础" tabindex="-1"><a class="header-anchor" href="#java基础应用编程——-面向对象基础" aria-hidden="true">#</a> Java基础应用编程—— 面向对象基础</h1><h2 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>节	知识点	掌握程度	难易程度
...
的属性（变量）和行为（方法）。
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_8_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="什么是类-示例-xiyoujirole-java" tabindex="-1"><a class="header-anchor" href="#什么是类-示例-xiyoujirole-java" aria-hidden="true">#</a> 什么是类？ 示例 XiyoujiRole.java</h3><pre><code>西游记游戏软件中的游戏人物
孙悟空：孙悟空的武器是金箍棒，战斗力五颗星，耐力五颗星
唐  僧：唐僧没有武器，战斗力为零，耐力五颗星
猪八戒：猪八戒的武器是耙子，战斗力四颗星，耐力两颗星
沙  僧：沙僧的武器是月牙铲 ，战斗力三颗星，耐力四颗星
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_8_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="类的格式" tabindex="-1"><a class="header-anchor" href="#类的格式" aria-hidden="true">#</a> 类的格式</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[类修饰符] class 类名
{
       类的成员
          …
}
...
对象(object) — 是实际存在的某类事物的个体，
                            也称为实例(instance)
类是创建对象的模板，对象是类的实例。
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_8_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="创建对象" tabindex="-1"><a class="header-anchor" href="#创建对象" aria-hidden="true">#</a> 创建对象</h3><p>语法格式</p><pre><code>类名   对象名 = new   构造器
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="示例-person-java-persontest-java" tabindex="-1"><a class="header-anchor" href="#示例-person-java-persontest-java" aria-hidden="true">#</a> 示例 Person.java PersonTest.java</h3><p><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_8_5.png" alt="" loading="lazy"> 内存结构参考java虚拟机视频</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Person  p  =  new  Person( “zhang”, 33,”male”);
Person  q  =  new  Person( “lisi”, 44, “male”);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_8_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>如上所示，对象的属性name 、age、sex都分配在堆内存中，但是对象名 p、q都分配在栈内存中。p 、q也称为对象的引用(reference)，引用在java中是地址的同义词。 访问对象：在其他类中或main方法中，若想访问对象的属性或是方法必须先实例化这个类，然后通过对象名（引用）和点操作符来完成：</p><pre><code>对象名. 属性名（）；
对象名. 方法名（）；
