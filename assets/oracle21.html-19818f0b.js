...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+p+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="5"><li>试为学生表student增加一列学生性别gender 默认值 “女”。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>alter table tab_student_13 add (gender char(2));
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="拓展知识" tabindex="-1"><a class="header-anchor" href="#拓展知识" aria-hidden="true">#</a> 拓展知识：</h3>`,58),x={href:"https://www.cnblogs.com/dt520/p/10141797.html",target:"_blank",rel:"noopener noreferrer"},_={href:"https://www.cnblogs.com/hijushen/p/4223557.html",target:"_blank",rel:"noopener noreferrer"},f={href:"https://blog.csdn.net/msh2016/article/details/86805428",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.cnblogs.com/lukelook/p/11068258.html",target:"_blank",rel:"noopener noreferrer"},O={href:"https://blog.csdn.net/ShadowerWArden/article/details/80658127",target:"_blank",rel:"noopener noreferrer"},w=e("hr",null,null,-1),k=e("h3",{id:"分割线",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#分割线","aria-hidden":"true"},"#"),a(" 分割线")],-1),B=e("hr",null,null,-1),I=e("div",{class:"hint-container info"},[e("p",{class:"hint-container-title"},"相关信息"),e("p",null,[e("strong",null,[a("以上就是我关于 "),e("em",null,"Oracle初级测试题十三(12-12)--创建和维护表"),a(" 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。")])])],-1);function L(A,C){const i=c("ExternalLinkIcon");return d(),t("div",null,[s(" more "),h,e("p",null,[e("a",x,[a("oracle VARCHAR2和NVARCHAR2的区别"),n(i)])]),e("p",null,[e("a",_,[a("Oracle 日期类型timestamp(时间戳)和date类型使用"),n(i)])]),e("p",null,[e("a",f,[a("Oracle入门精读79-Oracle时间操作详解（TIMESTAMP 类型）"),n(i)])]),e("p",null,[e("a",y,[a("ORACLE （BLOB、CLOB、NCLOB、BFILE）"),n(i)])]),e("p",null,[e("a",O,[a("在oracle数据库中存储BLOB类型的数据"),n(i)])]),w,k,B,I])}const V=l(g,[["render",L],["__file","oracle21.html.vue"]]);export{V as default};
