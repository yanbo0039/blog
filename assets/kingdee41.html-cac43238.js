...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="aftercreatenewdata" tabindex="-1"><a class="header-anchor" href="#aftercreatenewdata" aria-hidden="true">#</a> afterCreateNewData</h3><blockquote><p>触发时机：界面初始化或刷新，新建表单数据包成功，并给字段填写了默认值之后，触发此事件；</p></blockquote><blockquote><p>插件可以在此事件，重设字段的默认值。部分字段的默认值难以通过设计器配置出来，如需要计算的值、根据系统 参数选项决定的值，必须写插件实现</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class AfterCreateNewData extends AbstractFormPlugin {
    @Override
    public void afterCreateNewData(EventObject e) {
        // TODO 在此添加业务逻辑
    }
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="afterbinddata" tabindex="-1"><a class="header-anchor" href="#afterbinddata" aria-hidden="true">#</a> afterBindData</h3><blockquote><p>触发时机：界面数据包构建完毕，生成指令，刷新前端字段值、控件状态之后，触发此事件； 插件可以在此事件，根据各字段值数据，重新设置控件、字段的可用、可见性等。 不要在此事件，修改字段值</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="registerlistener" tabindex="-1"><a class="header-anchor" href="#registerlistener" aria-hidden="true">#</a> registerListener</h3><blockquote><p>触发时机：用户与界面上的控件进行交互时，即会触发此事件。建议在此事件，侦听各个控件的插件事件</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class RegisterListener extends AbstractFormPlugin {
    @Override
    public void registerListener(EventObject e) {
        // TODO 侦听控件的插件事件
    }
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="beforeclick" tabindex="-1"><a class="header-anchor" href="#beforeclick" aria-hidden="true">#</a> beforeClick</h3><blockquote><p>触发时机：用户点击按钮或者标签等控件时，触发此事件；插件可以在此事件，取消后续点击处理，不响应按钮绑定的操作；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class BeforeClick extends AbstractFormPlugin {
    @Override
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="click" tabindex="-1"><a class="header-anchor" href="#click" aria-hidden="true">#</a> click</h3><blockquote><p>触发时机：用户点击按钮时，触发此事件；插件可以在此响应点击事件， 实现定制的业务功能。 特别说明： 如果在beforeClick事件中，取消了后续操作，则不会触发本事件；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class Click extends AbstractFormPlugin
{
  @Override 
  public void click(EventObject evt){}
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="beforeitemclick" tabindex="-1"><a class="header-anchor" href="#beforeitemclick" aria-hidden="true">#</a> beforeItemClick</h3><blockquote><p>触发时机：用户点击菜单按钮后，在执行按钮绑定的操作前，触发此事件； 插件可以在此事件，取消菜单绑定的操作；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class BeforeItemClick extends AbstractFormPlugin
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="itemclick" tabindex="-1"><a class="header-anchor" href="#itemclick" aria-hidden="true">#</a> ItemClick</h3><blockquote><p>触发时机:用户点击菜单项时，触发此事件；插件可以在此响应自定义菜单项的点击处理。</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class ItemClick extends AbstractFormPlugin
{ 
  //工具栏的标识 
  private final static String KEY_MAINBAR = &quot;tbar_main&quot;; 
  //按钮的标识 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="afterdooperation" tabindex="-1"><a class="header-anchor" href="#afterdooperation" aria-hidden="true">#</a> afterDoOperation</h3><blockquote><p>触发时机:用户点击按钮、菜单，执行完绑定的操作后，不论成功与否，均会触发此事件；插件可以在此事件，根 据操作结果控制界面</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class AfterDoOperation extends AbstractFormPlugin
{
    final static String KEY_OPKEY = &quot;myoperation&quot;;
    @Override
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="confirmcallback" tabindex="-1"><a class="header-anchor" href="#confirmcallback" aria-hidden="true">#</a> confirmCallBack</h3><blockquote><p>触发时机：用户确认了交互提示信息后，触发此事件，通知插件进行后续处理；插件可以在此事件，了解用户的态 度，决定后续业务逻辑。</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class ConfirmCallBack extends AbstractFormPlugin
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="closedcallback" tabindex="-1"><a class="header-anchor" href="#closedcallback" aria-hidden="true">#</a> closedCallBack</h3><blockquote><p>触发时机：子界面关闭时，触发父界面的closedCallBack事件；父界面的插件，可以在此事件，接收子界面返回的 数据。</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class ClosedCallBack extends AbstractFormPlugin
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="propertychanged" tabindex="-1"><a class="header-anchor" href="#propertychanged" aria-hidden="true">#</a> propertyChanged</h3><blockquote><p>触发时机：表单模型某个字段值改变的时候就会触发此事件。 注意：单据头文本字段，日期字段等基础字段需勾选即时触发值更新，基础资料字段，单据体字段不需要。</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class DemoBillPlugin extends AbstractBillPlugIn
{  
    @Override
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="beforecreatelistcolumns" tabindex="-1"><a class="header-anchor" href="#beforecreatelistcolumns" aria-hidden="true">#</a> beforeCreateListColumns</h3><blockquote><p>事件触发时机 刷新单据列表，构建单据列表显示的列时，触发此事件，传入在设计器中已配置的列集合； 插件可以在此事件中，根据页面参数、过滤条件，动态添加、删除单据列表的显示列；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="beforecreatelistdataprovider" tabindex="-1"><a class="header-anchor" href="#beforecreatelistdataprovider" aria-hidden="true">#</a> beforeCreateListDataProvider</h3><blockquote><p>事件触发时机 构建列表取数器之前，触发此事件； 插件可以在此事件，构建自定义的列表取数器，实现自主取数；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="setfilter" tabindex="-1"><a class="header-anchor" href="#setfilter" aria-hidden="true">#</a> setFilter</h3><blockquote><p>事件触发时机 单据列表控件，在构建好取数条件，准备重新取数之前，触发此事件； 插件可以调整条件内容、追加条件，从而影响列表取数；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="filtercontainersearchclick" tabindex="-1"><a class="header-anchor" href="#filtercontainersearchclick" aria-hidden="true">#</a> filterContainerSearchClick</h3><blockquote><p>用户在过滤条件面版上改变过滤条件，触发此事件： 插件可以在此事件，调整用户在过滤面板上的条件配置，后续系统会根据调整后的条件配 置，生成取数条件；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="billlisthyperlinkclick" tabindex="-1"><a class="header-anchor" href="#billlisthyperlinkclick" aria-hidden="true">#</a> billListHyperLinkClick</h3><blockquote><p>事件触发时机 单据列表上显示为超链接的单元格，用户点击时，系统默认会打开单据维护界面。 在打开单据界面之前，触发此事件； 插件可以在此事件，判断点击的列，取消单据界面打开，自行显示其它界面</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="beforeshowbill" tabindex="-1"><a class="header-anchor" href="#beforeshowbill" aria-hidden="true">#</a> beforeShowBill</h3><blockquote><p>事件触发时机 在执行操作时，打开子界面之前，触发此事件； 插件可以修改子界面显示参数，或取消显示；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="listrowclick" tabindex="-1"><a class="header-anchor" href="#listrowclick" aria-hidden="true">#</a> listRowClick</h3><blockquote><p>用户点击单据列表行时，触发此事件。 在移动端的单据列表上，用户点击行时，系统会自动打开单据的详情界面。插件可以在此 事件，取消上述系统内置的逻辑；</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="操作插件-abstractoperationserviceplugin" tabindex="-1"><a class="header-anchor" href="#操作插件-abstractoperationserviceplugin" aria-hidden="true">#</a> 操作插件-AbstractOperationServicePlugIn</h3><blockquote><p>单据操作插件接口为IOperationServicePlugIn、IOperationService；</p></blockquote><blockquote><p>系统预置了一个操作插件基类 AbstractOperationServicePlugIn，实现了上述操作插件接口；</p></blockquote><blockquote><p>自定义的操作插件，扩展预置的操作插件基类 AbstractOperationServicePlugIn 即可。</p></blockquote><blockquote><p>插件基类 AbstractOperationServicePlugIn 内置了如下属性方法和本地变量，供插件访问，用以获取操 作执行上下文</p></blockquote><table><thead><tr><th>方法 属性</th><th>说明</th></tr></thead><tbody><tr><td>billEntityType</td><td>单据主实体</td></tr><tr><td>operateMeta</td><td>操作配置，据此获知当前执行的操作信息</td></tr><tr><td>operationResult</td><td>操作结果，可以向其中添加操作提示信息</td></tr><tr><td>getOption()</td><td>自定义操作参数选项，可以包含各种自定义操作参数</td></tr><tr><td>onPreparePropertys</td><td>在单据列表上执行单据操作，系统需要先根据传入的单据内码，加载单据 数据包；在加载单据数据包之前，触发此事件；插件需要在此事件，添加 需要用到的字段；</td></tr><tr><td>onAddValidators</td><td>系统预置的操作校验器加载完毕，执行校验之前，触发此事件；</td></tr><tr><td>beforeExecuteOperationTransaction</td><td>操作校验通过之后，开启事务之前，触发此事件；</td></tr><tr><td>beginOperationTransaction</td><td>操作校验通过，开启了事务，准备把数据提交到数据库之前触发此事件；</td></tr><tr><td>endOperationTransaction</td><td>数据已经提交到数据库之后，事务未提交之前，触发此事件；</td></tr><tr><td>rollbackOperation</td><td>操作事务提交失败，事务回滚之后触发此事件；</td></tr><tr><td>afterExecuteOperationTransaction</td><td>操作执行完毕，事务提交之后，触发此事件；</td></tr></tbody></table><h3 id="onpreparepropertys" tabindex="-1"><a class="header-anchor" href="#onpreparepropertys" aria-hidden="true">#</a> onPreparePropertys</h3><blockquote><p>操作执行，加载单据数据包之前，触发此事件；</p></blockquote><blockquote><p>在单据列表上执行单据操作，传入的是单据内码； 操作引擎需要先根据传入的单据内码，加载单据数据包，其中只包含操作要用到的字段， 然后再执行操作；在加载单据数据包之前，触发此事件；</p></blockquote><blockquote><p>在单据维护界面，执行单据操作时，传入的是单据数据包，不需要操作引擎自行加载单据， 不会触发此事件；</p></blockquote><blockquote><p>插件需要在此事件，添加需要用到的字段；否则，操作引擎加载出的单据数据包，可能没 有插件要用到的字段值，从而引发中断</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
public void onPreparePropertys(PreparePropertysEventArgs e)
    { 
    // 要求备注字段 
    e.getFieldKeys().add(“note”);
  }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="onaddvalidators" tabindex="-1"><a class="header-anchor" href="#onaddvalidators" aria-hidden="true">#</a> onAddValidators</h3><blockquote><p>构建好操作校验器之后，执行操作校验之前，触发此事件；</p></blockquote><blockquote><p>插件可以在此事件，增加自定义操作校验器，或者去掉内置的校验器。</p></blockquote><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>@Override 
