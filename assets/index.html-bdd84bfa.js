...
</code></pre><figure><img src="`+x+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--or 或者 --找出员工表中岗位为CLERK或者部门为20员工信息</p><p>select * from emp where job = &#39;CLERK&#39; or deptno = 20; <img src="'+S+`" alt="" loading="lazy"> --not 非 --not 可以跟以上4个特殊比较运算符搭配 --not between...and.... -- 找出员工工资不在1500-2500范围内的员工</p><pre><code>select * from emp where sal not between 1500 and 2500;
...
</code></pre><figure><img src="`+D+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--降序</p><pre><code>select ename,sal from emp order by sal desc;
</code></pre><figure><img src="`+v+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>--根据字符类型的列(根据字典序来排序a-z，如果字符串第一位一样的话， --会根据第二位来进行排序)；</p><pre><code>select * from emp order by ename desc;
...
</code></pre><figure><img src="`+U+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><p><strong>博主为咯学编程：父母不同意学编程，现已断绝关系;恋人不同意学编程，现已分手;亲戚不同意学编程，现已断绝来往;老板不同意学编程,现已失业三十年。。。。。。如果此博文有帮到你欢迎打赏，金额不限。。。</strong></p>',134);function ee(oe,ne){return o(),n("div",null,[r(" more "),$])}const ae=e(Z,[["render",ee],["__file","index.html.vue"]]);export{ae as default};
