...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试(必须先启动服务端，而后再启动客户端)结果如图所示：</p><figure><img src="`+a+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr>',8),h={class:"hint-container tip"},_=e("p",{class:"hint-container-title"},"提示",-1),g=e("em",null,"Java-使用套接字模拟服务端和客户端进行通信",-1),x={href:"https://github.com/javaobjects/demo521/commits/master",target:"_blank",rel:"noopener noreferrer"};function k(f,S){const i=v("ExternalLinkIcon");return r(),c("div",null,[d(" more "),e("h1",m,[u,n(),e("a",b,[n("154-Java-使用套接字模拟服务端和客户端进行通信.md"),t(i)])]),p,e("div",h,[_,e("p",null,[e("strong",null,[n("以上就是我关于 "),g,n(" 知识点的整理与总结的全部内容,"),e("a",x,[n("另附源码"),t(i)])])])])])}const w=s(o,[["render",k],["__file","java154.html.vue"]]);export{w as default};
