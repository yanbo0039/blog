...
</code></pre><p>content-box :这是由 CSS2.1 规定的宽度高度行为。宽度和高度分别应用到元素的内容框。在宽度和高度之外绘制元素的内边距和边框。此值为其默认值，其让元素维持W3C的标准盒模型</p><p>border-box: 为元素设定的宽度和高度决定了元素的边框盒。就是说，为元素指定的任何内边距和边框都将在已设定的宽度和高度内进行绘制。通过从已设定的宽度和高度分别减去边框和内边距才能得到内容的宽度和高度。 此值让元素维持IE传统的Box Model（IE6以下版本）</p><p>inherit: 规定应从父元素继承 box-sizing 属性的值 –</p>`,16),g={href:"https://www.w3cschool.cn/css_series/css_series-6tza24q1.html",target:"_blank",rel:"noopener noreferrer"},l=t('<p><a href="%5Bhttps://blog.csdn.net/zwkkkk1/article/details/79678177%5D(https://blog.csdn.net/zwkkkk1/article/details/79678177)">参考链接一</a></p><p><a href="%5Bhttps://www.w3cschool.cn/css_series/css_series-6tza24q1.html%5D(https://www.w3cschool.cn/css_series/css_series-6tza24q1.html)">参考链接二</a></p><p><a href="%5Bhttps://blog.csdn.net/zyuzixiao/article/details/18733463%5D(https://blog.csdn.net/zyuzixiao/article/details/18733463)">参考链接三</a></p><p><a href="%5Bhttp://me.eluup.com/365.html%5D(http://me.eluup.com/365.html)">参考链接四</a></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>Css-IE盒模型和标准盒模型</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',8);function m(b,w){const e=c("ExternalLinkIcon");return o(),i("div",null,[d(" more "),s,n("p",null,[n("a",g,[a("w3cschool参考"),h(e)])]),l])}const f=r(p,[["render",m],["__file","css2.html.vue"]]);export{f as default};
