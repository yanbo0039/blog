...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>测试</li></ol><p><strong>如图所示，测试通过</strong><img src="`+r+'" alt="" loading="lazy"></p><p><strong>作用：</strong> 调用者跟被调用者不能见面,实现解耦合，无须更改配置文件</p><p><strong>以上就是我对于Java重构代码之面向接口编程 的知识点的总结</strong></p><hr><h3 id="分割线" tabindex="-1"><a class="header-anchor" href="#分割线" aria-hidden="true">#</a> 分割线</h3><hr><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>以上就是我关于 <em>Java重构代码之面向接口编程</em> 知识点的整理与总结的全部内容，希望对你有帮助。。。。。。。</strong></p></div>',36);function u(o,m){return e(),n("div",null,[s(" more "),c])}const p=i(v,[["render",u],["__file","java57.html.vue"]]);export{p as default};
