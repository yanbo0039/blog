import{_ as l,X as n,Y as a,a1 as r,Z as e,$ as i,a2 as s,a0 as c,F as d}from"./framework-68dd73a2.js";const u="/blog/assets/Kingdee_50_1.png",o={},b={id:"_50-金蝶云苍穹之数据服务-md",tabindex:"-1"},v=e("a",{class:"header-anchor",href:"#_50-金蝶云苍穹之数据服务-md","aria-hidden":"true"},"#",-1),p={href:"http://xn--50--db9dnm51sg26aqmdiseq80ebft8ymwy6a.md",target:"_blank",rel:"noopener noreferrer"},m=c(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p>本博文仅供学术研究和交流参考，严禁将其用于商业用途。如因违规使用产生的任何法律问题，使用者需自行负责。</p></div><h4 id="orm概述" tabindex="-1"><a class="header-anchor" href="#orm概述" aria-hidden="true">#</a> ORM概述</h4><ul><li>什么是ORM？</li></ul><blockquote><p>对象关系映射(Object Relation Mappint)的简称，把实体模型映射到数据库中，提供对象的操作，在数据库中则体现为CRUD。</p></blockquote><ul><li><p>市面上有哪些开源ORM框架？</p><ul><li><p>Hibernate</p></li><li><p>Mybatis</p></li><li><p>JPA</p></li></ul></li><li><p>为什么需要ORM？</p><ul><li><p>多数库访问的需要: 应用主库、基础资料、工作流、日志、权限</p></li><li><p>自动处理繁琐的关联操作: 分录、子分录、多语言表、扩展表(动态)、多选基础资料</p></li><li><p>基于表单实体元数据，更符合业务逻辑</p></li><li><p>集成计算框架接口，可便捷地使用复杂的计算、大数据量的访问</p></li></ul></li></ul><h4 id="businessdataservicehelper-业务操作" tabindex="-1"><a class="header-anchor" href="#businessdataservicehelper-业务操作" aria-hidden="true">#</a> BusinessDataServiceHelper(业务操作)</h4><ul><li>创建对象</li></ul><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public static DynamicObject newDynamicObject(String entityName)
{
    //创建单据对象
