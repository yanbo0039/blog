import{_ as e,X as i,Y as n,a1 as a,a0 as d}from"./framework-68dd73a2.js";const s={},l=d(`<h1 id="java基础应用编程——-变量和运算符" tabindex="-1"><a class="header-anchor" href="#java基础应用编程——-变量和运算符" aria-hidden="true">#</a> Java基础应用编程—— 变量和运算符</h1><h2 id="本章内容" tabindex="-1"><a class="header-anchor" href="#本章内容" aria-hidden="true">#</a> 本章内容</h2><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="java程序结构" tabindex="-1"><a class="header-anchor" href="#java程序结构" aria-hidden="true">#</a> Java程序结构</h2><h3 id="java程序结构-1" tabindex="-1"><a class="header-anchor" href="#java程序结构-1" aria-hidden="true">#</a> Java程序结构</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="标识符、关键字和保留字" tabindex="-1"><a class="header-anchor" href="#标识符、关键字和保留字" aria-hidden="true">#</a> 标识符、关键字和保留字</h2><h3 id="标识符" tabindex="-1"><a class="header-anchor" href="#标识符" aria-hidden="true">#</a> 标识符</h3><pre><code>Java中的包、类、方法、参数和变量的名称
标识符的命名规则
必须以字母、下划线（_）或美元符号（$）开头
余下的字符可以是下划线、美元符号或任何的字母或数字，长度不限。标识符中不能有空格。
不能使用Java中的关键字或者保留字做为标识符
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="关键字-保留字" tabindex="-1"><a class="header-anchor" href="#关键字-保留字" aria-hidden="true">#</a> 关键字/保留字</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="☻-练习判断下列哪些是合法的标识符" tabindex="-1"><a class="header-anchor" href="#☻-练习判断下列哪些是合法的标识符" aria-hidden="true">#</a> ☻ 练习判断下列哪些是合法的标识符：</h3><pre><code>identifier  、userName  、class 、98.3  、Data#
...
特定的运算结果等
</code></pre><h3 id="变量的声明" tabindex="-1"><a class="header-anchor" href="#变量的声明" aria-hidden="true">#</a> 变量的声明</h3><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h2><h3 id="数据类型及分类" tabindex="-1"><a class="header-anchor" href="#数据类型及分类" aria-hidden="true">#</a> 数据类型及分类</h3><p>在Java中，数据类型分为两大类：</p><pre><code>基本数据类型：4类8种基本数据类型
引用数据类型
</code></pre><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="整数类型-—-byte、short、int默认、long" tabindex="-1"><a class="header-anchor" href="#整数类型-—-byte、short、int默认、long" aria-hidden="true">#</a> 整数类型 — byte、short、int默认、long</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Java中整型的三种表示形式
十进制整数：0 ~ 9，注：第一位不能是0
...
八进制整数：0 ~ 7，注：必须以0开头
                 例如： 0123     012
八进制整数：0 ~ 7，注：必须以0开头
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>Java各整数类型有固定的表数范围和字段长度，其不受操作系统的影响，以保证Java程序的可移植性。</p><p>Java语言的整形常量默认为int型，声明long型后面需加上l或者L，否则会出错</p><h3 id="☻-练习-1" tabindex="-1"><a class="header-anchor" href="#☻-练习-1" aria-hidden="true">#</a> ☻ 练习</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>在java中与语句“int a = 97;”等效的声明语句是_____
int a = 0X0061;
int a = 0X61;
int a = 0141;
int a = 97.0;
答案：ABC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="浮点数类型-—-float、double" tabindex="-1"><a class="header-anchor" href="#浮点数类型-—-float、double" aria-hidden="true">#</a> 浮点数类型 — float、double</h3><p>与整数类型相似，Java浮点数类型有固定的表数范围和字段长度，不受平台影响 <img src="http://rvg3orptc.hd-bkt.clouddn.com/assets/Java_7_8.png" alt="" loading="lazy"></p><p>Java浮点数类型有两种表示形式</p><pre><code>十进制数形式，例如：3.14    314.0    .314
